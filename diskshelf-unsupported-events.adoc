...
[.lead]
diskshelf.unsupported events are presented when oNTAP(R) software detects an unsupported disk shelf which is typically fixed by verifying system state and connectivity.
