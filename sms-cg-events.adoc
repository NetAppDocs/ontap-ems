...
[.lead]
sms.cg events are presented when a SnapMirror(R) Synchronous Automated Failover relationship is part of a cascade configuration which is typically fixed by following the documented corrective steps.
