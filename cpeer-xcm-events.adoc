...
[.lead]
cpeer.xcm events are presented when address discovery fails for a peer cluster which is typically fixed by verifying system state and updating configuration.
