...
[.lead]
lun.vtoc events are presented when the rebuilding of the Vdisk Table of Contents (VTOC) file is complete which typically does not require corrective action.
