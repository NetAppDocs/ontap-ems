...
[.lead]
replication.vol events occur when SnapMirror(R) or VolCopy replication encounters a disk error in the active map delta blocks on the destination and cannot continue replication.
