...
[.lead]
config.nopartnerluns EMS events occur in a High-Availablity (HA) configuration with array LUNS when there is no attachment to both local and partner LUNs.
