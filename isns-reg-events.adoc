...
[.lead]
isns.reg events are presented when the Internet Storage Name Service (iSNS) registration information is not valid or not available which is typically fixed by verifying system state and connectivity.
