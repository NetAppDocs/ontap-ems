...
[.lead]
mgr.partner events are presented when after a successful cluster takeover caused by a partner panic, and indicates partner stack trace information was collected from the time of the panic, which may require contacting NetApp support.
