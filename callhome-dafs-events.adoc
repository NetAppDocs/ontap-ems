...
[.lead]
callhome.dafs events are presented when the DAFS (Direct Acess File System) NIC (Network Interface Controller) has stopped while DAFS was running which may require a reboot.
