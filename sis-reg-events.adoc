...
[.lead]
sis.reg events are presented when this event is issued when a SIS volume operation found an invalid registry entry which typically does not require corrective action.
