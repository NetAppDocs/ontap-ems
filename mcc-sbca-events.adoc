...
[.lead]
mcc.sbca EMS events occur when a MetroCluster (tm) system metadata volume that provides storage for the configuration replication services is not available.
