...
[.lead]
mcc.sbca events are presented when a MetroCluster (tm) system metadata volume that provides storage for the configuration replication services is not available which may require contacting NetApp support.
