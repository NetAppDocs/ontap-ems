...
[.lead]
spm.coresegd events are presented when the core segment server (coresegd) involuntarily terminates which may require restarting affected services or nodes.
