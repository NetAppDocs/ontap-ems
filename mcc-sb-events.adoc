...
[.lead]
mcc.sb events are presented when dump/restore is aborted during a MetroCluster switchback operation which typically does not require corrective action.
