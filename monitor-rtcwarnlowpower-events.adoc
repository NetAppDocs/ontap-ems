...
[.lead]
monitor.rtcwarnlowpower events are presented when the real-time clock (RTC) battery is at a "warning low" voltage level which may require reseating or replacing affected hardware.
