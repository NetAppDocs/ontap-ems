...
[.lead]
rdb.corruption events are presented when the cluster management Data Replication Module determines that the node's local replica set is corrupted which typically does not require corrective action.
