...
[.lead]
sfo.takenover events are presented when an attempted optimized negotiated takeover is aborted by the node about to be taken over which is typically fixed by verifying system state and connectivity.
