...
[.lead]
clam.start events occur when the Kernel Cluster Services (KCS) Connectivity, Liveliness, Availability Monitor (CLAM) has started a poll to read CLAM mailboxes.
