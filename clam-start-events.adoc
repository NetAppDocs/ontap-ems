...
[.lead]
clam.start events are presented when the Kernel Cluster Services (KCS) Connectivity, Liveliness, Availability Monitor (CLAM) has started a poll to read CLAM mailboxes which typically does not require corrective action.
