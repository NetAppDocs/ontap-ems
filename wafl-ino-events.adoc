...
[.lead]
wafl.ino events are presented when an inode upgrade for the specified WAFL volume or aggregate is aborted which typically does not require corrective action.
