...
[.lead]
wafl.data events are presented when data compaction functionality is enabled or disabled on a volume which typically does not require corrective action.
