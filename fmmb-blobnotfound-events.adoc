...
[.lead]
fmmb.blobnotfound events are presented when a mailbox 'blob' is not read from the on-disk mailbox data structure which is typically fixed by updating configuration.
