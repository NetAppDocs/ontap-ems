...
[.lead]
vifmgr.clusterlfoconf events are presented when the failover policy and failover group for a cluster LIF are restored to their default values which typically does not require corrective action.
