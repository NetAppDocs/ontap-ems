...
[.lead]
wafl.fc EMS events occur when a FlexCache(R) origin node detects that its FlexCache volume has disconnected while a lock reclaim operation is in progress.
