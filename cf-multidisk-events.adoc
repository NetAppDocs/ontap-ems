...
[.lead]
cf.multidisk EMS events occur when the node is waiting for the partner to take over, after the node encounters a multidisk error or some other fatal error.
