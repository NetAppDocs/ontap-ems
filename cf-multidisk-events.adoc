...
[.lead]
cf.multidisk events are presented when the node is waiting for the partner to take over, after the node encounters a multidisk error or some other fatal error which typically does not require corrective action.
