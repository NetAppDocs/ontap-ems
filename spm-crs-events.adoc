...
[.lead]
spm.crs events are presented when the configuration replication server (crs) involuntarily terminates which may require restarting affected services or nodes.
