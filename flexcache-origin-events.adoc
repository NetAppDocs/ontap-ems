...
[.lead]
flexcache.origin events occur when the origin of the FlexCache volume expand operation fails to synchronize the configuration information between the newly created constituent volume and the FlexCache cluster.
