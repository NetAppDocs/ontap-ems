...
[.lead]
nv.flash events are presented when oNTAP(R) determines that failure is forthcoming or has occurred for the associated flash device on the nonvolatile memory (NVRAM) module which may require reseating or replacing affected hardware.
