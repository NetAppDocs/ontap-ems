...
[.lead]
nv.flash events occur when ONTAP(R) determines that failure is forthcoming or has occurred for the associated flash device on the nonvolatile memory (NVRAM) module.
