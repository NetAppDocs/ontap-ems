...
[.lead]
nblade.vscannopolicyenabled events occur when a file access is not considered for virus scanning because none of the configured On-Access policies are enabled for the Vserver.
