...
[.lead]
fg.admin events are presented when the data component takes longer than 15 seconds to update its view of the FlexGroup volume after an admin operation which typically does not require corrective action.
