...
[.lead]
config.atanotsupported events are presented when an ATA disk is found, but the appliance does not support it which is typically fixed by verifying system state and connectivity.
