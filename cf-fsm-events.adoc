...
[.lead]
cf.fsm events are presented when a node initiates an automatic giveback to its partner following a takeover that was due to a panic on the partner which typically does not require corrective action.
