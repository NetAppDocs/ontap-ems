...
[.lead]
monitor.cluster events are presented when the cluster is full after consuming space beyond the threshold value which is typically fixed by following the documented corrective steps.
