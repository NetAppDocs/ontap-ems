...
[.lead]
extcache.aggregate EMS events occur when this message provides diagnostic information about background work taking place in the WAFL(R) external cache subsystem.
