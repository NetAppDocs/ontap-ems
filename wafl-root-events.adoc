...
[.lead]
wafl.root events are presented when the contents of the root volume are changed to those of a previous point in time which is typically fixed by verifying system state and connectivity.
