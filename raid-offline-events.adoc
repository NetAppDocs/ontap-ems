...
[.lead]
raid.offline events are presented when an attempt to offline an aggregate fails due to active operations on the contained volumes which typically does not require corrective action.
