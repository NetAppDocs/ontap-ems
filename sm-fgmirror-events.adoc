...
[.lead]
sm.fgmirror events are presented when improper group workflow cleanup caused the subsequent SnapMirror(R) operation to fail which is typically fixed by following the documented corrective steps.
