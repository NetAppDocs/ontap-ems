...
[.lead]
volmigrate.migrating events are presented when a volume is being migrated from the filer by means of a SAN ownership change which typically does not require corrective action.
