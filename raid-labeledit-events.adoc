...
[.lead]
raid.labeledit events are presented when this event occurs when you run the 'label buildtree' command to create an aggregate from a collection of disks which typically does not require corrective action.
