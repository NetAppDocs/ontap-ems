...
[.lead]
mpt.phydisk events are presented when the system cannot allocate a physical disk path in the message processing technology (MPT) adapter driver which is typically fixed by verifying system state and connectivity.
