...
[.lead]
vifmgr.clntdev events are presented when a remote device is removed from the cluster or storage network which typically does not require corrective action.
