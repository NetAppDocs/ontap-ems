...
[.lead]
lun.metadb events are presented when a version mismatch is detected for the metafile containing LUN metadata which is typically fixed by following the documented corrective steps.
