...
[.lead]
air.cleared events occur when the Automated Incremental Repair (AIR) subsystem clears an entry in the qtree metafile because of inconsistent data within that entry.
