...
[.lead]
config.more2path events are presented when a disk is found to have more than two connections to the storage controller which is typically fixed by following the documented corrective steps.
