...
[.lead]
cf.sysid events are presented when a node sends its system ID and its HA partner's system ID successfully across the HA interconnect which typically does not require corrective action.
