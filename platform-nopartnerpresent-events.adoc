...
[.lead]
platform.nopartnerpresent events are presented when the HA partner's presence cannot be read via the GPIO ports on the controller which typically does not require corrective action.
