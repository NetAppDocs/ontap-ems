...
[.lead]
sp.notconfigured events are presented when weekly to remind you to configure the Service Processor (SP) which is typically fixed by verifying system state and updating configuration.
