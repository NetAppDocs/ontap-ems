...
[.lead]
wafl.trans events are presented when the system transitions a hybrid aggregate from 7-Mode to clustered Data ONTAP which is typically fixed by following the documented corrective steps.
