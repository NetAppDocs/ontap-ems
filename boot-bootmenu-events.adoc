...
[.lead]
boot.bootmenu events are presented when an error is detected while booting into, or using, the system boot menu which may require contacting NetApp support.
