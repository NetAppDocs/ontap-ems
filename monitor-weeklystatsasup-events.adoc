...
[.lead]
monitor.weeklystatsasup events are presented when weekly performance AutoSupport(tm) is disabled which is typically fixed by following the documented corrective steps.
