...
[.lead]
hashd.maxstore events are presented when the size of hashes in the hash store is greater than the maximum size configured which is typically fixed by updating configuration.
