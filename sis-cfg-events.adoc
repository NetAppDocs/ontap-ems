...
[.lead]
sis.cfg events are presented when the configuration file for a Single Instance Storage (SIS) volume is deleted which is typically fixed by updating configuration.
