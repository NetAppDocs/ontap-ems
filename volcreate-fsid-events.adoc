...
[.lead]
volcreate.fsid events are presented when flexible volumes were created with file system identifiers (FSIDs) which conflict with existing volumes which is typically fixed by following the documented corrective steps.
