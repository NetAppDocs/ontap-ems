...
[.lead]
hotplug.init events are presented when the "slot module insert" command encounters an error while initializing the module which may require contacting NetApp support.
