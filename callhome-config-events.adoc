...
[.lead]
callhome.config events are presented when the system detects a disk shelf configuration error for one or more disk shelves which is typically fixed by verifying system state and connectivity.
