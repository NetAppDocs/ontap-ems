...
[.lead]
vsdr.cluster events are presented when a source cluster of SVMDR relationship is at higher version than destination cluster which is typically fixed by following the documented corrective steps.
