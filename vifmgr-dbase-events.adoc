...
[.lead]
vifmgr.dbase events are presented when the logical interface manager (VIFMgr) experiences an error while verifying cluster database consistency which may require contacting NetApp support.
