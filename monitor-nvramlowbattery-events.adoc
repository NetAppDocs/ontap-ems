...
[.lead]
monitor.nvramlowbattery events are presented when the NVRAM battery is at a dangerously low power level which may require reseating or replacing affected hardware.
