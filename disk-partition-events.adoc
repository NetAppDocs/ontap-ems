...
[.lead]
disk.partition events are presented when the disk partition layout contains more partitions than are supported by the system which is typically fixed by following the documented corrective steps.
