...
[.lead]
rlm.driver events are presented when the system encounters an error while trying to get hourly statistics from the Remote LAN Module (RLM) which may require a reboot.
