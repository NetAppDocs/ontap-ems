...
[.lead]
vifmgr.lifbeingremoved events are presented when a logical interface (LIF) IP address is being removed or moved from the node which typically does not require corrective action.
