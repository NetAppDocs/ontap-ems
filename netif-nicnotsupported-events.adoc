...
[.lead]
netif.nicnotsupported events are presented when the installed network interface card (NIC) version is not supported which may require reseating or replacing affected hardware.
