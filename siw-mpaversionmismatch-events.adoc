...
[.lead]
siw.mpaversionmismatch events are presented when there is SW-iWARP Version mismatch between the HA nodes which is typically fixed by following the documented corrective steps.
