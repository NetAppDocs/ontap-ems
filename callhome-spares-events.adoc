...
[.lead]
callhome.spares events are presented when one or more RAID groups do not have an eligible spare disk drive available in case of a disk drive failure which may require contacting NetApp support.
