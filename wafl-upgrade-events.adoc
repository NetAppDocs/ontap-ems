...
[.lead]
wafl.upgrade events are presented when during an upgrade where the system need to use the active filesystem inofile, which typically does not require corrective action.
