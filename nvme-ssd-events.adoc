...
[.lead]
nvme.ssd events are presented when the NVMe drive encounters an error before the drive is reported to upper layers which may require reseating or replacing affected hardware.
