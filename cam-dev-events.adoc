...
[.lead]
cam.dev events are presented when the disk does not support the Forced Unit Access (FUA) feature bit which is typically fixed by following the documented corrective steps.
