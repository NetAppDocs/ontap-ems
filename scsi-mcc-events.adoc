...
[.lead]
scsi.mcc events occur when generated when an I/O request encounters an error because of an iSCSI Protocol Error, a end device error, or some stack internal error.
