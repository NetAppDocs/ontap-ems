...
[.lead]
config.exceededha events are presented when the number of local attached FC adapters exceeds the maximum allowed which typically does not require corrective action.
