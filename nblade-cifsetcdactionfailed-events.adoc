...
[.lead]
nblade.cifsetcdactionfailed events are presented when the DMAP container encounters an error processing an etcd request, such as a connection failure which is typically fixed by verifying system state and connectivity.
