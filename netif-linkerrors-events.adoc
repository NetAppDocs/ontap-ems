...
[.lead]
netif.linkerrors events are presented when the driver detects an excessive link error rate which is typically fixed by verifying system state and connectivity.
