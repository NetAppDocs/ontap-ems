...
[.lead]
arl.precmt events occur when ONTAP encounters issues associated with lock resynchronization and mirrored lock state creation during the aggregate relocation pre-commit phase.
