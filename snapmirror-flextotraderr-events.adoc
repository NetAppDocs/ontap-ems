...
[.lead]
snapmirror.flextotraderr events are presented when the user tries to copy a flexible volume into a traditional volume using SnapMirror(R) which is typically fixed by following the documented corrective steps.
