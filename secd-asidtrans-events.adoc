...
[.lead]
secd.asidtrans events are presented when oNTAP(R) software cannot translate an abbreviated SID to a Windows SID which may require contacting NetApp support.
