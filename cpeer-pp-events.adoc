...
[.lead]
cpeer.pp events are presented when an incoming cluster peer authentication request fails due to a passphrase mismatch which is typically fixed by verifying system state and connectivity.
