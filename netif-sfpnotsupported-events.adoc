...
[.lead]
netif.sfpnotsupported events are presented when the installed Small Form-factor Pluggable (SFP+ or QSFP+) module is not supported which may require reseating or replacing affected hardware.
