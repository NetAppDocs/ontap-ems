...
[.lead]
cluster.network events are presented when a two node cluster transitions between a switched and switchless configuration which typically does not require corrective action.
