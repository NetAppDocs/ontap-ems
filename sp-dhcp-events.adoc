...
[.lead]
sp.dhcp events are presented when the Service Processor (SP) cannot obtain network configuration data through DHCP which is typically fixed by verifying system state and updating configuration.
