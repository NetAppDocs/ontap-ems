...
[.lead]
vscan.odreport events are presented when the On-Demand job fails to create report file which is typically fixed by following the documented corrective steps.
