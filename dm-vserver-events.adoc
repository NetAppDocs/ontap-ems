...
[.lead]
dm.vserver events are presented when resynchronization of the Vserver configuration failed in a MetroCluster(tm) configuration which is typically fixed by following the documented corrective steps.
