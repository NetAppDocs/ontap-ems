...
[.lead]
mpt.bus events are presented when the message processing technology (MPT) adapter driver registration fails which typically does not require corrective action.
