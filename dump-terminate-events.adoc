...
[.lead]
dump.terminate events are presented when this event is generated during dump termination, we see if we can retrieve the name of the dump which typically does not require corrective action.
