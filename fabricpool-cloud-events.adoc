...
[.lead]
fabricpool.cloud events are presented when a cloud subscription license for FabricPools has been added which typically does not require corrective action.
