...
[.lead]
boot.varfs events occur when ONTAP encounters issues associated with backing up or restoring the /var file system to the boot media or node root volume.
