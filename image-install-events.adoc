...
[.lead]
image.install events are presented when oNTAP software installation was performed via the boot menu, which does not verify the digital signature of the software image which is typically fixed by following the documented corrective steps.
