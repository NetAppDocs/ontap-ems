...
[.lead]
diskown.shlf events are presented when shelf granular-based drive assignment is enabled or disabled which typically does not require corrective action.
