...
[.lead]
ccma.quota events are presented when a datastore has been orphaned due to the system not having sufficient memory to keep track of it in the quota system which may require restarting affected services or nodes.
