...
[.lead]
http.cfg events are presented when the maximum number of Cross-Site Request Forgery (CSRF) tokens has been reached which is typically fixed by verifying system state and updating configuration.
