...
[.lead]
spm.mntsvc events are presented when the Node Root Mount Service (mntsvc) involuntarily terminates which may require restarting affected services or nodes.
