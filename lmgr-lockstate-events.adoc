...
[.lead]
lmgr.lockstate events are presented when the system cannot clean up the lock state associated with the active file system which may require contacting NetApp support.
