...
[.lead]
diskown.ownerchangefailed events are presented when a disk ownership change request fails which is typically fixed by verifying system state and connectivity.
