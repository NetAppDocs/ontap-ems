...
[.lead]
callhome.aggr EMS events occur when ONTAP encounters issues associated with aggregate metafile corruption repairs and inconsistent aggregates being taken offline.
