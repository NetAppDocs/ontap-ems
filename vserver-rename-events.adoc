...
[.lead]
vserver.rename EMS events occur when the "vserver rename" command fails to update the peer Vserver name on the peer cluster in a Vserver peer relationship.
