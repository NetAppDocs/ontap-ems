...
[.lead]
spm.shmd events are presented when the System Health Monitor process (shmd) involuntarily terminates which may require restarting affected services or nodes.
