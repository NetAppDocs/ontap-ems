...
[.lead]
vsdr.invalid events are presented when a package is licensed at the primary site but not licensed at the secondary site in a MetroCluster(tm) configuration or Vserver DR setup which may require reseating or replacing affected hardware.
