...
[.lead]
aggr.resize EMS events occur when ONTAP encounters issues associated with aggregate resize requests sent to the REST server as part of storage thin provisioning.
