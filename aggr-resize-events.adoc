...
[.lead]
aggr.resize events are presented when a request to resize an aggregate is sent to the REST server as part of the storage thin provisioning feature in Quark which typically does not require corrective action.
