...
[.lead]
nblade.cifsnoprivshare events are presented when a client attempts to connect to a nonexistent ONTAP_ADMIN$ share which is typically fixed by following the documented corrective steps.
