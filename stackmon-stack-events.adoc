...
[.lead]
stackmon.stack events are presented when the system cannot determine the stack ID for a disk shelf which is typically fixed by verifying system state and connectivity.
