...
[.lead]
async.igroup events are presented when an error occurs asynchronously replicating an initiator group which is typically fixed by verifying system state and connectivity.
