...
[.lead]
callhome.device events are presented when the system detected a disk drive device that did not receive qualification from NetApp which may require reseating or replacing affected hardware.
