...
[.lead]
shm.reformat events are presented when the system tries to reformat a disk, but an error is returned which typically does not require corrective action.
