...
[.lead]
dfu.firmwaredownloading events are presented when firmware is being downloaded for a specific product ID of disks on the system which typically does not require corrective action.
