...
[.lead]
nblade.flexgroupstatefulprotocolaccess EMS events occur when the system detects an attempt to use Network Lock Manager (NLM) shared locks on a FlexGroup volume.
