...
[.lead]
wafl.ondemand events are presented when data ONTAP(R) fails to reserve space for a file operation due to lack of space on the aggregate which may require contacting NetApp support.
