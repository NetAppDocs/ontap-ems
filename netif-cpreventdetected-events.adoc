...
[.lead]
netif.cpreventdetected events are presented when a CPR Event (core PCI resiliency) is detected which is typically fixed by following the documented corrective steps.
