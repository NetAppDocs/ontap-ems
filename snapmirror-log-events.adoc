...
[.lead]
snapmirror.log events are presented when this event is issued when an error is encountered when opening the SnapMirror log file for writing which typically does not require corrective action.
