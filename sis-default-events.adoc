...
[.lead]
sis.default events are presented when ever volume move is done from a non All Flash Optimized node to an All Flash Optimized node and we attempt to enable storage efficiency features and automatic offline volume efficiency which typically does not require corrective action.
