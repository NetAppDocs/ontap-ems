...
[.lead]
sp.authlog events are presented when the Service Processor (SP) or baseboard management controller (BMC) fails to log an authentication event in the system event log (SEL) which may require a reboot.
