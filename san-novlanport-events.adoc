...
[.lead]
san.novlanport events are presented when a clustered Data ONTAP(R) system is in a MetroCluster(TM) configuration which is typically fixed by verifying system state and connectivity.
