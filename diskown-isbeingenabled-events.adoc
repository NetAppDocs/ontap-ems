...
[.lead]
diskown.isbeingenabled events are presented when the system is being converted from non-software based disk ownership to software based disk ownership, which typically does not require corrective action.
