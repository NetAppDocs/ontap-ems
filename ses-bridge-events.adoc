...
[.lead]
ses.bridge events are presented when the bridge firmware revision cannot be obtained which is typically fixed by verifying system state and connectivity.
