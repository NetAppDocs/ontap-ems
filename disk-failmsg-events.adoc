...
[.lead]
disk.failmsg events are presented when a drive is marked failed, is being sanitized, or has entered Maintenance Center which typically does not require corrective action.
