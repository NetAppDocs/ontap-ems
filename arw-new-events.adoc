...
[.lead]
arw.new events are presented when a new file extension is observed in anti-ransomware enabled volume which typically does not require corrective action.
