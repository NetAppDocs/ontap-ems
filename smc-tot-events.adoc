...
[.lead]
smc.tot events are presented when snapMirror is cannot update the latest total transfer bytes value of the SnapMirror relationship which typically does not require corrective action.
