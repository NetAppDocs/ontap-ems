...
[.lead]
copy.dst EMS events occur when a SnapMirror or aggregate copy operation attempts to update a flexible volume RAID block on the destination but is unable to do so.
