...
[.lead]
nblade.vscannoregdscanner events are presented when aV Connector notifies ONTAP(R) that it does not have a registered scan-engine which is typically fixed by following the documented corrective steps.
