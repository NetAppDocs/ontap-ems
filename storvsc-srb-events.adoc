...
[.lead]
storvsc.srb events are presented when oNTAP(R) software receives an unexpected hypervisor I/O adapter driver response code to an I/O request which is typically fixed by following the documented corrective steps.
