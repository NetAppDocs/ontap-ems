...
[.lead]
diskown.aashelf events occur when the controller cannot automatically assign a disk because disks on the shelf and disks on the stack have the same owner but belong to different pools.
