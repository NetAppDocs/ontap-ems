...
[.lead]
fg.svmdr events are presented when during FlexGroup volume replication in an SVM DR setup when the available QoS workloads are insufficient on the secondary cluster which may require contacting NetApp support.
