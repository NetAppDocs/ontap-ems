...
[.lead]
lmgr.sh events are presented when the system vetoes aggregate giveback or relocation because CIFS oplock recall fails which may require contacting NetApp support.
