...
[.lead]
cf.ic events are presented when the controller configuration is changed from a single enclosure HA configuration to a dual enclosure HA configuration which may require a reboot.
