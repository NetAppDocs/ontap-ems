...
[.lead]
netif.cprmaxeventsreached events are presented when the maximum number of CPR Events (core PCI resiliency) has occurred since boot which may require reseating or replacing affected hardware.
