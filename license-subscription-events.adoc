...
[.lead]
license.subscription events are presented when your Cloud ONTAP(R) license subscription has expired but may still be renewed which is typically fixed by following the documented corrective steps.
