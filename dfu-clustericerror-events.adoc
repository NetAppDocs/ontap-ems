...
[.lead]
dfu.clustericerror events are presented when communication with the controller failover partner cannot be established which is typically fixed by verifying system state and connectivity.
