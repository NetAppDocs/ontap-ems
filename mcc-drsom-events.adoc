...
[.lead]
mcc.drsom events are presented when it cannot be determined whether a disk belongs to a root aggregate which typically does not require corrective action.
