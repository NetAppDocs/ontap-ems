...
[.lead]
sp.upd events are presented when the Service Processor (SP) daemon cannot extract the SP firmware version from the metadata file which may require contacting NetApp support.
