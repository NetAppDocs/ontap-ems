...
[.lead]
diskown.autoassignproblem events are presented when data ONTAP(R) attempts to assign a disk automatically, but the request fails which is typically fixed by verifying system state and connectivity.
