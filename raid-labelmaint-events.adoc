...
[.lead]
raid.labelmaint events are presented when the system places an aggregate into online label maintenance mode which typically does not require corrective action.
