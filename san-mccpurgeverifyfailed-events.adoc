...
[.lead]
san.mccpurgeverifyfailed events occur in MetroCluster(TM) configurations on clustered Data ONTAP(R) systems when a SAN cache purge verify operation fails.
