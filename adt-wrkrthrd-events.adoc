...
[.lead]
adt.wrkrthrd events are presented when audit initialization fails because the necessary execution threads cannot be created which may require a reboot.
