...
[.lead]
secd.lsa events are presented when none of the configured LSA servers are accepting connections which is typically fixed by following the documented corrective steps.
