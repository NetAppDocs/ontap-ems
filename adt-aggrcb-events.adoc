...
[.lead]
adt.aggrcb events are presented when the auditing subsystem cannot remove a stale aggregate control block entry from the Audit aggregate hash table which may require a reboot.
