...
[.lead]
mc.post events are presented when post replay and conveys information regarding bdatas inserted, rejected, duplicate, hits and misses which typically does not require corrective action.
