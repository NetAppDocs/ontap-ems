...
[.lead]
mcc.ic events are presented when the MetroCluster(tm) config module receives a node advertisement from any of its partners which typically does not require corrective action.
