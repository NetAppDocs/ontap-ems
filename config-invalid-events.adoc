...
[.lead]
config.invalid events are presented when a SAS (Serial Attached SCSI) port is attached to another SAS port which is typically fixed by verifying system state and connectivity.
