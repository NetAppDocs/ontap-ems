...
[.lead]
sas.cpr events are presented when the CPR (Core PCIe Resilience) infrastructure determines that the SAS controller hardware cannot be recovered, and the associated SAS ports will be taken offline which may require reseating or replacing affected hardware.
