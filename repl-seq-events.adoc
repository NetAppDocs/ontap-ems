...
[.lead]
repl.seq events are presented when the SnapMirror sequential split is enabled on a SAN operating workload which is typically fixed by updating configuration.
