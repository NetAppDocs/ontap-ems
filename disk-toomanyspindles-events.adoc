...
[.lead]
disk.toomanyspindles events are presented when data ONTAP(R) finds more disks present on a platform than the platform actually supports which is typically fixed by updating configuration.
