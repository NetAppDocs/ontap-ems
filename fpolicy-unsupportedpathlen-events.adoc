...
[.lead]
fpolicy.unsupportedpathlen events are presented when an FPolicy screen request has a path name longer than 4k bytes which is typically fixed by following the documented corrective steps.
