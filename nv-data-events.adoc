...
[.lead]
nv.data events are presented when a Cloud Volumes ONTAP node configured for high write speed unexpectedly shuts down, possibly resulting in a loss of data which typically does not require corrective action.
