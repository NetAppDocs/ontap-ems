...
[.lead]
disk.capacity events are presented when a media size change is reported for the underlying storage device which typically does not require corrective action.
