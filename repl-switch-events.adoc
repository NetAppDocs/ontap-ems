...
[.lead]
repl.switch events are presented when the average Op Latency increases beyond the threshold value in parallel splitting mode which is typically fixed by following the documented corrective steps.
