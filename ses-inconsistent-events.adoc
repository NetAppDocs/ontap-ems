...
[.lead]
ses.inconsistent events are presented when the system detects an inconsistent configuration of shelf-to-channel connections which is typically fixed by verifying system state and connectivity.
