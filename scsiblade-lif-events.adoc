...
[.lead]
scsiblade.lif events are presented when the SAN LIF fails to be configured during Vserver initialization which is typically fixed by verifying system state and connectivity.
