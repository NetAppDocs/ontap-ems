...
[.lead]
acp.shelf EMS events occur when ONTAP encounters issues associated with the Alternate Control Path (ACP) Processor completing disk shelf power operations.
