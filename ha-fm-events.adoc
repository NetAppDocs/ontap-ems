...
[.lead]
ha.fm events are presented when the Failover Monitor (FM) platform type changes in response to changes in the cluster configuration which typically does not require corrective action.
