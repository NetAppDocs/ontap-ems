...
[.lead]
encryption.op events are presented when a rekey or conversion to encryption operation is completed on a volume which typically does not require corrective action.
