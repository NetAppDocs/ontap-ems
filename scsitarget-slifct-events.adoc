...
[.lead]
scsitarget.slifct events occur when the Fibre Channel target device driver encounters an unrecognized asynchronous event notification from the firmware, possibly as a result of a firmware update.
