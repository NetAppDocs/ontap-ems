...
[.lead]
fabric.sdm events are presented when the system fails to allocate a message for storage device monitor (SDM) notification which typically does not require corrective action.
