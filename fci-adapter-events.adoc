...
[.lead]
fci.adapter events are presented when the the Fibre Channel adapter driver is setting an option based on the setting of a bootarg variable which typically does not require corrective action.
