...
[.lead]
esh.speed events are presented when there is an error in the link speed of the disk shelves that are attached to the node which is typically fixed by verifying system state and connectivity.
