...
[.lead]
nblade.ecv events are presented when oNTAP(R) software uses a default Effective Cluster Version (ECV) before the actual ECV has been conclusively determined which typically does not require corrective action.
