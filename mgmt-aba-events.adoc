...
[.lead]
mgmt.aba events are presented when auto Balance Aggregate initiates a move of a volume that was then changed to a FlexClone(R) parent which typically does not require corrective action.
