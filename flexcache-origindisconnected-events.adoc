...
[.lead]
flexcache.origindisconnected events are presented when a FlexCache(R) volume cannot communicate with its origin volume which is typically fixed by verifying system state and connectivity.
