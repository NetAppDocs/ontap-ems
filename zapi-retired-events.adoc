...
[.lead]
zapi.retired events are presented when oNTAPI (ZAPI) is used for ONTAP data storage management which is typically fixed by following the documented corrective steps.
