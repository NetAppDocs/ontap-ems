...
[.lead]
raid.poolsort events are presented when the system detects an invalid number of disks on a single channel which typically does not require corrective action.
