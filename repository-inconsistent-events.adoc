...
[.lead]
repository.inconsistent events are presented when the Infinite Volume namespace redirector detects an inconsistency in the file attributes for a file in the namespace constituent during a client file operation request, which may require contacting NetApp support.
