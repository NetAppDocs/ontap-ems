...
[.lead]
repository.inconsistent EMS events occur during a client file operation request, when the Infinite Volume namespace redirector detects an inconsistency in the file attributes for a file in the namespace constituent.
