...
[.lead]
callhome.bad events are presented when correctable ECC errors are masked off, possibly due to bad or poorly seated memory or a faulty motherboard which may require reseating or replacing affected hardware.
