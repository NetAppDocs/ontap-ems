...
[.lead]
kern.thread events are presented when a thread creation has the system close to the maximum limit for the number of threads which typically does not require corrective action.
