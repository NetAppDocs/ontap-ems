...
[.lead]
wafl.disable events are presented when the volume guarantee of a flexible volume is disabled due to aggregate space being physically overallocated which is typically fixed by verifying system state and updating configuration.
