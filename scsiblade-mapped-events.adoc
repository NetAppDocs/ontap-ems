...
[.lead]
scsiblade.mapped events are presented when a mapped NVMe namespace attribute changes as a result of a management operation which is typically fixed by following the documented corrective steps.
