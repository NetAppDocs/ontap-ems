...
[.lead]
snaplock.invalid events are presented when an invalid autocommit period value is found on a SnapLock(R) volume which is typically fixed by updating configuration.
