...
[.lead]
monitor.raiddp events are presented when a double parity volume is in single degraded mode as part of an hourly system check, which is typically fixed by following the documented corrective steps.
