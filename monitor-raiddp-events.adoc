...
[.lead]
monitor.raiddp events are presented when part of an hourly system check when a double parity volume is in single degraded mode which is typically fixed by following the documented corrective steps.
