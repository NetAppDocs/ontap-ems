...
[.lead]
vldb.aggregatename EMS events occur when an aggregate's name in the Volume Location Database (VLDB) does not match the aggregate's current name on the node.
