...
[.lead]
vifmgr.hv EMS events occur when ONTAP encounters issues associated with Hypervisor host configuration or SNMP configuration required for monitoring hypervisor uplinks.
