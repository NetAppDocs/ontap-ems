...
[.lead]
moveagent.switchover EMS events occur when the volume move operation vetoes a MetroCluster(tm) switchover because the operations are mutually exclusive.
