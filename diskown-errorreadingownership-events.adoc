...
[.lead]
diskown.errorreadingownership events are presented when this event is issued when we get an error while reading all the DOWNs at once which typically does not require corrective action.
