...
[.lead]
diskown.errorreadingownership events are presented when we get an error while reading all the DOWNs at once, which typically does not require corrective action.
