...
[.lead]
moveagent.phase events are presented when an active volume move operation cannot access the volume move phase information which is typically fixed by verifying system state and connectivity.
