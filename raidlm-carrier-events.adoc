...
[.lead]
raidlm.carrier events are presented when data ONTAP(R) determines that an ongoing disk copy operation is no longer required and has stopped the disk copy previously started for this disk which typically does not require corrective action.
