...
[.lead]
raidlm.carrier events occur when Data ONTAP(R) determines that an ongoing disk copy operation is no longer required and has stopped the disk copy previously started for this disk.
