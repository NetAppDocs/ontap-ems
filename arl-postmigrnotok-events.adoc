...
[.lead]
arl.postmigrnotok events are presented when the specified subsystem encounters an error during the post-migration phase of the aggregate relocation (ARL) operation which is typically fixed by verifying system state and connectivity.
