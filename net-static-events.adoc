...
[.lead]
net.static events are presented when user configured static host route entry being replaced with a dynamic entry by route redirect message, which typically does not require corrective action.
