...
[.lead]
dfu.readtestfailed events are presented when a read of the disk fails after downloading firmware to a disk which is typically fixed by updating configuration.
