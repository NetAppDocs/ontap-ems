...
[.lead]
scsiblade.pport events are presented when pPorts LIF migration started before BSH cancel completed which is typically fixed by following the documented corrective steps.
