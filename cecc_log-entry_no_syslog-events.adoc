...
[.lead]
cecc_log.entry_no_syslog events are presented when correctable ECC errors occurred in the system memory which typically does not require corrective action.
