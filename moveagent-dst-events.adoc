...
[.lead]
moveagent.dst EMS events occur when the move agent detects that the attributes of the destination volume are partially updated during the commit destination phase.
