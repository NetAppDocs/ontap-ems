...
[.lead]
snapmirror.sockstrreaderr events are presented when SnapMirror tries to read a large string from the socket, which typically does not require corrective action.
