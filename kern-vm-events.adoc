...
[.lead]
kern.vm events are presented when an attempt to create a new mapping in the virtual address space of a process has failed which typically does not require corrective action.
