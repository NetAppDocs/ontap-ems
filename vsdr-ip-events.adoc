...
[.lead]
vsdr.ip events occur when ONTAP encounters issues associated with logical interface (LIF) automatic creation or placement in MetroCluster configurations.
