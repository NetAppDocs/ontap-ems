...
[.lead]
flexcache.cacheconnected events are presented when a FlexCache(R) origin volume establishes communication with its cache volume which is typically fixed by following the documented corrective steps.
