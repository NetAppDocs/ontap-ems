...
[.lead]
nv.extension events are presented when nVRAM segments of a nvlog client are disabled in a NVRAM section which typically does not require corrective action.
