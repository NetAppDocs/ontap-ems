...
[.lead]
nis.netgrp events are presented when the Network Information Service (NIS) netgroup database build fails which is typically fixed by following the documented corrective steps.
