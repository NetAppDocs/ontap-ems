...
[.lead]
siw.mpaverrelaxed events are presented when there is a mismatch in SW-iWARP versions, but due to negotiation or enhanced connect being enabled which is typically fixed by following the documented corrective steps.
