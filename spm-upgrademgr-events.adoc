...
[.lead]
spm.upgrademgr events are presented when the upgrade manager server (upgrademgr) involuntarily terminates which may require restarting affected services or nodes.
