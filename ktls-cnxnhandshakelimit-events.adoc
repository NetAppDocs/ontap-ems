...
[.lead]
ktls.cnxnhandshakelimit events are presented when the concurrent TLS connection handshake limit is reached which is typically fixed by following the documented corrective steps.
