...
[.lead]
raid.olm events are presented when a disk which is under online label maintenance(OLM) is prepared for ownership change by administrator forcibly which typically does not require corrective action.
