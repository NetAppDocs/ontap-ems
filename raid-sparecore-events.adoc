...
[.lead]
raid.sparecore events are presented when a sparecore disk is prepared for ownership change by administrator forcibly which typically does not require corrective action.
