...
[.lead]
asup.post EMS events occur when the AutoSupport(R) mechanism quits trying to post to the NetApp URL after having retried for the specified number of times.
