...
[.lead]
nblade.fileopenlimitexceeded events are presented when the number of open files on a single SMB connection or session exceeds the system limit which typically does not require corrective action.
