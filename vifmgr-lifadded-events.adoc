...
[.lead]
vifmgr.lifadded events are presented when an administrator action causes a logical interface (LIF) IP address to be added which typically does not require corrective action.
