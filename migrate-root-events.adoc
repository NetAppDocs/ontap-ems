...
[.lead]
migrate.root events are presented when the migration of a root aggregate has completed successfully which typically does not require corrective action.
