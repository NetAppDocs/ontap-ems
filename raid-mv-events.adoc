...
[.lead]
raid.mv events are presented when aggregates are brought online in a deferred way after mirror votes are retrieved automatically which typically does not require corrective action.
