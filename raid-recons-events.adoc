...
[.lead]
raid.recons events are presented when the system detects an inconsistent RAID write signature on a RAID stripe during a RAID reconstruction operation, which typically does not require corrective action.
