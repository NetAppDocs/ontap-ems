...
[.lead]
nblade.nfsmountrootonly events are presented when a non-root user performs MOUNT or NFS operation when the respective options '-mount-rootonly' or 'nfs-rootonly' are enabled which typically does not require corrective action.
