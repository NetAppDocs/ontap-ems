...
[.lead]
splog.unsupported events are presented when the current firmware of the Service Processor (SP) does not support the log collection function which is typically fixed by verifying system state and updating configuration.
