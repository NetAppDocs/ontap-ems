...
[.lead]
lmgr.notify events are presented when the volume lock manager cannot write to the notify hosts file due to an error, for example, insufficient space which typically does not require corrective action.
