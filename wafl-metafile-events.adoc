...
[.lead]
wafl.metafile events are presented when a metafile to be created is not documented, has information about it missing, or has not been identified and associated with an entry from the wiki page: MetafileRegistration which is typically fixed by following the documented corrective steps.
