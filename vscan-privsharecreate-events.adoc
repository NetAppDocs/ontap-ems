...
[.lead]
vscan.privsharecreate events are presented when the creation of privileged share ONTAP_ADMIN$ fails which is typically fixed by verifying system state and connectivity.
