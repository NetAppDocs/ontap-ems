...
[.lead]
disk.spindleerror events are presented when a disk returns a spindle detect error which is typically fixed by following the documented corrective steps.
