...
[.lead]
wafl.raid events are presented when an aggregate snapshot created in a 7-Mode environment is missing during an aggregate transition workflow, which is typically fixed by following the documented corrective steps.
