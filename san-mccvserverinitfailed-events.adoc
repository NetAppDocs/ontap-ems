...
[.lead]
san.mccvserverinitfailed EMS events occur in MetroCluster(TM) configurations on clustered Data ONTAP(R) systems when SAN Vserver failed to initialize during a switchover or switchback operation.
