...
[.lead]
config.habadremote events are presented when a remote host adapter is connected to the wrong switch bank which is typically fixed by following the documented corrective steps.
