...
[.lead]
sms.resync events are presented when a resynchronize operation between the source volume and destination volume fails which is typically fixed by verifying system state and connectivity.
