...
[.lead]
raid.data events are presented when a WAFL(R) generated read detects a stale block due to a lost write which typically does not require corrective action.
