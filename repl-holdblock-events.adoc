...
[.lead]
repl.holdblock events are presented when during an incremental transfer when the replica volume did a snapshot restore before the transfer which typically does not require corrective action.
