...
[.lead]
repl.holdblock events are presented when the replica volume did a snapshot restore before the transfer during an incremental transfer, which typically does not require corrective action.
