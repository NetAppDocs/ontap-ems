...
[.lead]
ktls.failed events are presented when several successive Transport Layer Security (TLS) connections with a remote system have failed which is typically fixed by following the documented corrective steps.
