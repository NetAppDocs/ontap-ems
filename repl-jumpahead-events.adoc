...
[.lead]
repl.jumpahead EMS events occur when the system cannot bring a replica volume online after applying the latest update to the replica because of possible inconsistencies detected in the update.
