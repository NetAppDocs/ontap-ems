...
[.lead]
wafl.iron events are presented when wafliron is running on a transitioned aggregate in precommit phase and there are 7-Mode volumes present which is typically fixed by following the documented corrective steps.
