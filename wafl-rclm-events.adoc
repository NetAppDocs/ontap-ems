...
[.lead]
wafl.rclm events are presented when an attempt to estimate the space that can be reclaimed for the aggregate was completed successfully which typically does not require corrective action.
