...
[.lead]
snmp.raid events are presented when this event is generated when a RAID group iterator was not able to be created which is typically fixed by verifying system state and connectivity.
