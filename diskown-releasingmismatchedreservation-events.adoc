...
[.lead]
diskown.releasingmismatchedreservation events are presented when we release the reservation because the DOWN says the disk is owned by someone else, which typically does not require corrective action.
