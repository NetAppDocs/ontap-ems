...
[.lead]
diskown.releasingmismatchedreservation events are presented when this event is issued when we release the reservation because the DOWN says the disk is owned by someone else which typically does not require corrective action.
