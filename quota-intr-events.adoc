...
[.lead]
quota.intr events are presented when previous quota initialization was interrupted due to a system reboot or file system consistency checking which typically does not require corrective action.
