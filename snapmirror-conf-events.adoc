...
[.lead]
snapmirror.conf events are presented when there an entry in the snapmirror.conf file is configured to use the outstanding value of greater than or equal to 10 seconds which is typically fixed by following the documented corrective steps.
