...
[.lead]
snapmirror.conf events occur when there an entry in the snapmirror.conf file is configured to use the outstanding value of greater than or equal to 10 seconds.
