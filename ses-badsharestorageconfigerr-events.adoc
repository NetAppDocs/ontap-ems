...
[.lead]
ses.badsharestorageconfigerr events are presented when a disk shelf module that is not supported in a Shared Storage system, such as an LRC module, is detected in a Shared Storage system which may require reseating or replacing affected hardware.
