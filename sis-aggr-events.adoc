...
[.lead]
sis.aggr events are presented when undo of cross volume savings on aggregate has to abort due to some error conditions which typically does not require corrective action.
