...
[.lead]
ses.fw events are presented when a firmware file is found to be empty during a disk shelf firmware update which is typically fixed by following the documented corrective steps.
