...
[.lead]
netif.badoversizepacket events are presented when the network interface card (NIC) receives a bad oversize packet which is typically fixed by following the documented corrective steps.
