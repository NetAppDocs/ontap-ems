...
[.lead]
mcc.drdom events are presented when disk ownership changes are made by the disaster recovery disk ownership manager (DRDOM) which typically does not require corrective action.
