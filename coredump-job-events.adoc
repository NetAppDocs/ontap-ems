...
[.lead]
coredump.job events are presented when the system cannot automatically save a core which is typically fixed by following the documented corrective steps.
