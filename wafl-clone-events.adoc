...
[.lead]
wafl.clone events are presented when alerts about invalid inherited counters for the clone flexible volume which is typically fixed by following the documented corrective steps.
