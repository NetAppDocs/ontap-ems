...
[.lead]
spider.message events are presented when a directory traversal task cannot finish because of an unexpected error which is typically fixed by following the documented corrective steps.
