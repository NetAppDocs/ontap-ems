...
[.lead]
wafl.c2c events are presented when attempt to increase volume max size limit during c2c restore fails due to an error which typically does not require corrective action.
