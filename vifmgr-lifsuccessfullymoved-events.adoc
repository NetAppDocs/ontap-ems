...
[.lead]
vifmgr.lifsuccessfullymoved events are presented when a logical interface (LIF) IP address was successfully moved to another node/port which typically does not require corrective action.
