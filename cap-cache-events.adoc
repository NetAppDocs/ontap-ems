...
[.lead]
cap.cache events are presented when a corrupt Central Access Policy (CAP) is encountered during access checks which is typically fixed by updating configuration.
