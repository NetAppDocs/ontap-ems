...
[.lead]
diskown.mccip events are presented when metroCluster(tm) quarter-shelf based drive assignment is enabled or disabled which typically does not require corrective action.
