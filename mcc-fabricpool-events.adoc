...
[.lead]
mcc.fabricpool events are presented when a FabricPool license exists on only one of the two sites of a MetroCluster(tm) configuration which may require reseating or replacing affected hardware.
