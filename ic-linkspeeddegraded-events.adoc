...
[.lead]
ic.linkspeeddegraded events are presented when the high-availability (HA) interconnect detects a degraded link speed which may require contacting NetApp support.
