...
[.lead]
wafl.no events are presented when occur when a volume don't have 'large_size_enabled' flag set even when the nominal size crosses the 100TB limit which typically does not require corrective action.
