...
[.lead]
sis.undo events are presented when a SIS volume 'undo' operation is aborted due to unexpected conditions, which typically does not require corrective action.
