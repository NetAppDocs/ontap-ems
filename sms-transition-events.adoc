...
[.lead]
sms.transition events are presented when a SnapMirror(R) initialize or resynchronize operation takes a long time to bring the relationship "in-sync" due to intermittent failure which typically does not require corrective action.
