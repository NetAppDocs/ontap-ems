...
[.lead]
lmgr.nl events are presented when the number of mirrored open lock count reaches the maximum supported limit which is typically fixed by verifying system state and connectivity.
