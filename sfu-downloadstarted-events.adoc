...
[.lead]
sfu.downloadstarted events are presented when a disk shelf firmware update starts to download disk shelf firmware which typically does not require corrective action.
