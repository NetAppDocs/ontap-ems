...
[.lead]
secd.unexpectedfailure events are presented when the security daemon captures an unexpected failure which is typically fixed by following the documented corrective steps.
