...
[.lead]
probedone.inquiry events are presented when the inquiry data fails the comparison at the domain validation (DV) step which is typically fixed by verifying system state and connectivity.
