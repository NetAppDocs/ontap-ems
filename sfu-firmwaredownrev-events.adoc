...
[.lead]
sfu.firmwaredownrev events are presented when disk shelf firmware is downrev and therefore cannot be updated automatically which is typically fixed by updating configuration.
