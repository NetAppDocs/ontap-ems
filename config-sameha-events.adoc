...
[.lead]
config.sameha events are presented when a disk is multipathed to the same host adapter which is typically fixed by following the documented corrective steps.
