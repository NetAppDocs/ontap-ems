...
[.lead]
icmp.ping events are presented when the system receives a burst of ICMP ping packet within a one-second interval which is typically fixed by following the documented corrective steps.
