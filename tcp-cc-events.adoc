...
[.lead]
tcp.cc events are presented when the system is configured to use the TCP NewReno congestion control algorithm which is typically fixed by verifying system state and updating configuration.
