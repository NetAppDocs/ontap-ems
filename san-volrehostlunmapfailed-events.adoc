...
[.lead]
san.volrehostlunmapfailed events occur on clustered Data ONTAP(R) systems, during Volume Rehost operation when Data ONTAP fails to create LUN map the destination Vserver.
