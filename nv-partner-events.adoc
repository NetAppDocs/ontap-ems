...
[.lead]
nv.partner events are presented when checking the partner nonvolatile RAM (NVRAM) and the partner NVRAM is disabled which typically does not require corrective action.
