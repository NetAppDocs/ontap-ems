...
[.lead]
wafl.inode events are presented when the in-memory inode cache is under high load and fully utilized which typically does not require corrective action.
