...
[.lead]
rdb.sql events are presented when the cluster management Data Replication Module could not upgrade its database from RDB to SQL which may require contacting NetApp support.
