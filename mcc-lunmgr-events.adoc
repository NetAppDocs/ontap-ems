...
[.lead]
mcc.lunmgr events are presented when failing to allocate a CTL Target LUN ID to a target disk which is typically fixed by following the documented corrective steps.
