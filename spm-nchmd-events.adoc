...
[.lead]
spm.nchmd events are presented when the Node Connectivity Health Monitor process (nchmd) involuntarily terminates which may require restarting affected services or nodes.
