...
[.lead]
dfu.suspended_disasterrecovery events occur in a MetroCluster(TM) environment when firmware download to remote disks is suspended during disaster recovery.
