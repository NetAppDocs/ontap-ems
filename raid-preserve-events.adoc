...
[.lead]
raid.preserve events are presented when during RAID replay of NVRAM, entries associated with a non-existent (offline or missing) aggregate were discovered which typically does not require corrective action.
