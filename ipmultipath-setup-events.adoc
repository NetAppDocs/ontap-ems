...
[.lead]
ipmultipath.setup events are presented when during IP Multipath connection setup, when the IP Multipath listener process cannot bind to any IP address of the source which is typically fixed by following the documented corrective steps.
