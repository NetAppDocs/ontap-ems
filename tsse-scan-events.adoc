...
[.lead]
tsse.scan events are presented when inactive data compression scan related information failed to be updated on the catalog file which typically does not require corrective action.
