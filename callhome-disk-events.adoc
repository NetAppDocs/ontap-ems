...
[.lead]
callhome.disk events occur when ONTAP encounters issues associated with insufficient spare disks, disk carrier evacuation, low disk throughput, or orphaned drives.
