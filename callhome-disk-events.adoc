...
[.lead]
callhome.disk events are presented when a system does not contain enough spares to correct existing disk failures which may require reseating or replacing affected hardware.
