...
[.lead]
lmgr.mismatch events are presented when the current file object of a lock does not match the file object found through the file handle which is typically fixed by following the documented corrective steps.
