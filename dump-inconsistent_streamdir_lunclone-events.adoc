...
[.lead]
dump.inconsistent_streamdir_lunclone events are presented when the dump engine encounters a disk error in a stream directory of an inconsistent LUN clone in a Snapshot(tm) copy which may require contacting NetApp support.
