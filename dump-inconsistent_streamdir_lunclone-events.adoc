...
[.lead]
dump.inconsistent_streamdir_lunclone events occur when the dump engine encounters a disk error in a stream directory of an inconsistent LUN clone in a Snapshot(tm) copy.
