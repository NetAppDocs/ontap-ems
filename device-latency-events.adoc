...
[.lead]
device.latency events are presented when a device exceeds the latency threshold for the 30- second monitoring period which is typically fixed by following the documented corrective steps.
