...
[.lead]
nblade.cifs events are presented when there is a budget allocation failure for a CIFS subsystem because other CIFS subsystems are consuming too much memory which may require contacting NetApp support.
