...
[.lead]
tapemc.iopending events are presented when data ONTAP(R) detects that multiple I/Os were sent to a device that supports only one I/O at a time which typically does not require corrective action.
