...
[.lead]
securepurge.aborted events are presented when a secure purge operation is aborted in a flexible volume which is typically fixed by following the documented corrective steps.
