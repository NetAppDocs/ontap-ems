...
[.lead]
dfu.fwdownloadfailedmultfiles events are presented when more than one file is found for downloading to an ATA drive which is typically fixed by verifying system state and updating configuration.
