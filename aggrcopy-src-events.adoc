...
[.lead]
aggrcopy.src events occur when we are not able to obtain all the snapshot information, from the vol copy source volume, required for a vol copy transfer.
