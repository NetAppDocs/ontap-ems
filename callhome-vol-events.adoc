...
[.lead]
callhome.vol events are presented when the system detects an inconsistent volume and takes it offline which is typically fixed by verifying system state and connectivity.
