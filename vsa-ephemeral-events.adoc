...
[.lead]
vsa.ephemeral events are presented when a node is configured to use ephemeral vNVRAM and the virtual machine has been re-hosted, using new ephemeral disk for vNVRAM which typically does not require corrective action.
