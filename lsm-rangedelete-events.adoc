...
[.lead]
lsm.rangedelete events are presented when a block store encounters an error while performing a range delete operation which typically does not require corrective action.
