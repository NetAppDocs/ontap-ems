...
[.lead]
acp.fw events are presented when the Alternate Control Path (ACP) Processor receives a command to initiate a firmware download which typically does not require corrective action.
