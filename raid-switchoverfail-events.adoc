...
[.lead]
raid.switchoverfail events are presented when a MetroCluster(tm) switchover attempt fails because of an error detected during RAID assimilation which may require contacting NetApp support.
