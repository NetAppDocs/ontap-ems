...
[.lead]
coredump.nosavecore events are presented when the process that saves a coredump is not able to flush to the boot device at the end of coredump which typically does not require corrective action.
