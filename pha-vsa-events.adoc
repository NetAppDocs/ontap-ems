...
[.lead]
pha.vsa events are presented when oNTAP(R) software detects a device with a device descriptor length greater than 40 characters which is typically fixed by following the documented corrective steps.
