...
[.lead]
scsiblade.invalid events are presented when a SCSI command requests a transfer length greater than the LUN's maximum supported transfer length of 1MB which may require a reboot.
