...
[.lead]
mcc.auso events are presented when a trigger for automatic unplanned switchover fails to issue the operation which is typically fixed by verifying system state and connectivity.
