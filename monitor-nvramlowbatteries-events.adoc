...
[.lead]
monitor.nvramlowbatteries events are presented when the NVRAM batteries are at a dangerously low power level which may require reseating or replacing affected hardware.
