...
[.lead]
snapmirror.sockstrwriteerr events are presented when this event is issued when SnapMirror tries to write a large string to the socket which typically does not require corrective action.
