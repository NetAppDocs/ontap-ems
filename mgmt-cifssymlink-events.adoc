...
[.lead]
mgmt.cifssymlink events are presented when configuration of a CIFS symbolic link fails; the symbolic link might not be available through CIFS which is typically fixed by verifying system state and connectivity.
