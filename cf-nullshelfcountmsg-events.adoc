...
[.lead]
cf.nullshelfcountmsg events are presented when this event occurs if we are sent a NULL negotiated failover shelf count message which is typically fixed by verifying system state and connectivity.
