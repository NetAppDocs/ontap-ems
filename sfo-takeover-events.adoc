...
[.lead]
sfo.takeover events are presented when the taking over node cannot complete an attempted optimized negotiated takeover which is typically fixed by verifying system state and connectivity.
