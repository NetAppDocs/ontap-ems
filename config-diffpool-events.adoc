...
[.lead]
config.diffpool events are presented when a disk is found to be multipathed to two different mirroring pools which may require contacting NetApp support.
