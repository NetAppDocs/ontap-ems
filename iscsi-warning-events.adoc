...
[.lead]
iscsi.warning events are presented when this event is issued if the iSCSI subsystem detects an abnormal state which typically does not require corrective action.
