...
[.lead]
dns.disabled events are presented when the last system to be upgraded in a cluster removes DNS configurations that were marked as disabled which typically does not require corrective action.
