...
[.lead]
nvmf.roce events are presented when there was an internal error while creating a NVMe over RoCE logical network interface (LIF) which is typically fixed by updating configuration.
