...
[.lead]
nodewatchdog.svc events are presented when a service critical to data access fails to respond to service monitoring and is restarted which may require a reboot.
