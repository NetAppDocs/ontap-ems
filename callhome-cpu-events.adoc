...
[.lead]
callhome.cpu events are presented when a CPU fan failed or the fan is spinning too slowly or too fast which may require reseating or replacing affected hardware.
