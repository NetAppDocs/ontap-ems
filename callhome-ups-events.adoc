...
[.lead]
callhome.ups events are presented when line power for an Uninterruptible Power Supply (UPS) system is restored and the battery power is normal which may require contacting NetApp support.
