...
[.lead]
wafl.offline events are presented when the system attempts to place a volume online, but cannot read the volinfo or fsinfo data for the volume which may require contacting NetApp support.
