...
[.lead]
lun.inaccessible events are presented when a LUN or NVMe namespace that is inaccessible due to restore is found in a volume which is typically fixed by following the documented corrective steps.
