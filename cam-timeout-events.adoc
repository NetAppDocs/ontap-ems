...
[.lead]
cam.timeout events are presented when an I/O request to a Common Access Method (CAM) device driver times out which typically does not require corrective action.
