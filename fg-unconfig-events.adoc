...
[.lead]
fg.unconfig EMS events occur when a FlexGroup detects constituents that are not properly configured and have not been removed after a sufficient timeout.
