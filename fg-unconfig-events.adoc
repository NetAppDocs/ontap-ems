...
[.lead]
fg.unconfig events are presented when a FlexGroup detects constituents that are not properly configured and have not been removed after a sufficient timeout which may require contacting NetApp support.
