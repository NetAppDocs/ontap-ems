...
[.lead]
bsdsocket.queuelimit events are presented when the number of connection requests for a socket reaches the maximum number which may require contacting NetApp support.
