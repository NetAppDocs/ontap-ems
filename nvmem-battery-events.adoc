...
[.lead]
nvmem.battery events are presented when the NVMEM battery lacks the capacity to preserve the NVMEM contents for the required minimum of 72 hours which may require reseating or replacing affected hardware.
