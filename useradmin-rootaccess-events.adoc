...
[.lead]
useradmin.rootaccess events are presented when the root account has been enabled or disabled because of the option security.rootaccess.enable which is typically fixed by following the documented corrective steps.
