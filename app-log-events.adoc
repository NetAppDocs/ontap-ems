...
[.lead]
app.log events are presented when this event is issued when an application is in a condition that should be corrected immediately which typically does not require corrective action.
