...
[.lead]
spm.ndmpd events are presented when the Network Data Management Protocol (NDMP) server (ndmpd) involuntarily terminates which may require restarting affected services or nodes.
