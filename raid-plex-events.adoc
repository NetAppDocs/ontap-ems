...
[.lead]
raid.plex events are presented when disks in a plex do not have the same hardware-based pool which may require reseating or replacing affected hardware.
