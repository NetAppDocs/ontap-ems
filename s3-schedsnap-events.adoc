...
[.lead]
s3.schedsnap events are presented when the system fails to create a scheduled S3 bucket snapshot for the given S3 bucket which may require contacting NetApp support.
