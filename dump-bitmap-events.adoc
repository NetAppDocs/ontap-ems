...
[.lead]
dump.bitmap events are presented when during dump restarting and looking for the bitmap file and it is cannot locate, which typically does not require corrective action.
