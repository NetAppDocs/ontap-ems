...
[.lead]
monitor.ioexpansiontemperature events are presented when this warning message occurs when the I/O expansion module is too cold which is typically fixed by following the documented corrective steps.
