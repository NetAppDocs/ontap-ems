...
[.lead]
nv.fake events are presented when the nonvolatile (NV) driver detects that system memory is being used to simulate NVRAM which is typically fixed by following the documented corrective steps.
