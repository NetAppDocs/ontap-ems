...
[.lead]
coredump.segment events are presented when the system encounters an error while trying to send a core segment request which typically does not require corrective action.
