...
[.lead]
san.iscsilifrepaired events are presented when an iSCSI LIF is repaired during Vserver initialization which is typically fixed by following the documented corrective steps.
