...
[.lead]
vifmgr.displaced events are presented when the home port of a displaced logical interface (LIF) has been restored to its original home port which typically does not require corrective action.
