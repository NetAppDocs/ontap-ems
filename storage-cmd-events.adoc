...
[.lead]
storage.cmd events are presented when indicates a user request to balance I/O across initiator ports has been issued which typically does not require corrective action.
