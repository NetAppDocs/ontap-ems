...
[.lead]
monitor.partnercontroller EMS events occur when both controllers are configured as an HA (high-availability) pair, but the partner controller is not present.
