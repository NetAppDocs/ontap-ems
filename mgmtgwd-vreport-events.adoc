...
[.lead]
mgmtgwd.vreport events are presented when the 'debug vreport' command found that some nodes were unreachable which is typically fixed by following the documented corrective steps.
