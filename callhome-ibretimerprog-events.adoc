...
[.lead]
callhome.ibretimerprog events occur when InfiniBand (IB) retimer programming of the high- availability (HA) interconnect link failed after multiple retry attempts.
