...
[.lead]
callhome.ibretimerprog events are presented when infiniBand (IB) retimer programming of the high- availability (HA) interconnect link failed after multiple retry attempts which may require contacting NetApp support.
