...
[.lead]
adt.service EMS events occur when ONTAP encounters issues associated with the audit consolidation service being unable to write to the destination volume hosting the audit logs.
