...
[.lead]
fci.config events occur when the system reboots automatically to enable correct adapter operation after changing the state of a reconfigurable adapter.
