...
[.lead]
secd.rogue events are presented when a CIFS authentication request fails more than 30 times in one minute with an invalid login password from a particular client which is typically fixed by verifying system state and updating configuration.
