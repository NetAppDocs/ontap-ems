...
[.lead]
nvme.link events are presented when the NVMe driver disables the PCIe link due to excessive errors which may require reseating or replacing affected hardware.
