...
[.lead]
volume.transition events are presented when a volume transition plug-in is taking longer than expected which typically does not require corrective action.
