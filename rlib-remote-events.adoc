...
[.lead]
rlib.remote events are presented when this event is generated to print information about remote node such as IP address and sysid along with the event that occurred which typically does not require corrective action.
