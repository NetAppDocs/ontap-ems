...
[.lead]
wafl.bad EMS events occur when ONTAP encounters issues associated with file system buftree type and RAID label format inconsistencies in aggregates or volumes.
