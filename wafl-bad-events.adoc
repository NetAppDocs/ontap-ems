...
[.lead]
wafl.bad events are presented when you attempt to bring an aggregate online whose file system buftree type and RAID label format are inconsistent which may require contacting NetApp support.
