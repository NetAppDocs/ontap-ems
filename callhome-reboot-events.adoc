...
[.lead]
callhome.reboot events are presented when after an appliance reboot--the appliance reports this event after the reboot is complete which may require contacting NetApp support.
