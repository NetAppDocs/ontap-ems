...
[.lead]
config.nopartnerdisks events are presented when in a High-Availablity (HA> configuration when there are no partner disks which is typically fixed by verifying system state and connectivity.
