...
[.lead]
connectx.ibretimerskipprogrm events are presented when infiniBand retimer programming is skipped after the system detects that a cable is plugged in, because there was no change in the cable's type and length which typically does not require corrective action.
