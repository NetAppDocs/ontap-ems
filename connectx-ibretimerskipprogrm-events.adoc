...
[.lead]
connectx.ibretimerskipprogrm EMS events occur when InfiniBand retimer programming is skipped after the system detects that a cable is plugged in, because there was no change in the cable's type and length.
