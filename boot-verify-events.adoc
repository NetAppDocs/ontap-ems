...
[.lead]
boot.verify events are presented when the verification of digitally signed kernel modules has been disabled which may require contacting NetApp support.
