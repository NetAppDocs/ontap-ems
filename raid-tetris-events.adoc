...
[.lead]
raid.tetris events are presented when the system detects a block number mismatch during a write operation which typically does not require corrective action.
