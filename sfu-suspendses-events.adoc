...
[.lead]
sfu.suspendses events are presented when a disk shelf firmware update is requested in a high-availability (HA) environment which typically does not require corrective action.
