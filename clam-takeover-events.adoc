...
[.lead]
clam.takeover events occur when ONTAP encounters issues associated with Connectivity, Liveliness, Availability Monitor (CLAM) initiated takeover operations.
