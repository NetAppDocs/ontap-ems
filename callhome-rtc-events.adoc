...
[.lead]
callhome.rtc events are presented when the voltage for the Real-Time Clock (RTC) battery is low which may require reseating or replacing affected hardware.
