...
[.lead]
raid.sp events are presented when one or more aggregate's capacity is not increased as part of the storage pool add job which may require contacting NetApp support.
