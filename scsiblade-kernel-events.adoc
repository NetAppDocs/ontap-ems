...
[.lead]
scsiblade.kernel events are presented when the kernel cluster group for the specified volume is in an indeterminate state which may require contacting NetApp support.
