...
[.lead]
zapi.snapshot events are presented when this event occurs when an asynchronous Snapshot(tm) copy is created successfully through the Zephyr API (ZAPI) interface which typically does not require corrective action.
