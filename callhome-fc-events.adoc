...
[.lead]
callhome.fc events are presented when a Fibre Channel arbitrated loop (FC-AL) has link failures which is typically fixed by verifying system state and connectivity.
