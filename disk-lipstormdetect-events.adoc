...
[.lead]
disk.lipstormdetect events are presented when a Fibre Channel disk detects a large number of Loop Initialization Procedure requests (a LIP storm) and has reset itself which is typically fixed by following the documented corrective steps.
