...
[.lead]
disk.lipstormdetect EMS events occur when a Fibre Channel disk detects a large number of Loop Initialization Procedure requests (a LIP storm) and has reset itself.
