...
[.lead]
raid.reparity events are presented when the system detects an inconsistent RAID write signature on a RAID stripe, during a RAID reparity operation which typically does not require corrective action.
