...
[.lead]
sm.log events are presented when writing SnapMirror(R) data to a log file fails which is typically fixed by verifying system state and updating configuration.
