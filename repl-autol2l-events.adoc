...
[.lead]
repl.autol2l events are presented when the replication destination engine encounters an unsupported configuration during a transfer with storage efficiency which typically does not require corrective action.
