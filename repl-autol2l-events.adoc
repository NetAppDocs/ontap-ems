...
[.lead]
repl.autol2l EMS events occur when the replication destination engine encounters an unsupported configuration during a transfer with storage efficiency.
