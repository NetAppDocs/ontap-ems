...
[.lead]
rdb.ha events are presented when the management process goes online as the master under two-node 'cluster HA' failover which typically does not require corrective action.
