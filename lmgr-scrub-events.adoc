...
[.lead]
lmgr.scrub events are presented when the internal scrubbing of Remote Lock Entry Metafile (RLEM) fails due to insufficient storage space which is typically fixed by following the documented corrective steps.
