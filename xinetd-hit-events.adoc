...
[.lead]
xinetd.hit events are presented when the rate of incoming network connections for a service exceeds the maximum allowed rate which is typically fixed by following the documented corrective steps.
