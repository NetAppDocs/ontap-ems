...
[.lead]
ses.status events are presented when a failure has been detected in ACP processor that provides alternate control path capability which may require reseating or replacing affected hardware.
