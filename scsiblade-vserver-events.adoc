...
[.lead]
scsiblade.vserver events are presented when a command or other internal operation becomes blocked within Data ONTAP(R) which may require contacting NetApp support.
