...
[.lead]
wafl.repl events are presented when a replication operation receives a timestamp with an invalid nanoseconds portion, and clears it which typically does not require corrective action.
