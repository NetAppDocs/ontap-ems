...
[.lead]
sas.8001 events are presented when the PM8001 serial-attached SCSI (SAS) host bus adapter reports an adapter firmware error which typically does not require corrective action.
