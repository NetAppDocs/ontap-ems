...
[.lead]
disk.outofservice events occur when a drive is removed from service because it has been marked failed, is being sanitized, or has entered Maintenance Center.
