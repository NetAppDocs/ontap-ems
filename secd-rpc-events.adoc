...
[.lead]
secd.rpc events occur when a user with the same domain and same client IP address is blocked due to continuous authentication requests with an invalid login password.
