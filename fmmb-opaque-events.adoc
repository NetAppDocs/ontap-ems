...
[.lead]
fmmb.opaque events are presented when this event is issued when the HA Mailbox opaque header is invalid which typically does not require corrective action.
