...
[.lead]
bootfs.env events are presented when an error is detected while trying to access the environment file stored on the boot device which may require reseating or replacing affected hardware.
