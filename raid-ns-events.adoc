...
[.lead]
raid.ns events are presented when the system removes ownership of its disks during initialization of a non-shared HA system which typically does not require corrective action.
