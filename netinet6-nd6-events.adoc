...
[.lead]
netinet6.nd6 events are presented when the port MTU (Maximum Transmission Unit) is set to a smaller value than the IPv6 minimum MTU of 1280 which is typically fixed by updating configuration.
