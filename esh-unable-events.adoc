...
[.lead]
esh.unable events are presented when a disk shelf cannot be added due to a memory allocation failure during disk shelf discovery processing which may require a reboot.
