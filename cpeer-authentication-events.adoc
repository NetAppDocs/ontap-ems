...
[.lead]
cpeer.authentication events are presented when authentication is successfully established with a peer cluster which typically does not require corrective action.
