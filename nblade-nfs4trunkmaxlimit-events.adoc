...
[.lead]
nblade.nfs4trunkmaxlimit EMS events occur when a session trunking group created by the NFSv41 client exceeds the maximum number of supported trunk connections.
