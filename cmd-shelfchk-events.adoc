...
[.lead]
cmd.shelfchk events are presented when this event is generated while verifying disk shelf cabling and configuration which typically does not require corrective action.
