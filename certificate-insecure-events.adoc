...
[.lead]
certificate.insecure events are presented when an installed certificate uses a hash function that is no longer considered secure which may require reseating or replacing affected hardware.
