...
[.lead]
mcc.switchover EMS events occur when a MetroCluster switchover operation finds a system metadata volume, used by config replication applications, in the nvfailed state.
