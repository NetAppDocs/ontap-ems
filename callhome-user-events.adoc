...
[.lead]
callhome.user events are presented when a SNMP (Simple Network Management Protocol) has been configured to cause an SNMP trap which typically does not require corrective action.
