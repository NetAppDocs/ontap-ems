...
[.lead]
wafl.zombie events are presented when the aggregate encounters the zombie throttling limits during zombie delete processing for large number of file deletions which typically does not require corrective action.
