...
[.lead]
wafl.zombie events occur when the aggregate encounters the zombie throttling limits during zombie delete processing for large number of file deletions.
