...
[.lead]
nameserv.config events are presented when a file write for name service configuration fails which is typically fixed by verifying system state and connectivity.
