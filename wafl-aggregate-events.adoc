...
[.lead]
wafl.aggregate events are presented when an operation is run on an aggregate while the aggregate or any volume of the aggregate is busy which typically does not require corrective action.
