...
[.lead]
aggrcopy.restart events are presented when 'aggr copy' checks for restart capability on the destination storage system fail which is typically fixed by following the documented corrective steps.
