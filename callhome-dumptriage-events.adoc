...
[.lead]
callhome.dumptriage events are presented when kernel dumptriage files are collected for a coredump event which typically does not require corrective action.
