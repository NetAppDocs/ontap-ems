...
[.lead]
reg.errno events are presented when this event is issued when Data ONTAP(tm) cannot add an errno-style error to the list of errors which typically does not require corrective action.
