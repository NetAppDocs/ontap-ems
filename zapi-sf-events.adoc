...
[.lead]
zapi.sf events occur when the M-host layer is operational and has notified the high-availability (HA) subsystem, which can then proceed with certain storage failover operations, such as giveback.
