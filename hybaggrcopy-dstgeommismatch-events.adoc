...
[.lead]
hybaggrcopy.dstgeommismatch events are presented when there is a mismatch between the disk geometries of source and destination hybrid aggregates which is typically fixed by following the documented corrective steps.
