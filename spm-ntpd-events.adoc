...
[.lead]
spm.ntpd events are presented when the Network Time Protocol Daemon process (ntpd) involuntarily terminates which may require restarting affected services or nodes.
