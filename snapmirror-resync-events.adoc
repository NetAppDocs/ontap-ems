...
[.lead]
snapmirror.resync EMS events occur when a flexible volume restored from a snapshot might not be able to relinquish free blocks to its containing aggregate.
