...
[.lead]
arw.snapshot events are presented when a new ARP snapshot is created in anti-ransomware enabled volume which typically does not require corrective action.
