...
[.lead]
vfiler.unable events are presented when during vFiler(tm) unit discovery, if one of the vFiler(tm) unit module initialization functions fails which typically does not require corrective action.
