...
[.lead]
ha.takeoverimpnotdef events are presented when the partner node is down and it is currently impossible to perform a takeover which is typically fixed by verifying system state and connectivity.
