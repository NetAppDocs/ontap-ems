...
[.lead]
license.ontapi events are presented when oNTAPI enablement evaluation license is installed successfully which is typically fixed by following the documented corrective steps.
