...
[.lead]
config.badlocalswitch events are presented when a disk is found to be attached to a switch, but there are also disks attached via local connections which may require contacting NetApp support.
