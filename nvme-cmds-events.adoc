...
[.lead]
nvme.cmds events occur when an NVMe controller detects one or more commands that did not have a command completion response in the allotted time frame.
