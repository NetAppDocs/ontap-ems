...
[.lead]
callhome.ondemand events are presented when NetApp technical support has remotely requested an AutoSupport or 'call home' message of type TEST, which typically does not require corrective action.
