...
[.lead]
callhome.ondemand events occur when this message normally occurs when NetApp technical support has remotely requested an AutoSupport or 'call home' message of type TEST.
