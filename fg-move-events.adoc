...
[.lead]
fg.move events are presented when a user moves a FlexGroup constituent to an unmirrored aggregate on nodes in a MetroCluster(tm) configuration which typically does not require corrective action.
