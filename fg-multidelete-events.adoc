...
[.lead]
fg.multidelete events are presented when a Snapshot copy in an invalid state is deleted from a FlexGroup volume which typically does not require corrective action.
