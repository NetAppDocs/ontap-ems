...
[.lead]
disk.reservedelay events are presented when a SCSI reservation command has a longer latency than expected during takeover which is typically fixed by following the documented corrective steps.
