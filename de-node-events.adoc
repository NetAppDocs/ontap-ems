...
[.lead]
de.node events are presented when the AIDE cluster loses communication with one of its Data Compute Nodes (DCN) which is typically fixed by verifying system state and connectivity.
