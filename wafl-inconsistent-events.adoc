...
[.lead]
wafl.inconsistent events are presented when the ONTAP(R) kernel detects an inconsistent WAFL(R) Access Control List (ACL) on disk which may require contacting NetApp support.
