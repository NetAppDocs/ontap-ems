...
[.lead]
monitor.sparelabelcheckfailed events are presented when the system detects that a hot spare disk has an invalid or a missing label which is typically fixed by following the documented corrective steps.
