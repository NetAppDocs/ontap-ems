...
[.lead]
snmp.fips events are presented when the system fails to delete SNMP traphosts and users that are not FIPS compliant which is typically fixed by following the documented corrective steps.
