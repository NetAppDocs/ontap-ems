...
[.lead]
spm.perfstatd events are presented when the perfstat daemon (perfstatd) involuntarily terminates which may require restarting affected services or nodes.
