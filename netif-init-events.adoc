...
[.lead]
netif.init events are presented when initialization of a network interface failed due to an unexpected software error which may require contacting NetApp support.
