...
[.lead]
spm.named events are presented when the Domain Name Service (DNS) name resolution daemon 'named' involuntarily exits which may require contacting NetApp support.
