...
[.lead]
lun.create events are presented when a LUN is created in a volume that is in the nvfailed state which is typically fixed by following the documented corrective steps.
