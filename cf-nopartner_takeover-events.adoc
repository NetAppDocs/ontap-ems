...
[.lead]
cf.nopartner_takeover events occur when the partner node fails but requested not to be taken over to prevent multiple, simultaneous RAID reconstructs from starting.
