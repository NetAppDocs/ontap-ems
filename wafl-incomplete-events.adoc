...
[.lead]
wafl.incomplete events are presented when the WAFL(R) kernel detects incomplete inode to path information for an inode on disk, which may require contacting NetApp support.
