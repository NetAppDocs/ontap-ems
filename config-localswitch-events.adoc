...
[.lead]
config.localswitch events are presented when a disk is found attached via both local connection and a switch which typically does not require corrective action.
