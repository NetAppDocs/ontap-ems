...
[.lead]
nblade.vscanbadprotomagicnum events are presented when an incorrectly formatted message is received from the AV Connector which is typically fixed by following the documented corrective steps.
