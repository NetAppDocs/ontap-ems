...
[.lead]
snapmirror.copy events are presented when the baseline transfer of a SnapMirror(R) copy for a volume is completed and the volume comes online which typically does not require corrective action.
