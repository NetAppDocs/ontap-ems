...
[.lead]
callhome.bdfu events are presented when drive unlock fails for firmware download on a FIPS-certified NetApp Storage Encryption SAS drive which may require contacting NetApp support.
