...
[.lead]
revertto.force events are presented when a revert-to process is being initiated with the "force" flag, and configuration errors have been detected which typically does not require corrective action.
