...
[.lead]
connectx.portdisabled events are presented when the HA interconnect port experiences persistent node advertisement send timeouts which may require a reboot.
