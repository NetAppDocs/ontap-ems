...
[.lead]
ha.panicinfonotsent events are presented when a node cannot send panic information to its high-availability (HA) partner over the HA interconnect which typically does not require corrective action.
