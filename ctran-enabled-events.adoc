...
[.lead]
ctran.enabled events are presented when kernel Cluster Services (KCS) Cluster Transaction Manager (CTRAN) subsystem is enabled which is typically fixed by following the documented corrective steps.
