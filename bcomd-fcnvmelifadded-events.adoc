...
[.lead]
bcomd.fcnvmelifadded events are presented when an FC NVMe (Nonvolatile Memory Express) logical interface (LIF) is added which typically does not require corrective action.
