...
[.lead]
se.changelog events are presented when single Instance Storage (SIS) change logging metafile is full during migration workflow through Snapmirror which is typically fixed by following the documented corrective steps.
