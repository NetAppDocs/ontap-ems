...
[.lead]
wafl.split events are presented when this event indicates that the split inofile scan has completed which typically does not require corrective action.
