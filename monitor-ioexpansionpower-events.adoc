...
[.lead]
monitor.ioexpansionpower events are presented when indicates that power on the I/O expansion module is degraded which may require contacting NetApp support.
