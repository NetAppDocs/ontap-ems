...
[.lead]
sfo.ignoretakeover events are presented when the environment indicating that mailbox takeover state should be rewritten could not be removed which is typically fixed by following the documented corrective steps.
