...
[.lead]
secd.netlogon events are presented when none of the configured Netlogon servers are accepting connections which is typically fixed by following the documented corrective steps.
