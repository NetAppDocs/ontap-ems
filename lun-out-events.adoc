...
[.lead]
lun.out events are presented when a LUN is brought offline by the SCSI layer because of a write failure due to lack of space which is typically fixed by following the documented corrective steps.
