...
[.lead]
vldb.aggregateuuid events occur when ONTAP encounters issues associated with aggregate Universally Unique Identifier (UUID) mismatches or missing entries in the Volume Location Database.
