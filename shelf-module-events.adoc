...
[.lead]
shelf.module events are presented when the system cannot complete the configuration of a disk shelf module with the desired parameters which may require contacting NetApp support.
