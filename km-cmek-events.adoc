...
[.lead]
km.cmek events occur when the configured Azure Key Vault Key Management Service (AKV-KMS) transitions to the active state after previously being in the blocked state.
