...
[.lead]
km.cmek events are presented when the configured Azure Key Vault Key Management Service (AKV-KMS) transitions to the active state after previously being in the blocked state which typically does not require corrective action.
