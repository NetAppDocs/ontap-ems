...
[.lead]
wafl.enc events are presented when the system detects a corrupted WAFL aggregate encryption keys metafile and creates a corrected replacement which typically does not require corrective action.
