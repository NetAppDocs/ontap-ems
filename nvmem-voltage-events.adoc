...
[.lead]
nvmem.voltage events are presented when the NVMEM supply voltage is high and the system is at a high risk of data loss if power fails which may require reseating or replacing affected hardware.
