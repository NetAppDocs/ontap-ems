...
[.lead]
sms.failed events are presented when a SnapMirror(R) Sync relationship cannot be established due to precheck failures which is typically fixed by verifying system state and connectivity.
