...
[.lead]
vsdr.periodic events are presented when the Vserver DR subsystem periodic check detects issues with the Vserver DR components which may require contacting NetApp support.
