...
[.lead]
dump.xfercomplete events are presented when the dump engine completes data backup with disk errors in user files which may require contacting NetApp support.
