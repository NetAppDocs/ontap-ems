...
[.lead]
nvmens.out events are presented when an NVMe namespace has been brought offline because of a write failure due to lack of space which is typically fixed by updating configuration.
