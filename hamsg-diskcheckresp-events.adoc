...
[.lead]
hamsg.diskcheckresp events are presented when a node receives a disk inventory check response from its high-availability (HA) partner which typically does not require corrective action.
