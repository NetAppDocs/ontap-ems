...
[.lead]
ztl.smap events are presented when the specified partition on a SSD-ZNS drive could not be onlined due to internal S/W or device error which typically does not require corrective action.
