...
[.lead]
mw.iron events are presented when is used to notify idlog purge at mount after 7 consecutive unsuccessful iron runs which typically does not require corrective action.
