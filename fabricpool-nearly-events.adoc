...
[.lead]
fabricpool.nearly events are presented when the total, cluster-wide FabricPool space usage of object stores from capacity-licensed providers has nearly reached the license limit which is typically fixed by verifying system state and updating configuration.
