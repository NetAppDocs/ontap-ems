...
[.lead]
clam.update events occur when the Kernel Cluster Services (KCS) Connectivity, Liveliness, Availability Monitor (CLAM) updates the failover state of the partner.
