...
[.lead]
clam.update events are presented when the Kernel Cluster Services (KCS) Connectivity, Liveliness, Availability Monitor (CLAM) updates the failover state of the partner which typically does not require corrective action.
