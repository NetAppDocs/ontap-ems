...
[.lead]
config.disknoswitch events are presented when a disk is found to be attached to a switch, but it's not supported for a switch configuration which may require contacting NetApp support.
