...
[.lead]
dfu.fwdownloadfailedstatus events are presented when a firmware download failure occurs which is typically fixed by following the documented corrective steps.
