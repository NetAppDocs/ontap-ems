...
[.lead]
wafl.aggrtrans events are presented when an aggregate transition operation encounters a corrupted aggregate which is typically fixed by following the documented corrective steps.
