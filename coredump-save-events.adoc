...
[.lead]
coredump.save events are presented when the savecore operation is aborted while saving a kernel core which typically does not require corrective action.
