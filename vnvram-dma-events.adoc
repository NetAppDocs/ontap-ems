...
[.lead]
vnvram.dma events are presented when a vNVRAM flush operation on an ONTAP-v system is taking too much time which is typically fixed by verifying system state and connectivity.
