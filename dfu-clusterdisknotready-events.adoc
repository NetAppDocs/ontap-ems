...
[.lead]
dfu.clusterdisknotready events are presented when the controller failover partner reports that a disk selected for download is in the NOT READY state which is typically fixed by following the documented corrective steps.
