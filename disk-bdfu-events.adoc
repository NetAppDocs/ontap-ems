...
[.lead]
disk.bdfu EMS events occur when the background drive firmware update process fails to unlock SAS NetApp(R) Storage Encryption (NSE) drives in FIPS-compliance mode.
