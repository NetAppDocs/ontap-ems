...
[.lead]
netinet6.nbr events are presented when oNTAP receives unexpected Neighbor Discovery (ND) packets which is typically fixed by verifying system state and connectivity.
