...
[.lead]
diskown.incorrectownername events are presented when this event is issued when we find a system finds a disk that it owns, but which has a different owner name than the system name which typically does not require corrective action.
