...
[.lead]
mcc.config events are presented when the MetroCluster(tm) local node configuration assignment to persistent storage failed which may require contacting NetApp support.
