...
[.lead]
callhome.carrier events are presented when all the disks in the carrier, that contains more than one disk in it, have failed which may require reseating or replacing affected hardware.
