...
[.lead]
nblade.exportaccesschkfailed events are presented when the network blade denies access to an exported share when a connection attempt violates an export policy which is typically fixed by verifying system state and connectivity.
