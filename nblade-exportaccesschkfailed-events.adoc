...
[.lead]
nblade.exportaccesschkfailed EMS events occur when the network blade denies access to an exported share when a connection attempt violates an export policy.
