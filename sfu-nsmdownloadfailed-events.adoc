...
[.lead]
sfu.nsmdownloadfailed events are presented when a disk shelf firmware update fails to download disk shelf firmware to a disk shelf successfully which is typically fixed by updating configuration.
