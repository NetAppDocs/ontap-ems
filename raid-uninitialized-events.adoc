...
[.lead]
raid.uninitialized events are presented when periodically to warn the user that the aggregate has no RAID protection and that data loss can occur if a disk fails which may require contacting NetApp support.
