...
[.lead]
raid.uninitialized EMS events occur periodically to warn the user that the aggregate has no RAID protection and that data loss can occur if a disk fails.
