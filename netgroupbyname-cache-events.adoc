...
[.lead]
netgroupbyname.cache events are presented when a host is checked for its membership in a netgroup that contains a large number of members which is typically fixed by updating configuration.
