...
[.lead]
air.qtm events are presented when the state of a scanner used to rebuild the qtree metafile changes which typically does not require corrective action.
