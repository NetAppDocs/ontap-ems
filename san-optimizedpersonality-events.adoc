...
[.lead]
san.optimizedpersonality events are presented when a mismatch is detected between the san-optimized personality of a node and the cluster which may require contacting NetApp support.
