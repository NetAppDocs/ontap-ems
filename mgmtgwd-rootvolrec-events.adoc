...
[.lead]
mgmtgwd.rootvolrec events are presented when the system detects that the root volume is dangerously low on space which may require contacting NetApp support.
