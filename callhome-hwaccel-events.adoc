...
[.lead]
callhome.hwaccel events are presented when the hardware accelerator gets certain threshold number of errors and collects related diagnostic data concerning the device which typically does not require corrective action.
