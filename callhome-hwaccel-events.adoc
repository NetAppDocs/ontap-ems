...
[.lead]
callhome.hwaccel events occur when the hardware accelerator gets certain threshold number of errors and collects related diagnostic data concerning the device.
