...
[.lead]
fci.discovery events are presented when the Fibre Channel adapter driver cannot complete device discovery within the specified time which typically does not require corrective action.
