...
[.lead]
iscsi.notice events are presented when this event is issued when a loggable, non-error event occurs within the iSCSI subsystem which typically does not require corrective action.
