...
[.lead]
iscsi.notice events are presented when a loggable, non-error event occurs within the iSCSI subsystem, which typically does not require corrective action.
