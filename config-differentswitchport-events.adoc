...
[.lead]
config.differentswitchport events are presented when the two ports of the disk are connected to different switch ports which typically does not require corrective action.
