...
[.lead]
fg.inactive events are presented when the system automatically deletes an inactive FlexGroup constituent that existed only in the data component which typically does not require corrective action.
