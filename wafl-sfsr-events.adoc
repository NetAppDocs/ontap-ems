...
[.lead]
wafl.sfsr events are presented when this event is issued when the system is forced to abort a file restore which typically does not require corrective action.
