...
[.lead]
callhome.nvmem events are presented when the sensor for the Non-Volatile memory (NVMEM) card lithium battery has an excessively high voltage which may require reseating or replacing affected hardware.
