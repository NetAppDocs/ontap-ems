...
[.lead]
callhome.sp events are presented when oNTAP(R) does not receive an expected "heartbeat" signal from the Service Processor (SP) which may require contacting NetApp support.
