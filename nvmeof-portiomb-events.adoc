...
[.lead]
nvmeof.portiomb events are presented when there are no longer two ports cabled incorrectly from a node to bottom module (B) on a shelf which typically does not require corrective action.
