...
[.lead]
nvpm.extend events are presented when nvlog client segments cannot be enabled in a partner NVRAM section following a controller failover or MetroCluster(R) switchover which may require a reboot.
