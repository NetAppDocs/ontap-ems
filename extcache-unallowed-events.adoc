...
[.lead]
extcache.unallowed events are presented when an external cache bootarg or setflag is set without the required privilege which typically does not require corrective action.
