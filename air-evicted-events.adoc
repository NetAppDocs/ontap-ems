...
[.lead]
air.evicted events occur when the Automated Incremental Repair (AIR) subsystem evicts an entry in the qtree metafile because of inconsistent data within that entry.
