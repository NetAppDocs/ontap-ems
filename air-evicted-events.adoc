...
[.lead]
air.evicted events are presented when the Automated Incremental Repair (AIR) subsystem evicts an entry in the qtree metafile because of inconsistent data within that entry which typically does not require corrective action.
