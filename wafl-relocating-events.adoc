...
[.lead]
wafl.relocating events are presented when the system cannot perform an aggregate relocation because a fence is set on one of the volumes in the aggregate which may require contacting NetApp support.
