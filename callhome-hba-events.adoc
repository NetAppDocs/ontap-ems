...
[.lead]
callhome.hba events are presented when a HBA port is taken offline due to read-after-write verification errors which may require contacting NetApp support.
