...
[.lead]
disk.lun events occur to confirm that enough memory is present to successfully allocate command blocks for all of the disks in the system and for additional LUNS.
