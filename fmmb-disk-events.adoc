...
[.lead]
fmmb.disk events are presented when the unique identifier of one of the disks used by the HA mailbox has changed, which typically does not require corrective action.
