...
[.lead]
acp.locked events occur when ONTAP encounters issues associated with the link status of the locked wrench Ethernet port on the back of the storage controller.
