...
[.lead]
wafl.svo events are presented when this event is generated if a write to a svo enabled volume fails to pass a check which typically does not require corrective action.
