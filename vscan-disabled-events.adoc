...
[.lead]
vscan.disabled events are presented when a Vserver or cluster administrator disables Vscan on a Vserver which typically does not require corrective action.
