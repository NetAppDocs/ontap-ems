...
[.lead]
coredump.compress events are presented when an error was encountered while compressing data for the coredump which typically does not require corrective action.
