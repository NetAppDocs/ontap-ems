...
[.lead]
wafl.encryption events are presented when the system takes offline an encrypted virtual volume because encryption became unsupported which may require a reboot.
