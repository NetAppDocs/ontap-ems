...
[.lead]
callhome.hainterconnect events are presented when the high-availability (HA) interconnect is down which is typically fixed by verifying system state and connectivity.
