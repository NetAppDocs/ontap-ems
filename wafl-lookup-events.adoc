...
[.lead]
wafl.lookup events are presented when the system encounters an unexpected deleted directory entry in a snapmirrored qtree which is typically fixed by following the documented corrective steps.
