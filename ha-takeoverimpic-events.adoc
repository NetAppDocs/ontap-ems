...
[.lead]
ha.takeoverimpic events are presented when the partner node is down and the local node cannot perform a takeover because of interconnect errors which is typically fixed by verifying system state and connectivity.
