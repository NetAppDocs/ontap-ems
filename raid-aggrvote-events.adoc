...
[.lead]
raid.aggrvote events are presented when the mirror vote pull from the replicated database (RDB) to the mailbox fails which typically does not require corrective action.
