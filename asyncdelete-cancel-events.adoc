...
[.lead]
asyncdelete.cancel events are presented when cancellation of async delete jobs is started on a node due to Vserver migrate operation which may require restarting affected services or nodes.
