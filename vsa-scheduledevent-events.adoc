...
[.lead]
vsa.scheduledevent events are presented when oNTAP(R) software is running as an instance in Azure and a NIC SR-IOV driver detach event is detected which typically does not require corrective action.
