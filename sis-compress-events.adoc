...
[.lead]
sis.compress events are presented when postprocess compression is skipped during a deduplication operation, even though postprocess compression is enabled on the volume which typically does not require corrective action.
