...
[.lead]
sis.compress events occur when postprocess compression is skipped during a deduplication operation, even though postprocess compression is enabled on the volume.
