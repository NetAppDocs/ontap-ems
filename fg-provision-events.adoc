...
[.lead]
fg.provision events are presented when a user provisions a FlexGroup on unmirrored aggregates on nodes in a MetroCluster(tm) configuration which typically does not require corrective action.
