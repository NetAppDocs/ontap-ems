...
[.lead]
ses.multipath events are presented when the AT-FCX disk shelf module does not support the multipath high-availability (Multipath HA) configuration which may require reseating or replacing affected hardware.
