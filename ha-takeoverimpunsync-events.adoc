...
[.lead]
ha.takeoverimpunsync EMS events occur when the partner node is down and it is currently impossible to perform a takeover because the takeover node does not have partner NVRAM data.
