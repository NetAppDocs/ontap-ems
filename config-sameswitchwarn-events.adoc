...
[.lead]
config.sameswitchwarn events are presented when both ports of a disk are found to be attached to the same switch which is typically fixed by following the documented corrective steps.
