...
[.lead]
aws.instance events are presented when instance metadata retrieval fails on a hypervisor hosting an Amazon Web Services (AWS) ONTAP instance which may require contacting NetApp support.
