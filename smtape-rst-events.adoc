...
[.lead]
smtape.rst events are presented when an SMTape restore operation from tape is aborted due to checksum error which may require contacting NetApp support.
