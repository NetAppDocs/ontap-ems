...
[.lead]
telnet.enabled events are presented when telnet is enabled in the cluster using the (privilege: advanced) "security protocol" command which typically does not require corrective action.
