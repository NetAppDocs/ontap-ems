...
[.lead]
lmgr.precommit events are presented when the system fails aggregate giveback or relocation because SMB oplock or NFSv4 delegation recall fails which may require a reboot.
