...
[.lead]
sis.max events are presented when single Instance Storage (SIS) savings on the volume is nearing its maximum limit which typically does not require corrective action.
