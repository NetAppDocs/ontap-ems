...
[.lead]
adminapi.xml events are presented when in case of a mismatched XML encoding received by ONTAP server, which is typically fixed by following the documented corrective steps.
