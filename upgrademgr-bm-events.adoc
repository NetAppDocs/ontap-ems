...
[.lead]
upgrademgr.bm events are presented when the upgrade manager starts to update boot media of the node with the target ONTAP image which typically does not require corrective action.
