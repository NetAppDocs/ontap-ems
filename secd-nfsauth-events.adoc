...
[.lead]
secd.nfsauth events occur when an NFS authorization attempt fails because of the inability of the system to retrieve a matching CIFS credential for use in multi-protocol security operations.
