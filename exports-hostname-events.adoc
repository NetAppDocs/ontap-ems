...
[.lead]
exports.hostname events occur when the forward lookup record mapping a host name to its IP address is not found in the configured name servers in a Vserver.
