...
[.lead]
snaplock.trans events are presented when autocommit period is adjusted on a Snaplock volume upon transition which typically does not require corrective action.
