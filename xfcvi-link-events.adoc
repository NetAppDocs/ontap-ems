---
sidebar: sidebar
permalink: xfcvi-link-events.html
keywords: ems, message, messages, event, events, group, catalog
summary: xfcvi.link events
---
...
[.lead]
xfcvi.link events are presented when the physical link of the Fibre Channel Virtual Interface (FC-VI) adapter goes down which is typically fixed by verifying system state and connectivity.
