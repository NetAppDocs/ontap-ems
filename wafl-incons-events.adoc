...
[.lead]
wafl.incons events are presented when the WAFL(R) kernel detects inconsistent compression metadata for a compression group which is typically fixed by verifying system state and updating configuration.
