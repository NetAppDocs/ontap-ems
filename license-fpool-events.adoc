...
[.lead]
license.fpool events are presented when the maximum storage capacity limit for FabricPool is changed which typically does not require corrective action.
