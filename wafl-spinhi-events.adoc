...
[.lead]
wafl.spinhi events are presented when a new spinnp error is being propagated to a blade that does not understand that error yet which typically does not require corrective action.
