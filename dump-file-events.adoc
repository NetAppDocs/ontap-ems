...
[.lead]
dump.file events are presented when the dump engine encounters an NFS security label during any type of dump operation which typically does not require corrective action.
