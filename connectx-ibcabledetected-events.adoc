...
[.lead]
connectx.ibcabledetected events are presented when an InfiniBand cable is detected on the InfiniBand port which typically does not require corrective action.
