...
[.lead]
netif.tcp events are presented when a bad checksum is detected in the incoming TCP packets which is typically fixed by verifying system state and connectivity.
