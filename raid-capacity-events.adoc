...
[.lead]
raid.capacity events are presented when the system creates a new aggregate, or registers a new capacity for an existing aggregate which typically does not require corrective action.
