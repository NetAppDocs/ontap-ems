...
[.lead]
vifmgr.subnet events are presented when an address is successfully acquired from a subnet's available-ranges list which typically does not require corrective action.
