...
[.lead]
callhome.vfiler events occur on the destination controller during the final phase of migrating a vfiler when the 120 second time limit has been reached.
