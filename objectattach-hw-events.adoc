...
[.lead]
objectattach.hw events are presented when an object store attach failed due to an unsupported hardware configuration which typically does not require corrective action.
