...
[.lead]
disk.min events are presented when a disk is detected that is not supported in this version of Data ONTAP(R) which may require reseating or replacing affected hardware.
