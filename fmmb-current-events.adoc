...
[.lead]
fmmb.current events are presented when this event is issued when HA mailbox disks are discovered or allocated which typically does not require corrective action.
