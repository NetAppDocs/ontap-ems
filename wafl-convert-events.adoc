...
[.lead]
wafl.convert events are presented when a directory cannot be safely converted to Unicode format which is typically fixed by verifying system state and updating configuration.
