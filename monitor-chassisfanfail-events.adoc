...
[.lead]
monitor.chassisfanfail events are presented when multiple chassis fans have failed, and the system will shut down in a few minutes unless corrected which may require restarting affected services or nodes.
