...
[.lead]
asa.personality events are presented when the cluster personality has been changed to an All SAN Array which typically does not require corrective action.
