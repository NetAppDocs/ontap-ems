...
[.lead]
callhome.shlf events occur when the system detects faulty hardware on the disk shelf, such as a fan, power supply unit (PSU), or failing temperature sensor.
