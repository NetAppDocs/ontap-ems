...
[.lead]
nblade.sharemaxconnlimit events are presented when a CIFS share exceeds its maximum configured connection limit which is typically fixed by updating configuration.
