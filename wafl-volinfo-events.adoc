...
[.lead]
wafl.volinfo events are presented when there is an error while reading the volinfo or fsinfo block of a volume which is typically fixed by following the documented corrective steps.
