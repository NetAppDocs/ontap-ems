...
[.lead]
quota.softlimit events are presented when a user exceeds the soft quota limit (file and/or block limit) which typically does not require corrective action.
