...
[.lead]
hotplug.generic events are presented when a module replacement or removal command fails because the driver or system is busy which may require contacting NetApp support.
