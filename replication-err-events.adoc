...
[.lead]
replication.err events are presented when the replication engine fails to create an automatic snapshot which is typically fixed by following the documented corrective steps.
