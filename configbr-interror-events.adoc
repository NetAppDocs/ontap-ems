...
[.lead]
configbr.interror events are presented when an attempt to create a configuration backup file encountered an internal software error which is typically fixed by following the documented corrective steps.
