...
[.lead]
coredump.nvlog events are presented when one or more unsuccessful attempts have been made to process information in the WAFL (R) NVlog after a previous failure which may require a reboot.
