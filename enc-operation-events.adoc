...
[.lead]
enc.operation events are presented when rekey or conversion to encryption operation is completed in a flexible volume which typically does not require corrective action.
