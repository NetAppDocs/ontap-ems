...
[.lead]
connectx.ibretimerprogrmpass events occur when InfiniBand retimer programming is succesfully completed after the system detects that a cable is plugged in.
