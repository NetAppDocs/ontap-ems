...
[.lead]
wafl.volume events are presented when a volume comes online with a corrupted or unavailable character mapping configuration which may require contacting NetApp support.
