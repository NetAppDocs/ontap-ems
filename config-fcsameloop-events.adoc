...
[.lead]
config.fcsameloop events are presented when a disk is multipathed to the same Fibre Channel loop which is typically fixed by following the documented corrective steps.
