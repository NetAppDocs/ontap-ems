...
[.lead]
secd.unixlookupfailure events are presented when an UNIXi(R) user or group lookup fails which is typically fixed by verifying system state and updating configuration.
