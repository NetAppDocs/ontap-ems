...
[.lead]
mgmtgwd.sign events are presented when a digital certificate for a Vserver expires which is typically fixed by following the documented corrective steps.
