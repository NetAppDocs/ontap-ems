...
[.lead]
raid.enable events are presented when this event is issued when RAID sub system enables recording in the partner's NVRAM entries for the log based file system which may require reseating or replacing affected hardware.
