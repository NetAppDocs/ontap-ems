...
[.lead]
msata.unable events are presented when data ONTAP(R) module that is responsible for monitoring the health of the mSATA device cannot extract health information from the associated device which may require reseating or replacing affected hardware.
