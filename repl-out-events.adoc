...
[.lead]
repl.out events are presented when replication source is asked to send certain blocks out of band because the replica volume did a snapshot restore which typically does not require corrective action.
