...
[.lead]
coredump.all events are presented when all disks available to coredump already contain unsaved cores which is typically fixed by following the documented corrective steps.
