...
[.lead]
spm.pipd events are presented when the post-ingest processing daemon (pipd) involuntarily terminates which may require restarting affected services or nodes.
