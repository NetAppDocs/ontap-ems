...
[.lead]
wafl.fs events are presented when the fractional reservation value for a volume is found to be corrupted during volume mount, which typically does not require corrective action.
