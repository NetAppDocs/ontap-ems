...
[.lead]
wafl.fs events are presented when during volume mount, when the fractional reservation value for a volume is found to be corrupted which typically does not require corrective action.
