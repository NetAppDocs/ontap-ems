...
[.lead]
cmd.sasadmin events are presented when an adapter firmware update failure occurs which is typically fixed by verifying system state and updating configuration.
