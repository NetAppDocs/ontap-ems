...
[.lead]
fabricpool.scu events are presented when contact has resumed between ONTAP and the Service Control Unit that is used with cloud subscription licenses which typically does not require corrective action.
