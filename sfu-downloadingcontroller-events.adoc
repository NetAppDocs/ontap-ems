...
[.lead]
sfu.downloadingcontroller events are presented when a disk shelf firmware download starts on a specific disk shelf which typically does not require corrective action.
