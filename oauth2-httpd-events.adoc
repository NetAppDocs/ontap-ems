...
[.lead]
oauth2.httpd events are presented when the httpd process fails to restart when the OAuth 2.0 status changes which may require contacting NetApp support.
