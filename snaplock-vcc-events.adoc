...
[.lead]
snaplock.vcc events are presented when the system detects mismatch in the SnapLock(R) volume compliance clock association with the system compliance clock which typically does not require corrective action.
