...
[.lead]
nodewatchdog.resrc events are presented when a critical system resource required for Data ONTAP(R) to continue serving data cannot be allocated for an extended period of time which may require a reboot.
