...
[.lead]
flexcache.featuredisabled events are presented when an attempt is made to mount a FlexCache volume which is typically fixed by verifying system state and connectivity.
