...
[.lead]
nblade.cifsnbnameconflict events occur when the NetBIOS Name Service receives a negative response from a remote machine for a name registration request.
