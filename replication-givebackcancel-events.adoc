...
[.lead]
replication.givebackcancel events are presented when a 'giveback' command is issued while a SnapMirror(R) or SnapVault(R) transfer is in progress which typically does not require corrective action.
