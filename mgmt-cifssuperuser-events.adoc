...
[.lead]
mgmt.cifssuperuser events are presented when configuration of a CIFS super-user fails; CIFS access through this account may not grant full super-user privileges which is typically fixed by verifying system state and connectivity.
