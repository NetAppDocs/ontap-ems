...
[.lead]
mgmt.cifssuperuser events occur when configuration of a CIFS super-user fails; CIFS access through this account may not grant full super-user privileges.
