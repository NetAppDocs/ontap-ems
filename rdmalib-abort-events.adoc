...
[.lead]
rdmalib.abort events are presented when a remote NVLOG operation is aborted due to an error, which is logged here which typically does not require corrective action.
