...
[.lead]
monitor.mismatch events are presented when the version of ONTAP(R) is not supported on this hardware which may require reseating or replacing affected hardware.
