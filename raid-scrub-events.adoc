...
[.lead]
raid.scrub events are presented when scrub cannot be scheduled as specified by the "raid.scrub.schedule" option which typically does not require corrective action.
