...
[.lead]
iclink.probe events are presented when the system cannot detect a High Availability (HA) interconnect card, making HA communication inoperable which is typically fixed by verifying system state and connectivity.
