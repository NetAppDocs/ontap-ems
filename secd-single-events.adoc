...
[.lead]
secd.single events are presented when the trusted domains for the CIFS home domain of a Vserver contains a single-label domain (SLD) which is typically fixed by following the documented corrective steps.
