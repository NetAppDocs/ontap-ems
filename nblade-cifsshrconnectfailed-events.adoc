...
[.lead]
nblade.cifsshrconnectfailed events are presented when the network blade cannot connect to the path specified in the CIFS share which is typically fixed by verifying system state and connectivity.
