...
[.lead]
acp.voltage events are presented when a 'voltage status' request that was sent to the Alternate Controller Path Processor fails which typically does not require corrective action.
