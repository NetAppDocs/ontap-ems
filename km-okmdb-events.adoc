...
[.lead]
km.okmdb events are presented when a read of the Onboard Key Manager's database file fails which is typically fixed by verifying system state and connectivity.
