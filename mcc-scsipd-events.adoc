...
[.lead]
mcc.scsipd events are presented when iSCSI session maintenance thread was signaled to reconnect and destroy SIM paths which typically does not require corrective action.
