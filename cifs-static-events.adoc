...
[.lead]
cifs.static EMS events occur when a user creates a static home directory without a substitution value (%u or %w) to uniquely identify a home directory share.
