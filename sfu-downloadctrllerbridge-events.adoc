...
[.lead]
sfu.downloadctrllerbridge events are presented when a disk shelf firmware download starts on a particular disk shelf which typically does not require corrective action.
