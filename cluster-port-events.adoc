...
[.lead]
cluster.port events are presented when the cluster ports are operating at an unsupported speed which is typically fixed by following the documented corrective steps.
