...
[.lead]
ha.takeover events are presented when the value of the 'bypass-takeover-optimization' parameter of the "storage failover" command is changed on a node which typically does not require corrective action.
