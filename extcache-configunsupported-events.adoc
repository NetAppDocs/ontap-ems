...
[.lead]
extcache.configunsupported EMS events occur when the controller contains an external cache hardware configuration that cannot be supported on the controller.
