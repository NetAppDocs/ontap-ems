...
[.lead]
diskown.delayed events are presented when the software disk ownership module completes the process of updating its view of the disks attached to the system but delays notifying other layers of the completion of this process which typically does not require corrective action.
