...
[.lead]
fci.set events are presented when the World-Wide Name (WWN) for this adapter is set to the value in the fci-wwn-"adapter_name" bootarg which typically does not require corrective action.
