...
[.lead]
net.ifconfig events are presented when the limit for adding logical virtual local area network (VLAN) and interface group (ifgrp) interfaces is exceeded which is typically fixed by following the documented corrective steps.
