...
[.lead]
mpt.action events are presented when the system bus is reset in the message processing technology (MPT) adapter driver which typically does not require corrective action.
