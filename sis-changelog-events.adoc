...
[.lead]
sis.changelog events are presented when the Single Instance Storage (SIS) change logging metafile is full which is typically fixed by following the documented corrective steps.
