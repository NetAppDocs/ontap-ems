...
[.lead]
pha.dev events are presented when oNTAP(R)software fails to get a drives's capacity after an extended wait which is typically fixed by following the documented corrective steps.
