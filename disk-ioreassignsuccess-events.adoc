...
[.lead]
disk.ioreassignsuccess events are presented when a medium error is detected on a disk and the sector reassignment succeeds which typically does not require corrective action.
