...
[.lead]
wafl.err events are presented when a level 1 indirect block with given block number is not found in a compacted block which typically does not require corrective action.
