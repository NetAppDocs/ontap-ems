...
[.lead]
callhome.appdm events are presented when the Application Data Management feature encounters an error while attempting to restore an application from a snapshot which is typically fixed by verifying system state and connectivity.
