...
[.lead]
callhome.appdm events occur when the Application Data Management feature encounters an error while attempting to restore an application from a snapshot.
