...
[.lead]
wafl.sparse events are presented when this event is issued when a sparse config metafile can not be removed in recycling bin which typically does not require corrective action.
