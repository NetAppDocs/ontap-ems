...
[.lead]
connectx.cmdinterface events are presented when the command interface of ConnectX HA interconnect hardware is temporarily hung which is typically fixed by following the documented corrective steps.
