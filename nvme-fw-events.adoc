...
[.lead]
nvme.fw events are presented when new firmware has been successfully activated on the drive and running normally which typically does not require corrective action.
