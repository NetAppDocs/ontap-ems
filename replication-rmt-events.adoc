...
[.lead]
replication.rmt events are presented when the remote system of a SnapMirror(R) or SnapVault(R) transfer does not have a host name which is typically fixed by updating configuration.
