...
[.lead]
vscan.newversion events are presented when the Vscan version mechanism allocates a new version-ID corresponding to the Vscan server version which typically does not require corrective action.
