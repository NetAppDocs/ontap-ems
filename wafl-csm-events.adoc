...
[.lead]
wafl.csm events are presented when the Cluster Session Manager (CSM) session is stopped as part of the shutdown process which typically does not require corrective action.
