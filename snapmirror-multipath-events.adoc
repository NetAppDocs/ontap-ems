...
[.lead]
snapmirror.multipath EMS events occur when during boot or during takeover when the filer is unable to setup the necessary infrastructure required for SnapMirror multipathing support.
