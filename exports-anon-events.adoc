...
[.lead]
exports.anon events are presented when we cannot get UNIX credentials for a user id when evaluating the "-anon" portion of an export-policy rule which is typically fixed by following the documented corrective steps.
