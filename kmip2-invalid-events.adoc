...
[.lead]
kmip2.invalid events are presented when oNTAP cannot push a key to a KMIP key server because the key has an invalid length which typically does not require corrective action.
