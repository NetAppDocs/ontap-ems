...
[.lead]
wafl.buf events are presented when the system encounters a bad header in the snapshot of the active map block of the filesystem which may require contacting NetApp support.
