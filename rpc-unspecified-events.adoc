...
[.lead]
rpc.unspecified events are presented when this event is issued when turning an ypgroup update fails to occur which typically does not require corrective action.
