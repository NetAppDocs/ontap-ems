...
[.lead]
gpo.sec events are presented when applying group policy object (GPO) event audit policy settings succeeds which typically does not require corrective action.
