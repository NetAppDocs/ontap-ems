...
[.lead]
cr.redir events are presented when the data scanner skips an inode for which it cannot access the redirector file which is typically fixed by following the documented corrective steps.
