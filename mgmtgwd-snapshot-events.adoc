...
[.lead]
mgmtgwd.snapshot events are presented when a snapshot cannot be deleted from an Infinite Volume which is typically fixed by following the documented corrective steps.
