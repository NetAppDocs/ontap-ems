...
[.lead]
ccma.perfstatd events are presented when the Perfstat daemon (perfstatd) has been disabled for more than an hour which is typically fixed by updating configuration.
