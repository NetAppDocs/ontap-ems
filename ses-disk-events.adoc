...
[.lead]
ses.disk events are presented when there are no longer any drives in a FAS2050 system's slots 20 through 23 which typically does not require corrective action.
