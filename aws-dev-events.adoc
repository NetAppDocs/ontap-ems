...
[.lead]
aws.dev events occur when ONTAP encounters issues associated with data disk failures, duplicate UUIDs, or device attachment limits in Amazon Web Services (AWS) instances.
