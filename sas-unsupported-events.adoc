...
[.lead]
sas.unsupported EMS events occur when ONTAP detects that a cable is attached to an I/O module port that is permanently disabled and does not support attachment.
