...
[.lead]
certificate.node events are presented when an installed certificate record exists in a node Vserver which is typically fixed by following the documented corrective steps.
