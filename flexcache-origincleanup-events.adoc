...
[.lead]
flexcache.origincleanup events are presented when the origin of a FlexCache(R) volume cleanup job fails to clean up the origin volume which may require contacting NetApp support.
