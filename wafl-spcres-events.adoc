...
[.lead]
wafl.spcres EMS events occur when this event indicates that the new space reservation guarantee was unabled to be obtained, so the old reservation type was kept unchanged.
