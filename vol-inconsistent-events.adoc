...
[.lead]
vol.inconsistent events are presented when the "vol inconsistent" command is used to modify a volume's state which typically does not require corrective action.
