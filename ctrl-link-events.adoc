...
[.lead]
ctrl.link events are presented when the software detects either symbol errors or out-of-sequence errors on HA interconnect links which may require reseating or replacing affected hardware.
