...
[.lead]
fg.convert events are presented when the conversion of a FlexVol(R) volume into a FlexGroup fails which is typically fixed by following the documented corrective steps.
