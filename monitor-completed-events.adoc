...
[.lead]
monitor.completed events occur when wafliron in the optional commit mode has finished on the aggregate but changes have not been committed or rejected.
