...
[.lead]
monitor.completed events are presented when wafliron in the optional commit mode has finished on the aggregate but changes have not been committed or rejected which is typically fixed by following the documented corrective steps.
