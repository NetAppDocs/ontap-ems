...
[.lead]
volcreate.name events are presented when flexible volumes were created with names which conflict with existing volume names which is typically fixed by following the documented corrective steps.
