...
[.lead]
san.changedhomenode events are presented when the home node of an existing SAN LIF is modified during LIF placement which typically does not require corrective action.
