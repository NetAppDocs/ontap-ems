...
[.lead]
ha.netparttodisabled events occur when takeovers due to network partitioning are disabled because of the number of previous, consecutive, network-partition takeovers that occurred within a preceding detection period.
