...
[.lead]
fp.est events are presented when the volume footprint estimator scan fails to update the catalog file which is typically fixed by verifying system state and connectivity.
