...
[.lead]
wafl.shutdown events are presented when during shutdown, to indicate that a volume has not been marked clean which may require contacting NetApp support.
