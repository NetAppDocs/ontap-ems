...
[.lead]
sis.corrupt events are presented when a Single Instance Storage (SIS) metafile is deleted because there are Disk/Media errors affecting the file which may require contacting NetApp support.
