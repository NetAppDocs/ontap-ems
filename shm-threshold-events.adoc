...
[.lead]
shm.threshold events are presented when the system detects a disk that exceeds the threshold count of high aggressive IO latencies which typically does not require corrective action.
