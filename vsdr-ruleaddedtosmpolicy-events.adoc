...
[.lead]
vsdr.ruleaddedtosmpolicy events are presented when a MAX Data(R) schedule update adds a new rule to a SnapMirror(R) policy with the "mirror-vault" type which typically does not require corrective action.
