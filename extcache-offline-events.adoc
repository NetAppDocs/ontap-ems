...
[.lead]
extcache.offline events are presented when the external cache is automatically taken offline which is typically fixed by following the documented corrective steps.
