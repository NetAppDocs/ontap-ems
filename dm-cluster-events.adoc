...
[.lead]
dm.cluster events are presented when resynchronization of the cluster configuration failed in a MetroCluster(tm) configuration which is typically fixed by verifying system state and connectivity.
