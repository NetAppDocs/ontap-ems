...
[.lead]
scsi.cmd events are presented when the aborted event is issued if an I/O request is aborted by a class driver which typically does not require corrective action.
