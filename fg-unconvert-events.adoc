...
[.lead]
fg.unconvert events are presented when a member of a FlexGroup fails to be converted into an independent FlexVol(R) volume which may require contacting NetApp support.
