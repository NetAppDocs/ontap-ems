...
[.lead]
vfilermigrate.diskownershipmismatch events occur when the SnapMover feature is licensed but the disk ownership model is not using the software-based disk ownership model.
