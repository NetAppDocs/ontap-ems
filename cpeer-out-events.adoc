...
[.lead]
cpeer.out events are presented when an outgoing cluster peer request authentication fails due to a passphrase mismatch which is typically fixed by verifying system state and connectivity.
