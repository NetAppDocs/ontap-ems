...
[.lead]
nvd.biodone events are presented when there is an error during a block I/O flush operation which is typically fixed by verifying system state and connectivity.
