...
[.lead]
asup.aods events are presented when the size of the response from the AutoSupport OnDemand Server (AODS) goes over the AOD response buffer size limit in ONTAP which may require contacting NetApp support.
