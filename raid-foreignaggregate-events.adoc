...
[.lead]
raid.foreignaggregate events are presented when the system changes the RAID tree ID of a foreign aggregate that is being brought online which typically does not require corrective action.
