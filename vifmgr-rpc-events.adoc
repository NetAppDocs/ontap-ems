...
[.lead]
vifmgr.rpc events are presented when the virtual interface manager (vifmgr) is having trouble communicating with the packet and connection processing module of the network component which may require contacting NetApp support.
