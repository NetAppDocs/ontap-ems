...
[.lead]
virtual.limits events are presented when the process virtual memory limit calculations are disabled on a given node which typically does not require corrective action.
