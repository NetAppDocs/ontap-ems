...
[.lead]
kern.process events are presented when a process creation has the system close to the maximum limit for the number of processes which typically does not require corrective action.
