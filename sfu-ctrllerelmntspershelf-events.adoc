...
[.lead]
sfu.ctrllerelmntspershelf events are presented when a disk shelf firmware download determines the number of controller elements per shelf that can be downloaded which typically does not require corrective action.
