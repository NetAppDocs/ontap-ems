...
[.lead]
sfu.ctrllerelmntspershelf events occur when a disk shelf firmware download determines the number of controller elements per shelf that can be downloaded.
