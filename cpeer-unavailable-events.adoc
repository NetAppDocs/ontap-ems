...
[.lead]
cpeer.unavailable events are presented when a peer cluster becomes unavailable which is typically fixed by verifying system state and updating configuration.
