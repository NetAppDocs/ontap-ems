...
[.lead]
clus.reboot events are presented when the cluster reboot detection feature detects an internal software error due to insufficient system resources which may require a reboot.
