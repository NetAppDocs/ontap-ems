...
[.lead]
scsiblade.offline events are presented when the node loses connectivity with the majority of the cluster which is typically fixed by following the documented corrective steps.
