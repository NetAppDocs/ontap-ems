...
[.lead]
snaplock.mcc events are presented when snapLock legal-hold or event based retention operations are aborted during a MetroCluster Switchback or a MetroCluster Switchover operation which typically does not require corrective action.
