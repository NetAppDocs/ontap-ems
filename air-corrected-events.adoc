...
[.lead]
air.corrected events are presented when the Automated Incremental Repair (AIR) subsystem repairs an inode having a corrupted qtree ID which typically does not require corrective action.
