...
[.lead]
arl.aggronlinefailed EMS events occur when the RAID or WAFL(R) subsystem fails to bring online the aggregate or its containing volumes after relocation.
