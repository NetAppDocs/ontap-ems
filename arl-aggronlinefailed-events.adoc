...
[.lead]
arl.aggronlinefailed events are presented when the RAID or WAFL(R) subsystem fails to bring online the aggregate or its containing volumes after relocation which is typically fixed by verifying system state and connectivity.
