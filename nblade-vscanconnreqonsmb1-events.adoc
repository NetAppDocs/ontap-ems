...
[.lead]
nblade.vscanconnreqonsmb1 events are presented when during a client attempt to establish a vscan connection over SMB1, which is not supported which is typically fixed by verifying system state and connectivity.
