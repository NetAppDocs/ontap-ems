...
[.lead]
mlm.scsi events are presented when an array target port contains SCSI INQUIRY data with an incorrect support level which is typically fixed by verifying system state and updating configuration.
