...
[.lead]
crypto.okmrecovery events are presented when the Onboard Key Manager (OKM) recovery command in the boot menu fails to recover the OKM hierarchy which is typically fixed by verifying system state and updating configuration.
