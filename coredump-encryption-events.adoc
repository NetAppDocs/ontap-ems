...
[.lead]
coredump.encryption events are presented when encryption is configured on the controller, but the coredump subsystem cannot encrypt data which is typically fixed by following the documented corrective steps.
