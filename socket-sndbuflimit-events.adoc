...
[.lead]
socket.sndbuflimit events are presented when an overflow is detected in the TCP socket send buffer which is typically fixed by following the documented corrective steps.
