...
[.lead]
diskown.diskwasstolen EMS events occur when the ownership of a disk owned by the system is changed such that the disk is no longer owned by the system.
