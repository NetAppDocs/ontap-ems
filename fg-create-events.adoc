...
[.lead]
fg.create events are presented when a user creates a FlexGroup volume that has a workflow with a type that is not "auto" which typically does not require corrective action.
