...
[.lead]
ha.panicinfosent events are presented when a node successfully sends panic information to its high-availability (HA) partner over the HA interconnect which typically does not require corrective action.
