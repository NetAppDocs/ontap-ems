...
[.lead]
snaplock.sfo events are presented when snapLock legal-hold or event-retention operations are aborted during an aggregate relocation or a sendhome operation which typically does not require corrective action.
