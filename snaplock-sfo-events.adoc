...
[.lead]
snaplock.sfo EMS events occur when SnapLock legal-hold or event-retention operations are aborted during an aggregate relocation or a sendhome operation.
