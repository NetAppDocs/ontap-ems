...
[.lead]
csm.nomemory events are presented when the memory allocator temporarily runs out of memory that can be allocated or when the entire node has an insufficient amount of free system memory which may require contacting NetApp support.
