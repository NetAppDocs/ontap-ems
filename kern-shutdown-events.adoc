...
[.lead]
kern.shutdown events are presented when this event is issued to indicate a pending shutdown is underway which typically does not require corrective action.
