...
[.lead]
connectx.ibunsupportcable events are presented when an unsupported InfiniBand cable is detected on the InfiniBand port which is typically fixed by following the documented corrective steps.
