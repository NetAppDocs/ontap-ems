...
[.lead]
netif.toomanynics events are presented when a network interface was not initialized because the number of interfaces of this type exceeds the maximum supported which is typically fixed by following the documented corrective steps.
