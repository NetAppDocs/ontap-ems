...
[.lead]
useradmin.registry events are presented when the system encounters an internal registry error while reading the useradmin entries which may require contacting NetApp support.
