...
[.lead]
nblade.nosmbvernegotiated events are presented when data ONTAP(R) does not support any of the SMB protocol versions sent by the client for negotiation which is typically fixed by verifying system state and connectivity.
