...
[.lead]
vifmgr.lifmoved events are presented when an administrator action causes a logical interface (LIF) IP address to move to another node/port which typically does not require corrective action.
