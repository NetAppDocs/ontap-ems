...
[.lead]
reg.transaction events are presented when oNTAP(R) cannot commit a registry transaction which is typically fixed by verifying system state and connectivity.
