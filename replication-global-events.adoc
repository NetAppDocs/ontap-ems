...
[.lead]
replication.global events are presented when the request to change/set the throttling value for a replication association is failed, which typically does not require corrective action.
