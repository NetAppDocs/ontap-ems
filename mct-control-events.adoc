...
[.lead]
mct.control events are presented when the Mirror Cache Transport layer encounters an error in its control group which typically does not require corrective action.
