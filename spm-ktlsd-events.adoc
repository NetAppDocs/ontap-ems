...
[.lead]
spm.ktlsd events are presented when the Kernel Transport Layer Security Daemon support process (ktlsd) involuntarily terminates which may require restarting affected services or nodes.
