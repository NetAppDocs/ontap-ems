...
[.lead]
diskown.shareddsk events are presented when a disk is shared by multiple nodes in a non-HA or stand-alone configuration which is typically fixed by following the documented corrective steps.
