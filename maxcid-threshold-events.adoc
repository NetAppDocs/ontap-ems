...
[.lead]
maxcid.threshold events are presented when the system is approaching the maximum number of open data connections supported on the node which is typically fixed by following the documented corrective steps.
