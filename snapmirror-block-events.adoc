...
[.lead]
snapmirror.block events are presented when a SnapMirror(R) operation needs to reconstruct the block type bits which is typically fixed by following the documented corrective steps.
