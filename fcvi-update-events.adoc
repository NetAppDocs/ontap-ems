...
[.lead]
fcvi.update events are presented when there is a change in physical link state of the Fibre Channel Virtual Interface (FC-VI) adapter which typically does not require corrective action.
