...
[.lead]
fgr.metadata events are presented when the system detects an inconsistency in the volume capacity rebalancing metadata which is typically fixed by following the documented corrective steps.
