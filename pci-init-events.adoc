...
[.lead]
pci.init events are presented when PCI configuration is waiting for outstanding background threads that might still be running, which typically does not require corrective action.
