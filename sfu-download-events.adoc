...
[.lead]
sfu.download events are presented when a disk shelf firmware update completes download firmware to a disk shelf or shelves in the system which is typically fixed by updating configuration.
