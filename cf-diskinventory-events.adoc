...
[.lead]
cf.diskinventory events are presented when the computed checksum of the disk inventory message is different from the checksum sent as part of the disk inventory message which typically does not require corrective action.
