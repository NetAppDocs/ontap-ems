...
[.lead]
cf.diskinventory events occur when the computed checksum of the disk inventory message is different from the checksum sent as part of the disk inventory message.
