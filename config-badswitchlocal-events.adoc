...
[.lead]
config.badswitchlocal events are presented when a disk is found to be attached locally, but there are also disks attached via switches which may require contacting NetApp support.
