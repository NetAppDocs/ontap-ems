...
[.lead]
wafl.blkreclaim events are presented when to inform you that the block reclamation scanner was aborted which is typically fixed by following the documented corrective steps.
