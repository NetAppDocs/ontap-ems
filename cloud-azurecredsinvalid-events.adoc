...
[.lead]
cloud.azurecredsinvalid events are presented when the system acquires Azure Managed Service Identity (MSI) credentials that are not valid which is typically fixed by verifying system state and connectivity.
