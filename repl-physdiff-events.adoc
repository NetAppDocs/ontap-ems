...
[.lead]
repl.physdiff events are presented when a block to replicate was found to be inconsistent in the source volume which is typically fixed by following the documented corrective steps.
