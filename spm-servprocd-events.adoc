...
[.lead]
spm.servprocd events are presented when the Service processor daemon process (servprocd) involuntarily terminates which may require restarting affected services or nodes.
