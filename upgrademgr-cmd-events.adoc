...
[.lead]
upgrademgr.cmd events are presented when the execution of the commands listed in the support file has completed which typically does not require corrective action.
