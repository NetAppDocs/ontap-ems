...
[.lead]
vscan.odjob events are presented when the system fails to delete queued Vscan On-Demand job which is typically fixed by following the documented corrective steps.
