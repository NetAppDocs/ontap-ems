...
[.lead]
disk.sizegrew events are presented when the controller detects an increase in the capacity of a virtual disk which typically does not require corrective action.
