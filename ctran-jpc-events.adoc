...
[.lead]
ctran.jpc events are presented when a Join Proposal Coordinator (JPC) node is assigned by Kernel Cluster Services (KCS) Cluster Transaction Manager (CTRAN) which typically does not require corrective action.
