...
[.lead]
ktls.health events are presented when the depth of the action queue in the ktlsd subsystem is increasing in the majority of time intervals which typically does not require corrective action.
