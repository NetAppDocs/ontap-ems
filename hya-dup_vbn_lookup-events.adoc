...
[.lead]
hya.dup_vbn_lookup events are presented when this event is generated if we detect redundant lookups of a PVBN without an intervening suspend which typically does not require corrective action.
