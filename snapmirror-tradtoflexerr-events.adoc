...
[.lead]
snapmirror.tradtoflexerr events are presented when the user tries to copy a traditional volume into a flexible volume using SnapMirror(R) which is typically fixed by following the documented corrective steps.
