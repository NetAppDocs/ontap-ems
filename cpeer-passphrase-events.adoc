...
[.lead]
cpeer.passphrase events are presented when the cluster peer offer for anonymous cluster with system-generated passphrase expired and deleted which is typically fixed by following the documented corrective steps.
