...
[.lead]
raid.vldb events are presented when rAID fails to notify the M-host that the VLDB(volume location database) is online which typically does not require corrective action.
