...
[.lead]
savecore.nospace events are presented when savecore has determined that the space available for storing the unsaved core is not sufficient which is typically fixed by verifying system state and connectivity.
