...
[.lead]
raid.monitor EMS events occur when the hourly monitor indicates that the current aggregate or volume number exceeded the maximum number of supported volumes on the host.
