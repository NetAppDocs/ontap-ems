...
[.lead]
callhome.nht events are presented when the weekly AutoSupport or 'call home' event is sent for any drive NHT data which typically does not require corrective action.
