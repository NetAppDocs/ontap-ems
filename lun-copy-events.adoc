...
[.lead]
lun.copy events are presented when a LUN appears in the public namespace of the destination volume during a LUN copy operation which typically does not require corrective action.
