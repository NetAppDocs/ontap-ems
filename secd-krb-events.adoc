...
[.lead]
secd.krb events are presented when kerberos S4U2self (Service for User to Self) operation fails which is typically fixed by following the documented corrective steps.
