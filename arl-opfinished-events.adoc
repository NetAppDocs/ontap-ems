...
[.lead]
arl.opfinished events are presented when the aggregate relocation operation from the source node to the specified destination is finished which typically does not require corrective action.
