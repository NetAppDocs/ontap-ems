...
[.lead]
wafl.failed events are presented when the ONTAP(R) kernel cannot mount a volume because of file system inconsistency which may require contacting NetApp support.
