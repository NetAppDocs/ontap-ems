...
[.lead]
netif.phyoperationfailed events are presented when there is a failure in reading or writing the physical layer (PHY) of a network interface which may require reseating or replacing affected hardware.
