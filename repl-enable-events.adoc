...
[.lead]
repl.enable events are presented when sequential splitting mode is enabled for a SnapMirror Synchronous relationship which typically does not require corrective action.
