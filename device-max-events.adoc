...
[.lead]
device.max events are presented when data ONTAP(R) cannot install one or more discovered devices since the device type count is at full capacity which may require contacting NetApp support.
