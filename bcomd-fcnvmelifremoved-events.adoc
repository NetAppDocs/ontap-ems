...
[.lead]
bcomd.fcnvmelifremoved events are presented when an FC NVMe (Nonvolatile Memory Express) logical interface (LIF) is removed which typically does not require corrective action.
