...
[.lead]
mlm.tapemc events are presented when the system discovers a new tape or media changer logical unit (Tape/MC LUN) reported by a tape library which typically does not require corrective action.
