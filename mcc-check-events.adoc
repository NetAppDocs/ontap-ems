...
[.lead]
mcc.check events are presented when the MetroCluster (tm) check job has failed to complete all checks for the system which is typically fixed by verifying system state and connectivity.
