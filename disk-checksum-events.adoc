...
[.lead]
disk.checksum events are presented when multiple errors are detected during checksum verification which may require reseating or replacing affected hardware.
