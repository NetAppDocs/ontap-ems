...
[.lead]
vifmgr.lifcapacity events are presented when the system informs the administrator of the number of Logical Interfaces (LIFs) supported by the node which typically does not require corrective action.
