...
[.lead]
vserver.config events are presented when the Vserver create operation cannot create the Vserver-specific configuration directory which is typically fixed by following the documented corrective steps.
