...
[.lead]
upgrademgr.package events are presented when a Data ONTAP(R) package is successfully imported into the cluster and processed by the upgrade manager's package handler which typically does not require corrective action.
