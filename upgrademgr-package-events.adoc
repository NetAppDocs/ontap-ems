...
[.lead]
upgrademgr.package events occur when a Data ONTAP(R) package is successfully imported into the cluster and processed by the upgrade manager's package handler.
