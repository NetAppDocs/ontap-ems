...
[.lead]
oauth2.wsdb events are presented when setting the SSL trusted server CA path in web services database fails which is typically fixed by verifying system state and connectivity.
