...
[.lead]
fg.plex EMS events occur when a user unmirrors an aggregate (plex delete) that contains a FlexGroup constituent on nodes in a MetroCluster(tm) configuration.
