...
[.lead]
download.request events are presented when this event is generated when a user-initiated download is initiated which typically does not require corrective action.
