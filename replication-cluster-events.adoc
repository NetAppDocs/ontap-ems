...
[.lead]
replication.cluster events are presented when because the transfer of clustered volumes is not supported in nonclustered environments which is typically fixed by following the documented corrective steps.
