...
[.lead]
fmmb.exthdr events are presented when this event is issued when the HA Mailbox extension header is invalid which typically does not require corrective action.
