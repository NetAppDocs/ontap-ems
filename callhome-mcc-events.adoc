...
[.lead]
callhome.mcc events are presented when a MetroCluster(tm) automatic unplanned switchover operation has completed and the outage window was longer than 120 sec which is typically fixed by verifying system state and connectivity.
