...
[.lead]
disk.healthtrigger events are presented when the disk returns a health trigger event which is typically fixed by following the documented corrective steps.
