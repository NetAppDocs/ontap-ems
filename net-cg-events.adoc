...
[.lead]
net.cg events are presented when the current connection group experiences backpressure which is typically fixed by verifying system state and updating configuration.
