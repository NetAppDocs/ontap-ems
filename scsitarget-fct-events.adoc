...
[.lead]
scsitarget.fct events are presented when a Fibre Channel (FC) Registered State Change Notification (RSCN) frame is received, specifically for a fabric name change event which typically does not require corrective action.
