...
[.lead]
scsitarget.fct events occur when a Fibre Channel (FC) Registered State Change Notification (RSCN) frame is received, specifically for a fabric name change event.
