...
[.lead]
wafl.delete events are presented when the system encounters a lost indirect block while deleting a file which is typically fixed by following the documented corrective steps.
