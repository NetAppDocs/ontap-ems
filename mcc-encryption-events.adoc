...
[.lead]
mcc.encryption events are presented when the encryption for NVLog and storage data in a MetroCluster (tm) configuration is disabled which typically does not require corrective action.
