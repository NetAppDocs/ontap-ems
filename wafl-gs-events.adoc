...
[.lead]
wafl.gs events are presented when wafl is unsuccessful to check and load Granular Set metafile for the volume which is typically fixed by verifying system state and connectivity.
