...
[.lead]
dfu.readtestfailedstatus events are presented when a read test failure occurs after a firmware download which is typically fixed by following the documented corrective steps.
