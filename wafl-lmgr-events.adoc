...
[.lead]
wafl.lmgr events are presented when the appliance file lock state for a volume could not be moved during a file system check operation (wafliron) which typically does not require corrective action.
