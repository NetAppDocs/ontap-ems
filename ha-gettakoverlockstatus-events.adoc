...
[.lead]
ha.gettakoverlockstatus events are presented when the HA subsystem attempts to acquire takeover lock as part of the takeover operation which typically does not require corrective action.
