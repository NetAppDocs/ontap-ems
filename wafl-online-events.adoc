...
[.lead]
wafl.online events are presented when a cluster admin volume comes online during MetroCluster(TM) switchover which is typically fixed by following the documented corrective steps.
