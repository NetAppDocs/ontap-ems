...
[.lead]
ha.tkover events are presented when a pending takeover is waiting for an in-progress aggregate relocation (ARL) operation to complete or abort before proceeding with the takeover which typically does not require corrective action.
