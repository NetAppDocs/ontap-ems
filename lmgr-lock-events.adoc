...
[.lead]
lmgr.lock events are presented when the system aborts the volume lock reclaim process which is typically fixed by following the documented corrective steps.
