...
[.lead]
fmmb.blobwritten events are presented when a mailbox 'blob' write to the on-disk mailbox data structure succeeds which typically does not require corrective action.
