...
[.lead]
sfu.rebootrequest events are presented when the disk shelf firmware update is complete and the disk shelf will be rebooted to run the new code which typically does not require corrective action.
