...
[.lead]
mcc.forced events are presented when the node triggers a forced automatic unplanned switchover because the "allow-auto-forced-switchover" option is true which typically does not require corrective action.
