...
[.lead]
san.volrehostlunmapcreated EMS events occur on clustered Data ONTAP(R) systems for Volume Rehost operation on successful creation of the LUN map the destination Vserver.
