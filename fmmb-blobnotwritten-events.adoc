...
[.lead]
fmmb.blobnotwritten events are presented when a mailbox 'blob' write operation to the on-disk mailbox data structure fails which is typically fixed by updating configuration.
