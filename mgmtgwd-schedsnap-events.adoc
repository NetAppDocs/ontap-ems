...
[.lead]
mgmtgwd.schedsnap events are presented when the system fails to create a Snapshot(tm) copy for the given volume which may require contacting NetApp support.
