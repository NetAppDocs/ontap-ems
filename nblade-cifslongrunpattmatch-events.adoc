...
[.lead]
nblade.cifslongrunpattmatch events occur when a CIFS query directory command that includes wildcard characters exceeds the reporting time threshold for completion.
