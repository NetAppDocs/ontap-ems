...
[.lead]
showmount.update events are presented when the showmount job fails to update the "exports.data" file which is typically fixed by verifying system state and connectivity.
