...
[.lead]
wafl.s2c events are presented when snapMirror(R) detects a missing clone block in the volume block map metafile which typically does not require corrective action.
