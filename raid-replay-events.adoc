...
[.lead]
raid.replay events occur when an aggregate becomes available and system successfully replayed the preserved NVRAM entries associated with that aggregate.
