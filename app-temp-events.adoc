...
[.lead]
app.temp events are presented when a S3 Bucket cannot be deleted as a part of an application destroy operation which is typically fixed by following the documented corrective steps.
