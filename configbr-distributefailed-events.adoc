...
[.lead]
configbr.distributefailed events are presented when a configuration backup cannot be distributed to another node in the cluster which is typically fixed by updating configuration.
