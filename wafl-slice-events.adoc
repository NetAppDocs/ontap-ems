...
[.lead]
wafl.slice events are presented when an invalid slice stream was not fixed by wafliron because the associated slice base file was not recognized at the time wafliron ran which may require contacting NetApp support.
