...
[.lead]
volcopy.flextotraderr events are presented when the user tries to copy a flexible volume into a traditional volume using the command 'vol copy' which is typically fixed by following the documented corrective steps.
