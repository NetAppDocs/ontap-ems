...
[.lead]
disk.encryptcmdfailed events occur when the indicated "storage encryption disk" command fails on an encrypting disk that supports storage encryption methods.
