...
[.lead]
platform.chsismobonamediff events are presented when the product name on the chassis is different from the one on the controller which is typically fixed by following the documented corrective steps.
