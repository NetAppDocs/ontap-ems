...
[.lead]
snapmirror.registry events are presented when the system cleans up an invalid value in SnapMirror(R) registry which typically does not require corrective action.
