...
[.lead]
cpeer.access EMS events occur when an access request from a peer cluster is rejected, either because the request is made to a restricted Vserver or to a restricted table.
