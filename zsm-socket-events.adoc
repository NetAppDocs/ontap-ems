...
[.lead]
zsm.socket events are presented when the event posted when the listener socket for the ZAPI Socket Manager (ZSM) service cannot be created which may require a reboot.
