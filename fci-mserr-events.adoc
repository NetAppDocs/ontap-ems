...
[.lead]
fci.mserr events occur when the Fibre Channel fabric cannot successfully complete a request to the Management Server to retrieve configuration information.
