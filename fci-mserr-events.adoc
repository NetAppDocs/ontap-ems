...
[.lead]
fci.mserr events are presented when the Fibre Channel fabric cannot successfully complete a request to the Management Server to retrieve configuration information which is typically fixed by verifying system state and connectivity.
