...
[.lead]
pha.disk events are presented when the backing disk type for an existing disk was changed from the cloud API which is typically fixed by verifying system state and connectivity.
