...
[.lead]
vnvram.flush events are presented when the write to the backing storage device for the EMS region of VNVRAM (virtual NVRAM) takes longer than 500 msec which typically does not require corrective action.
