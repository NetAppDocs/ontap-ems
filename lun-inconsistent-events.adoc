...
[.lead]
lun.inconsistent events are presented when the block containing a LUN or NVMe namespace's attributes is found to be inconsistent which may require contacting NetApp support.
