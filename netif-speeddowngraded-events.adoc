...
[.lead]
netif.speeddowngraded events are presented when the interface is operating at a lower speed than expected which is typically fixed by verifying system state and connectivity.
