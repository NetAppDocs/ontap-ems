...
[.lead]
nblade.vldb events occur when a protocol requests a list of blades but one cannot be generated due to one or more references to a previous request or requests still outstanding.
