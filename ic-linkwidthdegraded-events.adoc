...
[.lead]
ic.linkwidthdegraded events are presented when the high-availability (HA) interconnect detects a degraded link width which may require contacting NetApp support.
