...
[.lead]
scsiblade.volume events are presented when lUNs in the specified Vserver and volume are not accessible on one or more SAN LIFs which may require contacting NetApp support.
