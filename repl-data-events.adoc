...
[.lead]
repl.data events are presented when compacted data is replicated to a volume that does not have data compaction enabled which typically does not require corrective action.
