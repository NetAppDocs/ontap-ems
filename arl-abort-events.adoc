...
[.lead]
arl.abort events are presented when a relocation of an aggregate is canceled due to activity in RAID which is typically fixed by following the documented corrective steps.
