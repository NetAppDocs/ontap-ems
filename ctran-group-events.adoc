...
[.lead]
ctran.group events are presented when an attempt to reset a group by Kernel Cluster Services (KCS) Cluster Transaction Manager (CTRAN) fails which may require contacting NetApp support.
