...
[.lead]
lun.restore events are presented when the SFSR (Single File SnapRestore(R)) for a LUN or NVMe namespace is complete which typically does not require corrective action.
