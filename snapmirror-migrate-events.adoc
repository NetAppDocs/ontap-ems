...
[.lead]
snapmirror.migrate events are presented when this event is issued when a migrate completes successfully which typically does not require corrective action.
