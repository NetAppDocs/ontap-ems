...
[.lead]
qos.min events are presented when minimum throughput value is not honoured if adaptive QoS is set on a SnapMirror Synchronous protected storage object which typically does not require corrective action.
