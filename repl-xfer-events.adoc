...
[.lead]
repl.xfer events are presented when a replication transfer component (sender or receiver) has taken more than an hour to terminate which may require a reboot.
