...
[.lead]
hybaggrcopy.srcgeommismatch events are presented when an aggregate cannot be copied which is typically fixed by verifying system state and connectivity.
