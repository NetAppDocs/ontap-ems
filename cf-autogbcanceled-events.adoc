...
[.lead]
cf.autogbcanceled events are presented when an automatic giveback is canceled because of a headswap which typically does not require corrective action.
