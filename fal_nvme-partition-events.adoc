...
[.lead]
fal_nvme.partition events are presented when a partition status in the Flash Adaptation Layer (FAL) changes which typically does not require corrective action.
