...
[.lead]
exports.ngbh EMS events occur when a netgroup by host request fails because all ns-switch sources for the netgroup database have returned connection errors and files are unusable as a source.
