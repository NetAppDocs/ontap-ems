...
[.lead]
arl.opaborted events are presented when an aggregate relocation operation is aborted which is typically fixed by following the documented corrective steps.
