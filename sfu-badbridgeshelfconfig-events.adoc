...
[.lead]
sfu.badbridgeshelfconfig events are presented when the disk shelf firmware update aborts because it cannot contact the two peer FC-to-SAS bridges which is typically fixed by updating configuration.
