...
[.lead]
vifmgr.startup events are presented when the logical interface manager (VIFMgr) encounters an error while initializing the structures required for logical interface (LIF) failover which may require contacting NetApp support.
