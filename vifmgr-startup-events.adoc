...
[.lead]
vifmgr.startup events occur when the logical interface manager (VIFMgr) encounters an error while initializing the structures required for logical interface (LIF) failover.
