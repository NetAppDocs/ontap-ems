...
[.lead]
tar.extract events are presented when an error while processing a particular entry causes the extraction of the archive to fail during the process of extracting a TAR archive, which typically does not require corrective action.
