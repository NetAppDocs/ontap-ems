...
[.lead]
tar.extract events occur during the process of extracting a TAR archive, when an error while processing a particular entry causes the extraction of the archive to fail.
