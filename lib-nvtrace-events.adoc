...
[.lead]
lib.nvtrace events are presented when the system sorts the syslog messages when syslog is not yet initialized, and the panic messages are relogged which typically does not require corrective action.
