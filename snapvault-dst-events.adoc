...
[.lead]
snapvault.dst events are presented when snapVault(R) creates a backup snapshot for a given backup schedule which typically does not require corrective action.
