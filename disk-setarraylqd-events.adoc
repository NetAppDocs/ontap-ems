...
[.lead]
disk.setarraylqd events are presented when you set the LUN queue depth for all the LUNs of an array which typically does not require corrective action.
