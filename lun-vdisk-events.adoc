...
[.lead]
lun.vdisk events are presented when a volume contains more than the supported limit of LUNs in the volume which is typically fixed by following the documented corrective steps.
