...
[.lead]
vol.registryget events are presented when a registry request finds no 512 or 520 BPS (bytes per sector) disks which typically does not require corrective action.
