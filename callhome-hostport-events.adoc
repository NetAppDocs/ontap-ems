...
[.lead]
callhome.hostport events are presented when an Embedded Switched Hub (ESH) bypasses a host port due to excessive errors on the port which may require reseating or replacing affected hardware.
