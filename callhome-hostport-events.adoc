...
[.lead]
callhome.hostport events occur when ONTAP encounters issues associated with host ports being bypassed by ESH or disabled by IOM due to excessive errors.
