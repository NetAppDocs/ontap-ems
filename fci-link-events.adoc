...
[.lead]
fci.link events are presented when the Fibre Channel adapter detects a break in the link which is typically fixed by verifying system state and connectivity.
