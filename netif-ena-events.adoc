...
[.lead]
netif.ena events are presented when the network throughput exceeds the bandwidth allowance for the node which typically does not require corrective action.
