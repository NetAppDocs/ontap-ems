...
[.lead]
diskown.errorduringio events are presented when this event is issued when an I/O error occurs during a sanown disk operation which typically does not require corrective action.
