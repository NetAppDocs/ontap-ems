...
[.lead]
replication.regoperr events are presented when the system encounters an error during a registry operation related to SnapMirror(R) or SnapVault(R) which is typically fixed by following the documented corrective steps.
