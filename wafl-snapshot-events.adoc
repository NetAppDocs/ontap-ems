...
[.lead]
wafl.snapshot events are presented when the system discover that a filesize is out of range in a snapshot, which typically does not require corrective action.
