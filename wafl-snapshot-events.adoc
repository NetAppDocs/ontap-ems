...
[.lead]
wafl.snapshot events are presented when this event is issued when the system discover that a filesize is out of range in a snapshot which typically does not require corrective action.
