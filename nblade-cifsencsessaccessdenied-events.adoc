...
[.lead]
nblade.cifsencsessaccessdenied events occur when a client not capable of SMB encryption tries to establish a CIFS session that requires SMB encryption.
