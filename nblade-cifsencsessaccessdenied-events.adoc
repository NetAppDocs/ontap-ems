...
[.lead]
nblade.cifsencsessaccessdenied events are presented when a client not capable of SMB encryption tries to establish a CIFS session that requires SMB encryption which is typically fixed by following the documented corrective steps.
