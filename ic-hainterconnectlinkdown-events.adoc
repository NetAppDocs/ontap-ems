...
[.lead]
ic.hainterconnectlinkdown events are presented when one of the high-availability (HA) interconnect links is down every hour, which is typically fixed by verifying system state and connectivity.
