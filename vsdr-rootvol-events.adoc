...
[.lead]
vsdr.rootvol EMS events occur when the system detects that there is data in the Server Virtual Machine root volume during a disaster recovery (DR) transfer phase.
