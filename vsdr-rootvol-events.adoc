...
[.lead]
vsdr.rootvol events are presented when the system detects that there is data in the Server Virtual Machine root volume during a disaster recovery (DR) transfer phase which is typically fixed by following the documented corrective steps.
