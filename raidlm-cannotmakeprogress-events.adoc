...
[.lead]
raidlm.cannotmakeprogress events are presented when a system does not contain enough spares to correct existing disk failures or misconfigurations which may require reseating or replacing affected hardware.
