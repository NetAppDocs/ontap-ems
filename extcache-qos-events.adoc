...
[.lead]
extcache.qos events are presented when external Cache Quality of Service (QoS) monitoring is enabled/disabled which typically does not require corrective action.
