...
[.lead]
daregister.periph events are presented when a peripheral device is lost during registration which is typically fixed by verifying system state and connectivity.
