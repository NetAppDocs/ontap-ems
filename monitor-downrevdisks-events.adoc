...
[.lead]
monitor.downrevdisks events are presented when oNTAP(R) detects that downrev disks are still present in the system which is typically fixed by updating configuration.
