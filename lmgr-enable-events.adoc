...
[.lead]
lmgr.enable events are presented when the enabling of the remote lock functionality is unsuccessful due to insufficient storage space which is typically fixed by following the documented corrective steps.
