...
[.lead]
repl.gsr events are presented when snapMirror faces internal error while going Out-Of-Sync or source volume comes online which may require contacting NetApp support.
