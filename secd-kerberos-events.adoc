...
[.lead]
secd.kerberos events are presented when there is a "time error"(clock skew, time skew, time out of bounds) which is typically fixed by updating configuration.
