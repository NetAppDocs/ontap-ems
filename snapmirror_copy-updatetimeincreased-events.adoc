...
[.lead]
snapmirror_copy.updatetimeincreased events are presented when the update time taken by the latest transfer is 5 minutes more than the previous three transfer times which typically does not require corrective action.
