...
[.lead]
snapmirror_copy.updatetimeincreased EMS events occur when the update time taken by the latest transfer is 5 minutes more than the previous three transfer times.
