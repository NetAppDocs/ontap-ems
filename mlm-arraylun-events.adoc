...
[.lead]
mlm.arraylun events are presented when data ONTAP(R) cannot install one or more discovered array LUNs since the disk device count is at full capacity which may require contacting NetApp support.
