...
[.lead]
snaplock.event events are presented when on completion of a event based retention apply operation on a SnapLock(R) volume which typically does not require corrective action.
