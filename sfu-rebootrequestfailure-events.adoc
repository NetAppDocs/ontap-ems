...
[.lead]
sfu.rebootrequestfailure events occur when an attempt to issue a reboot request after downloading disk shelf firmware fails, indicating a software error.
