...
[.lead]
sfu.rebootrequestfailure events are presented when an attempt to issue a reboot request after downloading disk shelf firmware fails, indicating a software error which is typically fixed by updating configuration.
