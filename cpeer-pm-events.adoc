...
[.lead]
cpeer.pm events are presented when the peer manager job experiences a transient failure which is typically fixed by verifying system state and updating configuration.
