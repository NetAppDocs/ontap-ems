...
[.lead]
vnvram.flushed events are presented when the VNVRAM contents of any ONTAP-based virtual appliance that is not using full-mode VNVRAM, are written to the backing storage device which typically does not require corrective action.
