...
[.lead]
csm.unmarshallerror events are presented when the Cluster Session Manager (CSM) fails to unmarshal a packet, which is typically fixed by following the documented corrective steps.
