...
[.lead]
diskown.assign EMS events occur when the "storage disk assign" command fail to assign a disk to a different owner from the other disks within the carrier.
