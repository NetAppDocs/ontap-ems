...
[.lead]
diskown.assign events are presented when the "storage disk assign" command fail to assign a disk to a different owner from the other disks within the carrier which is typically fixed by following the documented corrective steps.
