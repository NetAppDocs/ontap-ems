...
[.lead]
cpeer.localid events are presented when there is an issue reading the local cluster ID which is typically fixed by following the documented corrective steps.
