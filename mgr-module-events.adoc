...
[.lead]
mgr.module events are presented when this occurs to inform you of where kernel modules were loaded in memory which typically does not require corrective action.
