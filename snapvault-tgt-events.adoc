...
[.lead]
snapvault.tgt events are presented when snapVault(R) detects more than one coalesced snapshot of a specific type in a SnapVault secondary volume which typically does not require corrective action.
