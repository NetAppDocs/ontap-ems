...
[.lead]
fmmb.mediator events are presented when a mailbox disk from the mediator site is selected to be included in the mailbox disk list which typically does not require corrective action.
