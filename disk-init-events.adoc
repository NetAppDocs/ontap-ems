...
[.lead]
disk.init events are presented when a disk reports a sector size that does not match the drive qualification table which may require reseating or replacing affected hardware.
