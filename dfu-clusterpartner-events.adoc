...
[.lead]
dfu.clusterpartner events are presented when automatic firmware download is performed as part of system boot and partner disks are downrev which is typically fixed by updating configuration.
