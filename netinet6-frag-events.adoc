...
[.lead]
netinet6.frag events are presented when the incoming fragment overlaps some of the existing previous fragment in the reassembly queue which typically does not require corrective action.
