...
[.lead]
netif.phyread events are presented when there is a failure in reading the physical layer (PHY) of a network interface which may require contacting NetApp support.
