...
[.lead]
backup.fail events are presented when during a giveback operation, when there are active dump or restore processes running on root aggregates of the partner node which may require a reboot.
