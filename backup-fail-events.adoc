...
[.lead]
backup.fail events are presented when there are active dump or restore processes running on root aggregates of the partner node during a giveback operation, which may require a reboot.
