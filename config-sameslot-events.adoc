...
[.lead]
config.sameslot events are presented when a SAS disk is multipathed to host adapters in the same controller slot which is typically fixed by following the documented corrective steps.
