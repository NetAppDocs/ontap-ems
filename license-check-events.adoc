...
[.lead]
license.check events are presented when the license checker determines that the Base license has expired which may require reseating or replacing affected hardware.
