...
[.lead]
sk.kt events are presented when this is the output of debugging command that prints the time of day held in the real-time clock chip which typically does not require corrective action.
