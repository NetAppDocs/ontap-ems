...
[.lead]
flexcache.originconnected events are presented when a FlexCache(R) volume establishes communication with its origin volume which is typically fixed by following the documented corrective steps.
