...
[.lead]
pn.mvia events are presented when the round-trip-time (RTT) measured in pass-through network layer exceeds predefined threshold which typically does not require corrective action.
