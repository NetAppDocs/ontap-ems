...
[.lead]
cpeer.receiver events are presented when an incoming cluster peer request using the system-generated passphrase which is typically fixed by verifying system state and connectivity.
