...
[.lead]
ic.unsupportcable events are presented when an unsupported cable is detected on the high-availability interconnect port which is typically fixed by following the documented corrective steps.
