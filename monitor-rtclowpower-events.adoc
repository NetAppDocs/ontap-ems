...
[.lead]
monitor.rtclowpower events are presented when the real-time clock (RTC) battery is at a dangerously low power level which may require reseating or replacing affected hardware.
