...
[.lead]
sfu.suspenddiskio events are presented when a disk shelf firmware update is started and disk I/O is suspended which typically does not require corrective action.
