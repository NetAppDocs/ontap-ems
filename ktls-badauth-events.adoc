...
[.lead]
ktls.badauth events are presented when the system receives a TLS message with bad 'authentication' data which is typically fixed by following the documented corrective steps.
