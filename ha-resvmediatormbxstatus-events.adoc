...
[.lead]
ha.resvmediatormbxstatus events are presented when the local node attempts to reserve a mailbox disk while trying to acquire the takeover lock as part of the takeover operation which typically does not require corrective action.
