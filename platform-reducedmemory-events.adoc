...
[.lead]
platform.reducedmemory events are presented when system memory is less than expected for this model, likely due to slots that contain incorrect, failed, or missing DIMMs which may require reseating or replacing affected hardware.
