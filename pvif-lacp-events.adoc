...
[.lead]
pvif.lacp events are presented when a link is operationally up and cannot be aggregated into its configured ifgrp within the time limit which is typically fixed by verifying system state and connectivity.
