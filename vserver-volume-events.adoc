...
[.lead]
vserver.volume events occur when a volume is placed on nonhomogeneous aggregates, because of errors on homogeneous aggregates, such as max volumes is reached or aggregate is not home.
