...
[.lead]
sas.reset events are presented when sAS adapter driver resets the expander because of failure status of discovery response which may require contacting NetApp support.
