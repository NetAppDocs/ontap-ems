...
[.lead]
nblade.cifsmaxopensamefilenotice events are presented when the number of open instances of a particular file under a CIFS tree nears the configuration limit which is typically fixed by verifying system state and updating configuration.
