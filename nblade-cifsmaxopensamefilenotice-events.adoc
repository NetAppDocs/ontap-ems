...
[.lead]
nblade.cifsmaxopensamefilenotice EMS events occur when the number of open instances of a particular file under a CIFS tree nears the configuration limit.
