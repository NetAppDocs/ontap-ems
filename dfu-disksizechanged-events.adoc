...
[.lead]
dfu.disksizechanged events are presented when a size change is detected after a firmware update which is typically fixed by following the documented corrective steps.
