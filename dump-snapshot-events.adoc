...
[.lead]
dump.snapshot events occur when during dump restarting and looking for the snapshot that was created by the dump while it was terminating last time and we are unable to locate the snapshot.
