...
[.lead]
dump.snapshot events are presented when this event is generated during dump restarting and looking for the snapshot that was created by the dump while it was terminating last time and we are cannot locate the snapshot which typically does not require corrective action.
