...
[.lead]
diskown.replayingownership events are presented when this event occurs during a boot or takeover when a disk ownership request is replayed from NVRAM which typically does not require corrective action.
