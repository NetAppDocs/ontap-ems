...
[.lead]
diskown.replayingownership events are presented when a disk ownership request is replayed from NVRAM during a boot or takeover, which typically does not require corrective action.
