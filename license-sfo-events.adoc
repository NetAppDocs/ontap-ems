...
[.lead]
license.sfo events occur when a storage failover giveback is vetoed because a select capacity license has not been installed and the license installation grace period has ended.
