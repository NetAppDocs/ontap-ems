...
[.lead]
license.sfo events are presented when a storage failover giveback is vetoed because a select capacity license has not been installed and the license installation grace period has ended which may require a reboot.
