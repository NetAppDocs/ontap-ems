...
[.lead]
mgmtgwd.mixed events are presented when not all nodes are running the same version of ONTAP which is typically fixed by verifying system state and connectivity.
