...
[.lead]
ds.sas events are presented when the system detects a configuration problem on the shelf I/O module which may require reseating or replacing affected hardware.
