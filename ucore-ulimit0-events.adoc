...
[.lead]
ucore.ulimit0 events are presented when a userspace core is not dumped because the core size limit is set to 0 which may require contacting NetApp support.
