...
[.lead]
acp.upgrade events are presented when the Alternate Control Path (ACP) Administrator determines that the ACP Processor has successfully upgraded the firmware which typically does not require corrective action.
