...
[.lead]
acp.upgrade EMS events occur when the Alternate Control Path (ACP) Administrator determines that the ACP Processor has successfully upgraded the firmware.
