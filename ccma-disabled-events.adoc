...
[.lead]
ccma.disabled events are presented when the Performance Archive has been disabled for more than an hour which is typically fixed by updating configuration.
