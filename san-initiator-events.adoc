...
[.lead]
san.initiator events are presented when oNTAP detects that an initiator which was previously not logged on is now logged on which typically does not require corrective action.
