...
[.lead]
availability.zone events are presented when the storage availability zone space usage has exceeded the full threshold value which is typically fixed by following the documented corrective steps.
