...
[.lead]
useradmin.lockedout events are presented when the user tries to log into the appliance using an invalid password and the account has been disabled which is typically fixed by following the documented corrective steps.
