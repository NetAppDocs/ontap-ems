...
[.lead]
hwaccel.init events are presented when initialization of a hardware accelerator fails due to an unexpected software error which may require contacting NetApp support.
