...
[.lead]
nblade.vscanvirusdetected events are presented when a vscan server reports an error to the storage system which is typically fixed by verifying system state and connectivity.
