...
[.lead]
acp.init EMS events occur when ONTAP encounters issues associated with initialization and configuration of the Alternate Control Path (ACP) Ethernet port.
