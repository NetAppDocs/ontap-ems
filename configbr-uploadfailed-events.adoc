...
[.lead]
configbr.uploadfailed events are presented when the configuration backup cannot be uploaded to the destination URL which is typically fixed by following the documented corrective steps.
