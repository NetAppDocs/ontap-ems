...
[.lead]
ha.panicinforcvbadvrsn events are presented when the version of the panic information received from the high-availability (HA) partner is not equal to the expected version which typically does not require corrective action.
