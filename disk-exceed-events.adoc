...
[.lead]
disk.exceed events are presented when READ/WRITE I/O requests exceed their expected maximum completion time during disk qualification testing, which typically does not require corrective action.
