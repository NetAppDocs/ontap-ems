...
[.lead]
disk.exceed events are presented when this event is generated during disk qualification testing when READ/WRITE I/O requests exceed their expected maximum completion time which typically does not require corrective action.
