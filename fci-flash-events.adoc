...
[.lead]
fci.flash events are presented when there is a failure updating the Fibre Channel adapter flash preload table which may require reseating or replacing affected hardware.
