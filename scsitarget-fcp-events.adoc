...
[.lead]
scsitarget.fcp events occur when ONTAP encounters issues associated with small form-factor pluggable (SFP) modules in the Fibre Channel (FC) target adapter.
