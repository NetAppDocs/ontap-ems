...
[.lead]
replication.wormlog events are presented when failed to append to the replication worm log file, which is typically fixed by verifying system state and connectivity.
