...
[.lead]
raid.disk events are presented when this event is issued to inform what the sum of all disk sizes is as well as what system capacity limit is which is typically fixed by following the documented corrective steps.
