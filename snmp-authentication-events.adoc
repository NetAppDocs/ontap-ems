...
[.lead]
snmp.authentication events are presented when there is an authentication failure during an SNMP query which is typically fixed by verifying system state and connectivity.
