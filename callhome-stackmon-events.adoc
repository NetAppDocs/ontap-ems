...
[.lead]
callhome.stackmon events are presented when the system fails to assign the correct stack-id to one or more disk shelves which is typically fixed by verifying system state and connectivity.
