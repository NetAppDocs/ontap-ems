...
[.lead]
bridge.sas events are presented when the SAS disk shelves behind an FC-to-SAS bridge are not cabled correctly, indicating an invalid SAS2 to SAS3 transition which is typically fixed by following the documented corrective steps.
