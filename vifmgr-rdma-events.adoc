...
[.lead]
vifmgr.rdma events occur when a logical interface (LIF) is moved from a port that does not support the required remote direct memory access (RDMA) protocols of the LIF.
