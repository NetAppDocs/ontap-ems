...
[.lead]
pac.access EMS events occur when the access is denied or unsuccessful for the specified source host, destination host, and network interface combination.
