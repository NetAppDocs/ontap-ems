...
[.lead]
ucm.mode events are presented when the FC adapter or converged networking adapter is reconfigured from a backup which is typically fixed by following the documented corrective steps.
