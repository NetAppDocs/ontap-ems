...
[.lead]
rdmalib.rcm events are presented when the configuration of the high-availability (HA) interface cannot be completed due to a missing IP address which is typically fixed by verifying system state and connectivity.
