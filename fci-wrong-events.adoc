...
[.lead]
fci.wrong events are presented when the fixed speed level requested by the fc-force-XG-ports bootarg is out of range for the corresponding FC port which is typically fixed by following the documented corrective steps.
