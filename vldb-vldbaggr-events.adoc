...
[.lead]
vldb.vldbaggr events are presented when an aggregate is identified that does not exist in the Volume Location Database which is typically fixed by verifying system state and connectivity.
