...
[.lead]
dyn.auth events are presented when the custom trust score component of the Dynamic Authorization feature encounters an error which is typically fixed by verifying system state and connectivity.
