...
[.lead]
securepurge.started events are presented when a secure purge operation is started in a flexible volume which typically does not require corrective action.
