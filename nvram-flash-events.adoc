...
[.lead]
nvram.flash events are presented when periodically when the capacity of the NVRAM flash memory spare blocks is low, before it becomes critically low which may require contacting NetApp support.
