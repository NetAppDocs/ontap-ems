...
[.lead]
lun.oovc events are presented when the rebuilding of the Out Of Volume Container (OOVC) file is complete which typically does not require corrective action.
