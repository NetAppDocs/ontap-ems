...
[.lead]
rlm.notconfigured events are presented when weekly to remind you to configure the Remote LAN Module (RLM) which is typically fixed by verifying system state and updating configuration.
