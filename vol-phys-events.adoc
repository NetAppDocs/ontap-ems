...
[.lead]
vol.phys events are presented when the volume or aggregate is running dangerously low on free blocks to write to which is typically fixed by updating configuration.
