...
[.lead]
wafl.32bit events are presented when an aggregate or volume with a 32-bit or mixed format file system is found which may require contacting NetApp support.
