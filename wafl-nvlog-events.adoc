...
[.lead]
wafl.nvlog events are presented when this event is issued to indicate that the system is cannot create nvlog stats file which typically does not require corrective action.
