...
[.lead]
diskown.mcc events are presented when the number of drives assigned in the MetroCluster(tm) configuration exceeds the supported limit which may require contacting NetApp support.
