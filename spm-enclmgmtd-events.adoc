...
[.lead]
spm.enclmgmtd events are presented when the Enclosure Management Daemon (enclmgmtd) involuntarily terminates which may require contacting NetApp support.
