...
[.lead]
sas.link events are presented when the SAS adapter was cannot recover the link and is going offline which is typically fixed by verifying system state and connectivity.
