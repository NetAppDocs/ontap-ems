...
[.lead]
cecc_log.dropped events are presented when the ECC error logger dropped some correctable ECC errors without logging them which typically does not require corrective action.
