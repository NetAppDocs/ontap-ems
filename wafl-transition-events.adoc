...
[.lead]
wafl.transition events are presented when at the completion of a WAFL(R) consistency point (CP) that occurs during a failover transition, such as takeover or giveback which typically does not require corrective action.
