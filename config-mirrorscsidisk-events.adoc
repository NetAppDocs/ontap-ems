...
[.lead]
config.mirrorscsidisk events are presented when a SCSI disk is found in a SyncMirror(R) configuration which is typically fixed by updating configuration.
