...
[.lead]
sfu.adaptersuspendio events are presented when during a disk shelf firmware update on a disk shelf that cannot perform I/O while updating firmware which is typically fixed by updating configuration.
