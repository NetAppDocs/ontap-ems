...
[.lead]
callhome.dbs events occur when ONTAP encounters issues associated with the Distributed Block Store (DBS) assignments, capacity, data consistency, or cluster faults.
