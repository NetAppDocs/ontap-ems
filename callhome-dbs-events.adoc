...
[.lead]
callhome.dbs events are presented when the Distributed Block Store (DBS) assignments reports a validation error which may require contacting NetApp support.
