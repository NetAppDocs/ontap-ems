...
[.lead]
scsiblade.autoheal EMS events occur when the node loses connectivity with the majority of the cluster and autoheal has been explicitly disabled by the user.
