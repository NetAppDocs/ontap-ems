...
[.lead]
diff.svcs EMS events occur when the system cannot automatically apply the Differentiated Services (diff-svcs) setting to the High Availability (HA) partner.
