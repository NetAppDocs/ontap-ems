...
[.lead]
ha.aggrmigrduration events are presented when every 60 seconds during an aggregate migration operation which typically does not require corrective action.
