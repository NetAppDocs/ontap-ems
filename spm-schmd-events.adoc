...
[.lead]
spm.schmd events are presented when the System Connectivity Health Monitor process (schmd) involuntarily terminates which may require restarting affected services or nodes.
