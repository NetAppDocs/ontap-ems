...
[.lead]
upgrademgr.node events are presented when a cluster node takes more than 30 minutes to reach giveback ready state during automated nondisruptive upgrade which typically does not require corrective action.
