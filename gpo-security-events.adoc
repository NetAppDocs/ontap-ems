...
[.lead]
gpo.security events are presented when the GptTmpl.inf file is not in UNICODE (16 bit)format, which is typically fixed by following the documented corrective steps.
