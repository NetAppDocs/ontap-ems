...
[.lead]
vifmgr.vs events are presented when logical Interface Manager (VIFMgr) is cannot retrieve the list of Vservers from the management gateway Vserver cache in the allotted time which may require contacting NetApp support.
