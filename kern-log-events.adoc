...
[.lead]
kern.log events are presented when this event is issued when the system messages log is rotated to a new name which typically does not require corrective action.
