...
[.lead]
snapmirror.lrs events are presented when snapMirror encounters mismatched file types between two snapshots that it is comparing which may require contacting NetApp support.
