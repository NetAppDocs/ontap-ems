...
[.lead]
callhome.ndo events are presented when the controller replacement operation has been canceled by the administrator which is typically fixed by verifying system state and connectivity.
