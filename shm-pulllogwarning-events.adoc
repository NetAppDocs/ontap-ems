...
[.lead]
shm.pulllogwarning events are presented when the disk dongle requests the system to retrieve the error log which typically does not require corrective action.
