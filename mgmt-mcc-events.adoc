...
[.lead]
mgmt.mcc EMS events occur when MetroCluster(tm) switchback or switchover happens while applying a file security (fsecurity) policy on the MetroCluster partner.
