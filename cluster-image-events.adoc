...
[.lead]
cluster.image events are presented when a non-disruptive data ONTAP upgrade of the cluster was aborted by the user which typically does not require corrective action.
