...
[.lead]
snmp.server events are presented when the SNMP daemon is busy serving a high rate of incoming SNMP queries which is typically fixed by updating configuration.
