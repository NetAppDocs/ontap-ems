...
[.lead]
vifmgr.lifdeleted events are presented when an administrator action causes a logical interface (LIF) IP address to be deleted which typically does not require corrective action.
