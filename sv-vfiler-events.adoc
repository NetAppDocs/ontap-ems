...
[.lead]
sv.vfiler events are presented when movement of SnapVault(R) configuration from 'from' vFiler to 'to' vFiler fails which is typically fixed by following the documented corrective steps.
