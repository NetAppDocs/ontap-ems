...
[.lead]
dump.register events are presented when this event is generated when a registry transaction failed to commit which typically does not require corrective action.
