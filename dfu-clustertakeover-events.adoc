...
[.lead]
dfu.clustertakeover events are presented when firmware download is attempted while in takeover mode which is typically fixed by updating configuration.
