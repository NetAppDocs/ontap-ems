...
[.lead]
fpolicy.outage events are presented when file creation fails under the configured resiliency directory path which is typically fixed by verifying system state and connectivity.
