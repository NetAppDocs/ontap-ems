...
[.lead]
connectx.iblinkretrainnotreqd events are presented when the software detects that the previous InfiniBand link training was successful which typically does not require corrective action.
