...
[.lead]
sfu.resumediskio events are presented when a disk shelf firmware update is completed and disk I/O is resumed which typically does not require corrective action.
