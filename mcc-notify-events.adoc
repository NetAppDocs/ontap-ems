...
[.lead]
mcc.notify events are presented when failed to queue the "MetroCluster Auto Heal" job which is typically fixed by following the documented corrective steps.
