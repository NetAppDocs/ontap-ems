...
[.lead]
spm.timestate events are presented when the subsystem managing timekeeping parameters (time_state) stops running which may require contacting NetApp support.
