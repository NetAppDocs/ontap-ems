...
[.lead]
sp.wdog events are presented when oNTAP(R) software fails to disable or enable the service-processor' (SP or BMC) watchdog timer which may require a reboot.
