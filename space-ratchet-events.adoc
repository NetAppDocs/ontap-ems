...
[.lead]
space.ratchet events are presented when this event is generated if the space ratchet catches a space-check error which typically does not require corrective action.
