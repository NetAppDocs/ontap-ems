...
[.lead]
asup.throttle events are presented when an AutoSupport message is dropped because it is believed to be spam which is typically fixed by updating configuration.
