...
[.lead]
tapemc.alias events are presented when the automatic addition of a tape or medium changer alias fails which is typically fixed by verifying system state and connectivity.
