...
[.lead]
pcp.linkstatechangesucceed events are presented when a change of network port state can now be confirmed after the initial attempt failed due to some race condition which typically does not require corrective action.
