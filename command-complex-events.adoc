...
[.lead]
command.complex events are presented when a custom role associated with a Storage Virtual Machine has a command directory with complex query which is typically fixed by following the documented corrective steps.
