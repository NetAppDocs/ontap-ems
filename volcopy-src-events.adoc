...
[.lead]
volcopy.src events are presented when there is insufficient memory on the vol copy source for the transfer to continue, which typically does not require corrective action.
