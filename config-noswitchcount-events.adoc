...
[.lead]
config.noswitchcount events are presented when an attempt to obtain the switch port count fails because it does not exist which typically does not require corrective action.
