...
[.lead]
nblade.scannerconnected events are presented when a Vserver connects successfully to a Vscan server which typically does not require corrective action.
