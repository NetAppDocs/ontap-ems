...
[.lead]
configbr.deletefailed events are presented when an old configuration backup cannot be deleted which is typically fixed by following the documented corrective steps.
