...
[.lead]
wafl.spacetax events occur when the spacetax feature is disabled for all flexible volumes in the system because of the 'wafl-disable-spacetax?' boot option.
