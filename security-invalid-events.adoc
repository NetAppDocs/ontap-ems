...
[.lead]
security.invalid events are presented when an attempt is made to access the system by using invalid authentication credentials which is typically fixed by verifying system state and connectivity.
