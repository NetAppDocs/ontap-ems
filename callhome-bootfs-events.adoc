...
[.lead]
callhome.bootfs events are presented when a consistency check of the boot media (compact flash or other type) has shown a problem and has not been corrected automatically which is typically fixed by verifying system state and connectivity.
