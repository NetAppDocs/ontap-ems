...
[.lead]
wafl.8 events are presented when wAFL(R) unexpectedly encounters a Data ONTAP(R) 8.0.x logical mirror volume during an upgrade which is typically fixed by following the documented corrective steps.
