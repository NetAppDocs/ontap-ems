...
[.lead]
ucore.limits events are presented when a userspace core is not dumped because system limits for this process are reached which may require contacting NetApp support.
