...
[.lead]
flexcache.cachedisconnected events are presented when a FlexCache(R) origin volume cannot communicate with its cache volume which is typically fixed by verifying system state and connectivity.
