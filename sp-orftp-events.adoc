...
[.lead]
sp.orftp events are presented when there is a communication error while sending information to or receiving information from the Service Processor (SP) which may require a reboot.
