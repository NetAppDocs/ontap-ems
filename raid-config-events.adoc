...
[.lead]
raid.config events are presented when during a mirror check, when the system discovers that all plexes have failed in an aggregate which may require reseating or replacing affected hardware.
