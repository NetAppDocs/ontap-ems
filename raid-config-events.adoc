...
[.lead]
raid.config events are presented when the system discovers that all plexes have failed in an aggregate during a mirror check, which may require reseating or replacing affected hardware.
