...
[.lead]
sis.clog events occur while mounting a volume, when an error with the SIS metafile operation results in the change logging function being disabled to avoid inconsistencies.
