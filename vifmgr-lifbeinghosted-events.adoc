...
[.lead]
vifmgr.lifbeinghosted events are presented when a logical interface (LIF) IP address that was previously marked as down because no eligible ports could host this LIF is now being hosted which typically does not require corrective action.
