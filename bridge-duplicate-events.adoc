...
[.lead]
bridge.duplicate events are presented when the system discovers an ATTO FibreBridge using the same IP address as some other device in the network which may require contacting NetApp support.
