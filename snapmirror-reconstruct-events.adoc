...
[.lead]
snapmirror.reconstruct events occur when the SnapMirror(R) requested reconstruction of a per-volume meta file used for labeling block information is complete.
