...
[.lead]
diskown.raid events are presented when a disk assign or disk remove ownership request is rejected at the RAID layer which is typically fixed by verifying system state and connectivity.
