...
[.lead]
scsiblade.import events are presented when attributes of a SAN LUN under LUN import are modified which is typically fixed by following the documented corrective steps.
