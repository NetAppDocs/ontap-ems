...
[.lead]
ha.mbxresvreleasedelay EMS events occur when the takeover node cannot release a disk reservation for a mailbox disk in preparation for a giveback event.
