...
[.lead]
platform.insufficientmemory events are presented when there is not enough system memory for the system to function, likely due to slots that contain incorrect, failed, or missing DIMMs which may require reseating or replacing affected hardware.
