...
[.lead]
volcopy.tradtoflexerr events are presented when the user tries to copy a traditional volume into a flexible volume using the command 'vol copy' which is typically fixed by following the documented corrective steps.
