...
[.lead]
config.move events occur when a logical interface (LIF) migration fails in such a way that there might have been a resulting internal loss of the LIF IP address.
