...
[.lead]
bdfu.selected events are presented when background disk firmware update selects a disk for firmware download which typically does not require corrective action.
