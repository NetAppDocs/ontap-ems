...
[.lead]
vifmgr.vifidmissing events are presented when a LIF ID, associated with a particular storage virtual machine (SVM), is configured in the VIFMgr but is missing in the vifids UI table which may require contacting NetApp support.
