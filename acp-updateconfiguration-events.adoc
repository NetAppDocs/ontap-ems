...
[.lead]
acp.updateconfiguration events occur when the Alternate Control Path (ACP) Administrator determines that the SAS shelf I/O module (IOM) supports only the in-band ACP configuration.
