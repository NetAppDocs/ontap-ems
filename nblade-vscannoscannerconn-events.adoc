...
[.lead]
nblade.vscannoscannerconn events are presented when oNTAP(R) has no vscan connection for servicing virus scan-requests which is typically fixed by following the documented corrective steps.
