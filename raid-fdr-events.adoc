...
[.lead]
raid.fdr events are presented when we detect an entry in the failed disk registry, and have forcibly failed the disk which may require reseating or replacing affected hardware.
