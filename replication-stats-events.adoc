...
[.lead]
replication.stats events are presented when SnapMirror(R) or SnapVault(R) cannot load the statistics (for example during system boot, which typically does not require corrective action.
