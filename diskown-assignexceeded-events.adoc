...
[.lead]
diskown.assignexceeded events are presented when an attempt is made to assign more disks than are supported by this node which is typically fixed by following the documented corrective steps.
