...
[.lead]
exports.nsdb events are presented when a user string cannot be mapped to a user id when evaluating the "-anon" portion of an export-policy rule which is typically fixed by following the documented corrective steps.
