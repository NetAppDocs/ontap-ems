...
[.lead]
cr.snapshot events are presented when a temporary Snapshot(tm) copy created by the 'volume check' command could not be deleted which is typically fixed by following the documented corrective steps.
