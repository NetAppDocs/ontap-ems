...
[.lead]
gpo.cap events are presented when applying group policy object (GPO) central access policy (CAP) settings succeeds which typically does not require corrective action.
