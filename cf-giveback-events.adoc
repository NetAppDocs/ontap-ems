...
[.lead]
cf.giveback events are presented when giveback of a partner node is delayed due to the cleanup of a previous giveback event which typically does not require corrective action.
