...
[.lead]
san.volrehostigroupcreatefailed EMS events occur on clustered Data ONTAP(R) systems, during Volume Rehost operation when Data ONTAP fails to create igroup on the destination Vserver.
