...
[.lead]
bcomd.vdisk EMS events occur when ONTAP encounters issues associated with LUN or NVMe namespace configuration replication in a MetroCluster configuration.
