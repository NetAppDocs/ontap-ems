...
[.lead]
bcomd.vdisk events are presented when after a replication failure of a LUN or an NVMe namespace configuration in a MetroCluster(TM) configuration which is typically fixed by following the documented corrective steps.
