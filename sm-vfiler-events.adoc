...
[.lead]
sm.vfiler events are presented when movement of the SnapMirror(R) status configuration from 'from' vFiler to 'to' vFiler fails which typically does not require corrective action.
