...
[.lead]
nblade.nfs4illegaldirentname EMS events occur when a user attempts to list a directory over NFSv4 that contains an entry name with non UTF-8 characters.
