...
[.lead]
fpolicy.fgconversion events are presented when a FlexVol(R) unmount notification is not sent to the FPolicy(tm) server during a FlexGroup conversion which typically does not require corrective action.
