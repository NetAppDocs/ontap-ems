...
[.lead]
vsa.sriov events are presented when oNTAP(R) software running in the guest virtual machine (VM) detects an SR-IOV NIC detach event which typically does not require corrective action.
