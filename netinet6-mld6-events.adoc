...
[.lead]
netinet6.mld6 events occur when the system discovers an illegal Internet Control Message Protocol (ICMP) type field in a multicast listener discovery structure.
