...
[.lead]
raid.mcc events are presented when reports the summary information for the MetroCluster(tm) switchover operation which typically does not require corrective action.
