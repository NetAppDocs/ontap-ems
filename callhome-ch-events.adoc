...
[.lead]
callhome.ch events occur when ONTAP encounters issues associated with chassis power supply unit (PSU) degradation, faults, or incorrect power source connection.
