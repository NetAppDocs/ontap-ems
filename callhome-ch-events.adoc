...
[.lead]
callhome.ch events are presented when a degraded chassis power supply unit (PSU) state exists which may require reseating or replacing affected hardware.
