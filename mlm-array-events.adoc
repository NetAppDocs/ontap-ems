...
[.lead]
mlm.array events are presented when the system detects an array LUN from an unsupported array which is typically fixed by following the documented corrective steps.
