...
[.lead]
arl.subsystemabort events are presented when the specified subsystem aborts relocation of the aggregate which is typically fixed by verifying system state and connectivity.
