...
[.lead]
monitor.ioxmtemp events are presented when the I/O module is above the recommended operating temperature which is typically fixed by following the documented corrective steps.
