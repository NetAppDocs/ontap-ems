...
[.lead]
shm.bypassed events are presented when the system recommends that a disk be failed because it has been bypassed which typically does not require corrective action.
