...
[.lead]
vldb.aggrvote events are presented when a row of the aggr vote table is not replicated to the local table when an update is received from the remote cluster which typically does not require corrective action.
