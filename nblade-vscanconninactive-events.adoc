...
[.lead]
nblade.vscanconninactive events are presented when oNTAP(R) detects a nonresponsive antivirus (AV) server and forcibly closes its vscan connection which is typically fixed by following the documented corrective steps.
