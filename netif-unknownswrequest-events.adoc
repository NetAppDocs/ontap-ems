...
[.lead]
netif.unknownswrequest events are presented when a network driver does not recognize a request from another software module, possibly because the request is invalid which may require a reboot.
