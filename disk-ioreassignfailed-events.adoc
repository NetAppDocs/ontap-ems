...
[.lead]
disk.ioreassignfailed events are presented when a disk reports a medium error and the sector reassignment fails which may require reseating or replacing affected hardware.
