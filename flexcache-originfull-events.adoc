...
[.lead]
flexcache.originfull events are presented when a FlexCache(R) origin volume cannot serve data to cache volume because origin volume is full which is typically fixed by following the documented corrective steps.
