...
[.lead]
ha.resvconflicthalt events are presented when the node halts itself after it finds disks with reservation conflicts which typically does not require corrective action.
