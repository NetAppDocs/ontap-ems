...
[.lead]
wafl.volref events are presented when wafliron is started on aggregate containing volumes, which are in-use by other subsystems which is typically fixed by following the documented corrective steps.
