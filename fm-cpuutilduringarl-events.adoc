...
[.lead]
fm.cpuutilduringarl events are presented when at the start of an aggregate relocation (ARL) and at the completion of an ARL which typically does not require corrective action.
