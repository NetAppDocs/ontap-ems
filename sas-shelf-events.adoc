...
[.lead]
sas.shelf events are presented when the system detects that two or more SAS (serial attached SCSI) disk shelves have the same shelf ID which is typically fixed by following the documented corrective steps.
