...
[.lead]
dfu.firmwaredownrev EMS events occur when the system finds disks with a downrev version of firmware, as defined by the installed version of Data ONTAP(R).
