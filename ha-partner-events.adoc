...
[.lead]
ha.partner events are presented when a controller in an High Availability Configuration discovers its HA partner which typically does not require corrective action.
