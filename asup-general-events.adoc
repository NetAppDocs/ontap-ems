...
[.lead]
asup.general events are presented when the system cannot generate an AutoSupport message from a callhome EMS event which typically does not require corrective action.
