...
[.lead]
shelf.reset events are presented when oNTAP(R) software resets the error counters on a disk shelf module which typically does not require corrective action.
