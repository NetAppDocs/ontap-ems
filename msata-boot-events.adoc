...
[.lead]
msata.boot events occur when Data ONTAP(R) module that is responsible for monitoring the health of the mSATA device determines that the associated boot device is reporting a failure condition.
