...
[.lead]
aws.nic events are presented when data ONTAP(R) is running in Amazon Web Services (AWS) and a network interface stops processing packets at the beginning of system boot which may require a reboot.
