...
[.lead]
connectx.iblinkretrainreqd events are presented when the software detects that the previous InfiniBand link training was unsuccessful which typically does not require corrective action.
