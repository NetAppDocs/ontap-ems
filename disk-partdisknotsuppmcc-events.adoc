...
[.lead]
disk.partdisknotsuppmcc events are presented when a partitioned disk is found in a MetroCluster(TM) configuration which is typically fixed by following the documented corrective steps.
