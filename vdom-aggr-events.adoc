...
[.lead]
vdom.aggr events are presented when an internal timeout has been reached while processing volumes for an aggregate coming online during a takeover, giveback, or aggregate relocation event which typically does not require corrective action.
