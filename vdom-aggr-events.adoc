...
[.lead]
vdom.aggr events occur when an internal timeout has been reached while processing volumes for an aggregate coming online during a takeover, giveback, or aggregate relocation event.
