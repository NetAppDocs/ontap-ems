...
[.lead]
repl.cg events are presented when the number of Consistency Group Items involved in a SnapMirror(R) Granular Sync relationship exceeds its limit in the system which is typically fixed by following the documented corrective steps.
