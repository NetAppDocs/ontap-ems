...
[.lead]
sk.long events are presented when an SK process detects that a message has been queued longer than expected, as defined by an internal threshold which typically does not require corrective action.
