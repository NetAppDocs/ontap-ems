...
[.lead]
cr.rdb events are presented when the RDB (replicated database) cannot be updated with the inode counters for a particular scan which typically does not require corrective action.
