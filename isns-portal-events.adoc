...
[.lead]
isns.portal events are presented when the Internet Storage Name Service (iSNS) is not able to retrieve the portal information required for iSNS registration which is typically fixed by following the documented corrective steps.
