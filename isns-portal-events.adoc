...
[.lead]
isns.portal EMS events occur when the Internet Storage Name Service (iSNS) is not able to retrieve the portal information required for iSNS registration.
