...
[.lead]
san.missinglicense EMS events occur during replication of the FC/iSCSI service configuration, when the required service is not licensed or has expired in the cluster.
