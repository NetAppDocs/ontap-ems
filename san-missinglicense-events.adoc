...
[.lead]
san.missinglicense events are presented when the required service is not licensed or has expired in the cluster during replication of the FC/iSCSI service configuration, which is typically fixed by following the documented corrective steps.
