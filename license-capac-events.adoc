...
[.lead]
license.capac events are presented when the total storage capacity of all disks currently assigned to your system exceeds the limits of your capacity license which is typically fixed by following the documented corrective steps.
