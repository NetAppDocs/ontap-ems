...
[.lead]
monitor.power events are presented when the main unit power supply is in a degraded mode which is typically fixed by following the documented corrective steps.
