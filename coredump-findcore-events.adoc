...
[.lead]
coredump.findcore events are presented when the core dump process detects an error while checking for an unsaved core in the dump device which typically does not require corrective action.
