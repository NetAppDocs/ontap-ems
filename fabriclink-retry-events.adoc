...
[.lead]
fabriclink.retry events are presented when object replication encounters an error when attempting to contact a remote object store which typically does not require corrective action.
