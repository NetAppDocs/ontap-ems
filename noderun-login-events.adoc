...
[.lead]
noderun.login events are presented when a cluster user successfully logs in to the node using the 'run' command which typically does not require corrective action.
