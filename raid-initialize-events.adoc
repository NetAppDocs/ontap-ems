...
[.lead]
raid.initialize events are presented when a foreign or partner homed spare disk is detected during system initialization which is typically fixed by following the documented corrective steps.
