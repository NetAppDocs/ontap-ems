...
[.lead]
fmmb.add events are presented when this event is issued when the HA mailbox is attempting to add a mailbox disk and a problem occurred which typically does not require corrective action.
