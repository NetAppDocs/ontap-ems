...
[.lead]
nblade.smb1onlyclientfound events are presented when oNTAP(R) detects a client that supports only the SMB1 protocol which typically does not require corrective action.
