...
[.lead]
cna.sfp events are presented when the converged network adapter (CNA) detects an unsupported small form-factor Pluggable (SFP) in the adapter which may require reseating or replacing affected hardware.
