...
[.lead]
ha.takeoverimplowmem events are presented when the partner node is down; however, due to this node being low on memory, it is currently impossible to perform a takeover which may require contacting NetApp support.
