...
[.lead]
wafl.timer events are presented when disk I/O is stalled, possibly during a disk firmware download operation which may require restarting affected services or nodes.
