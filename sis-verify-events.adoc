...
[.lead]
sis.verify events are presented when the system suspends a Single Instance Storage (SIS) volume checking operation to to run a queued SIS operation which typically does not require corrective action.
