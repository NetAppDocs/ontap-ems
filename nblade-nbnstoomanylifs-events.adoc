...
[.lead]
nblade.nbnstoomanylifs events are presented when the NetBIOS Name Service receives more than 25 IP addresses for a name registration request which is typically fixed by updating configuration.
