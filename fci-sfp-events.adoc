...
[.lead]
fci.sfp events are presented when an invalid Small Form-factor Pluggable (SFP) is inserted into the adapter which may require reseating or replacing affected hardware.
