...
[.lead]
callhome.no events are presented when a volume is out of inodes, which refer to individual files, other types of files, and directories which is typically fixed by updating configuration.
