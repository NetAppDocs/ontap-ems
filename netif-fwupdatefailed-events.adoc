...
[.lead]
netif.fwupdatefailed events are presented when there is an error during a network interface firmware update which is typically fixed by updating configuration.
