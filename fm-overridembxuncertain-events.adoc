...
[.lead]
fm.overridembxuncertain events are presented when the user has chosen to override a mailbox uncertain state using the CTRL_O option which typically does not require corrective action.
