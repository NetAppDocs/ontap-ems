...
[.lead]
wafl.atime events occur when the access time updates of all the files in the volumes of an aggregate start because the aggregate has enough free space.
