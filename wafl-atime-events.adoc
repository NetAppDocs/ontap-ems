...
[.lead]
wafl.atime events are presented when the access time updates of all the files in the volumes of an aggregate start because the aggregate has enough free space which typically does not require corrective action.
