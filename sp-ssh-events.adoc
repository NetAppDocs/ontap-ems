...
[.lead]
sp.ssh events are presented when the SSH access list of the service processor needs to be reconfigured which is typically fixed by updating configuration.
