...
[.lead]
callhome.syncsm events are presented when critical thresholds are breached for a SnapMirror(R) Synchronous relationship which is typically fixed by verifying system state and connectivity.
