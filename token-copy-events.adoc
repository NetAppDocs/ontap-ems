...
[.lead]
token.copy events are presented when a 'copy complete' request fails to free the reference on a remote node which typically does not require corrective action.
