...
[.lead]
disk.readreservationfailed events are presented when a SCSI (Small Computer System Interface) read reservation fails which is typically fixed by following the documented corrective steps.
