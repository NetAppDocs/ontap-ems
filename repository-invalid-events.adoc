...
[.lead]
repository.invalid events are presented when the Infinite Volume namespace redirector detects an internal inconsistency in a redirector file in the namespace constituent during a client file operation request, which may require contacting NetApp support.
