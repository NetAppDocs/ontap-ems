...
[.lead]
config.mirrornotmultipath events are presented when a disk is not multipathed but synchronous mirroring is enabled which is typically fixed by following the documented corrective steps.
