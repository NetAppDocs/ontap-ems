...
[.lead]
netif.phynotread events are presented when the system cannot read identification information from the physical layer (PHY) of a network interface which may require a reboot.
