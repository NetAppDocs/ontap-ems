...
[.lead]
nvmens.repl EMS events occur when replication of a volume containing NVMe namespaces has failed because the destination does not support NVMe namespaces.
