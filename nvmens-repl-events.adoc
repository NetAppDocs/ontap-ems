...
[.lead]
nvmens.repl events are presented when replication of a volume containing NVMe namespaces has failed because the destination does not support NVMe namespaces which is typically fixed by following the documented corrective steps.
