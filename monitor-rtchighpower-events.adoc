...
[.lead]
monitor.rtchighpower events are presented when the real-time clock (RTC) battery voltage is above normal level which may require reseating or replacing affected hardware.
