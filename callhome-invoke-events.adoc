...
[.lead]
callhome.invoke events are presented when you invoke an AutoSupport(R) message, and the "type" of that message is set to "test" which typically does not require corrective action.
