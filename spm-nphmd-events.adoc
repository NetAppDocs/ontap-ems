...
[.lead]
spm.nphmd events are presented when the Controller Health Monitor process (nphmd) involuntarily terminates which may require restarting affected services or nodes.
