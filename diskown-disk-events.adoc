...
[.lead]
diskown.disk events are presented when during an attempt to assign a disk that is being deleted which is typically fixed by verifying system state and connectivity.
