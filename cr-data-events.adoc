...
[.lead]
cr.data events are presented when the namespace scanner skips an inode for which it cannot access the data file which is typically fixed by following the documented corrective steps.
