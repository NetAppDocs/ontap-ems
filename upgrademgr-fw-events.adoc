...
[.lead]
upgrademgr.fw events are presented when an automated nondisruptive upgrade (ANDU) completes the firmware update monitoring job which typically does not require corrective action.
