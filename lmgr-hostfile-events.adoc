...
[.lead]
lmgr.hostfile events are presented when the volume lock manager hosts file is unusable which is typically fixed by following the documented corrective steps.
