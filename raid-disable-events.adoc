...
[.lead]
raid.disable events are presented when RAID sub system disables recording in the partner's NVRAM entries for the log based file system, which may require reseating or replacing affected hardware.
