...
[.lead]
se.gatherer events are presented when single Instance Storage (SIS) auto gathering scanner completed on the auto adaptive volume which typically does not require corrective action.
