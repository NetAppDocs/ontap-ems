...
[.lead]
san.changedhomeport events are presented when the home port of an existing SAN LIF is modified during LIF placement which typically does not require corrective action.
