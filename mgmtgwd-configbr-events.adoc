...
[.lead]
mgmtgwd.configbr events are presented when a scheduled configuration backup is successfully created which typically does not require corrective action.
