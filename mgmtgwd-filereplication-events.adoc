...
[.lead]
mgmtgwd.filereplication events are presented when the startup scan of the file replication publishing root directory fails to verify packages which may require contacting NetApp support.
