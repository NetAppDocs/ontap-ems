...
[.lead]
clam.voting events are presented when the Kernel Cluster Services Connectivity, Liveliness, Availability Monitor (CLAM) detects that the voting state of the node changed which typically does not require corrective action.
