...
[.lead]
ses.system events are presented when oNTAP(R) software does not support internal disk drives in this platform which is typically fixed by verifying system state and connectivity.
