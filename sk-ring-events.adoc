...
[.lead]
sk.ring events are presented when indicates that a module detected a condition that warranted dumping the internal tracing buffer to a file which typically does not require corrective action.
