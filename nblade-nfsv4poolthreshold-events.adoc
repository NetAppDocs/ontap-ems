...
[.lead]
nblade.nfsv4poolthreshold events are presented when one of the NFSv4 store pools is nearing exhaustion (80% of max size) which is typically fixed by following the documented corrective steps.
