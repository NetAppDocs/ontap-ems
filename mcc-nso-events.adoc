...
[.lead]
mcc.nso events are presented when dump/restore is aborted during a MetroCluster switch-over operation which typically does not require corrective action.
