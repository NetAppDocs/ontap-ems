...
[.lead]
objstore.host events are presented when the object-store server host name cannot be resolved to an IP address which is typically fixed by verifying system state and connectivity.
