...
[.lead]
san.lifmoveafterswitchback events occur during MetroCluster(tm) switchback, when a LIF cannot be placed on one of the disaster recovery (DR) nodes because it is offline.
