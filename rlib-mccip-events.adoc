...
[.lead]
rlib.mccip events are presented when this event is generated if any error occurs while configuring MCC/IP which typically does not require corrective action.
