...
[.lead]
raid.mirror events are presented when a SyncMirror(R) aggregate uses aggregate snapshots other than SyncMirror aggregate snapshots which may require contacting NetApp support.
