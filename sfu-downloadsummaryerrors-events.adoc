...
[.lead]
sfu.downloadsummaryerrors events are presented when a disk shelf firmware update completes without successfully downloading to all shelves it attempted which is typically fixed by updating configuration.
