...
[.lead]
monitor.chassistemperature events are presented when the chassis temperature is too cool which is typically fixed by following the documented corrective steps.
