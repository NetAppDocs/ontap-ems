...
[.lead]
fmmb.major events are presented when this event is issued when the HA Mailbox major reset data should exist and it doesn't which typically does not require corrective action.
