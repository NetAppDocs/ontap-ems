...
[.lead]
callhome.root events are presented when the root volume is not working properly and its recovery is required which may require contacting NetApp support.
