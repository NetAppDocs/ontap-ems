...
[.lead]
sis.autosched events are presented when a SIS volume operation could not be auto scheduled due to unexpected conditions, which typically does not require corrective action.
