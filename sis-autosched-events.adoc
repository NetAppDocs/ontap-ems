...
[.lead]
sis.autosched events are presented when this event is issued when a SIS volume operation could not be auto scheduled due to unexpected conditions which typically does not require corrective action.
