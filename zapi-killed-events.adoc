...
[.lead]
zapi.killed events are presented when zAPI Socket Manager (ZSM) terminates and no longer offers a connection on which a client can deliver Zephyr API (ZAPI) requests which typically does not require corrective action.
