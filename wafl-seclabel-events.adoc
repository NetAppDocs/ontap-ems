...
[.lead]
wafl.seclabel events are presented when the mutual exclusion has failed between the SnapMirror Synchronous and NFS v4.2 Security Labels features which typically does not require corrective action.
