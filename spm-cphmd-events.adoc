...
[.lead]
spm.cphmd events are presented when the Chassis Health Monitor process (cphmd) involuntarily terminates which may require restarting affected services or nodes.
