...
[.lead]
cf.shutdown EMS events occur when the controller receives a message from its partner over the HA interconnect that indicates a condition related to the partner's attempted graceful shutdown.
