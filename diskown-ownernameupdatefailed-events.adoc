...
[.lead]
diskown.ownernameupdatefailed events are presented when this event is issued when we have to rewrite a DOWN because it is out of date wrt the other DOWNs which typically does not require corrective action.
