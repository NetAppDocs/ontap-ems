...
[.lead]
diskown.ownernameupdatefailed events are presented when we have to rewrite a DOWN because it is out of date wrt the other DOWNs, which typically does not require corrective action.
