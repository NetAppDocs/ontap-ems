...
[.lead]
callhome.ext events are presented when a check of the external memory cache used for increasing system performance has failed and this cache has been disabled which may require contacting NetApp support.
