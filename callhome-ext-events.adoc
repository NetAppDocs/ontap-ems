...
[.lead]
callhome.ext events occur when a check of the external memory cache used for increasing system performance has failed and this cache has been disabled.
