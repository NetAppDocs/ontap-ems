...
[.lead]
nblade.cifsnonunicoderequest events are presented when a client attempts to send a non-unicode request to a Vserver which is typically fixed by verifying system state and connectivity.
