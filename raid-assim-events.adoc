...
[.lead]
raid.assim events are presented when this event is generated when adding an offline disk into a raidtree which typically does not require corrective action.
