...
[.lead]
nodewatchdog.config events are presented when bootarg.nodewatchdog.level is set to an invalid value which is typically fixed by updating configuration.
