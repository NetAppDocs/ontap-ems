...
[.lead]
mpt.busreg events are presented when physical disk bus registration fails in the message processing technology (MPT) adapter driver which is typically fixed by verifying system state and connectivity.
