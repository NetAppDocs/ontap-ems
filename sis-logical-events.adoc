...
[.lead]
sis.logical events are presented when the deduplication engine's logical data limit is nearly reached on a volume which is typically fixed by following the documented corrective steps.
