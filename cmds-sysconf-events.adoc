...
[.lead]
cmds.sysconf events are presented when to log the reason for system halt, before actually system is halted which typically does not require corrective action.
