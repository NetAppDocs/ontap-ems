...
[.lead]
snapvault.qtree events are presented when snapVault(R) cannot start a volume-wide snapshot target to complete a manually invoked baseline transfer or resynchronizing transfer which typically does not require corrective action.
