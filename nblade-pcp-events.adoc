...
[.lead]
nblade.pcp events are presented when a network port undergoes multiple link state transitions within a short period of time which is typically fixed by verifying system state and connectivity.
