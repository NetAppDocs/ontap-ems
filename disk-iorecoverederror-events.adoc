...
[.lead]
disk.iorecoverederror events are presented when a disk determines that it will fail shortly which may require reseating or replacing affected hardware.
