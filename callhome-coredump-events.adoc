...
[.lead]
callhome.coredump events are presented when all the core segments belonging to a coredump have been saved which is typically fixed by verifying system state and connectivity.
