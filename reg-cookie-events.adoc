...
[.lead]
reg.cookie events are presented when allocation of cookies for traversing all keys under a prefix fails which is typically fixed by verifying system state and connectivity.
