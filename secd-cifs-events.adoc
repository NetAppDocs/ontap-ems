...
[.lead]
secd.cifs events are presented when the CIFS server machine account is missing from the Active Directory domain which is typically fixed by following the documented corrective steps.
