...
[.lead]
wafl.nfsv4 events are presented when the system cannot map an ID stored in the Access Control Entry (ACE) to a valid UNIX(R) User ID/Group ID (UID/GID) pair which may require contacting NetApp support.
