...
[.lead]
fmmb.lock events are presented when this event is issued when a disk is removed from the HA mailbox disk lock set which typically does not require corrective action.
