...
[.lead]
auto.policy events occur when ONTAP encounters issues associated with enabling the "auto" efficiency policy on volumes during upgrade to Data ONTAP 9.3 or later.
