...
[.lead]
moveagent.commitsrc events are presented when an active volume move operation cannot commit the source volume which may require contacting NetApp support.
