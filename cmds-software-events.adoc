...
[.lead]
cmds.software events are presented when because the system cannot create the directory at the designated path which typically does not require corrective action.
