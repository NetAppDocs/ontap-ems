...
[.lead]
wafl.takeover events are presented when the system does not find any WAFL(R) nvlog records to replay during takeover processing which typically does not require corrective action.
