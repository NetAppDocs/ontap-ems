...
[.lead]
vifmgr.svcpolicy events are presented when a service is added to a network interface service policy which typically does not require corrective action.
