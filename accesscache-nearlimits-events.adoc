...
[.lead]
accesscache.nearlimits events are presented when the access cache module is near its limit for entries which is typically fixed by updating configuration.
