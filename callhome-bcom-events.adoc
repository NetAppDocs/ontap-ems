...
[.lead]
callhome.bcom events are presented when multiple attempts to initialize the SAN Kernel Agent for a Vserver have failed which is typically fixed by verifying system state and connectivity.
