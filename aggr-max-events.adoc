...
[.lead]
aggr.max events are presented when the maximum aggregate size limit is increased from the default value defined in the Platform Specific Module (PSM) table which typically does not require corrective action.
