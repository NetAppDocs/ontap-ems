...
[.lead]
sis.op events are presented when this event is issued when a SIS volume operation is aborted due to unexpected conditions which typically does not require corrective action.
