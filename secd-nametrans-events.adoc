...
[.lead]
secd.nametrans events are presented when the group name cannot be resolved by any of the entities in the ns-switch for the virtual server which is typically fixed by following the documented corrective steps.
