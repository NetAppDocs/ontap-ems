...
[.lead]
netif.excesslinkinterrupts events are presented when excessive link status change interrupts occur on the network interface which may require reseating or replacing affected hardware.
