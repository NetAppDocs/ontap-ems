...
[.lead]
encryption.queue events are presented when an operation on the volume in the encryption queue failed which is typically fixed by verifying system state and connectivity.
