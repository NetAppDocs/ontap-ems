...
[.lead]
arl.netra events occur when ONTAP encounters issues associated with aggregate relocation failures due to destination node validation checks or resource availability.
