...
[.lead]
wafl.extent events are presented when the volume extent option is set and WAFL(R) encounters an invalid extent size which typically does not require corrective action.
