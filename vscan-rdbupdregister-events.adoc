...
[.lead]
vscan.rdbupdregister events are presented when the Vscan configuration replication mechanism fails to register RDB update callback which may require a reboot.
