...
[.lead]
lmgr.pruning events are presented when there is a delay in pruning and removing unused entries in the volume lock manager hosts file which typically does not require corrective action.
