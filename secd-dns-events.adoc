...
[.lead]
secd.dns events are presented when the DNS server fails to respond to a query and timeout occurs which is typically fixed by following the documented corrective steps.
