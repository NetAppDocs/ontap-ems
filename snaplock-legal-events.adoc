...
[.lead]
snaplock.legal events are presented when on completion of a legal-hold dump-files operation on a SnapLock(R) compliance volume which typically does not require corrective action.
