...
[.lead]
repl.logical events are presented when a data warehouse is rebuilt as part of a SnapMirror(R) restore or resync operation which typically does not require corrective action.
