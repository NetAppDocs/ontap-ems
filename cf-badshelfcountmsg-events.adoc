...
[.lead]
cf.badshelfcountmsg events are presented when if we are sent an invalid negotiated failover shelf count message, which is typically fixed by verifying system state and connectivity.
