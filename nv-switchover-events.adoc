...
[.lead]
nv.switchover events are presented when switchover proceeds even when nonvolatile RAM (NVRAM) inconsistencies are detected in the DR partner sections which typically does not require corrective action.
