...
[.lead]
arw.auto events are presented when anti-ransomware has been automatically switched from learning mode to enabled after various conditions have been satisfied, such as learning period, file creation, file write, and file extension discovery activities which typically does not require corrective action.
