...
[.lead]
cpeer.long events are presented when a cross-cluster update takes longer than 15 minutes which is typically fixed by verifying system state and updating configuration.
