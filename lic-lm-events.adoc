...
[.lead]
lic.lm EMS events occur when ONTAP(R) software is running in the capacity pools licensing model and there is no License Manager configuration available.
