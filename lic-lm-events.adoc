...
[.lead]
lic.lm events are presented when oNTAP(R) software is running in the capacity pools licensing model and there is no License Manager configuration available which is typically fixed by verifying system state and updating configuration.
