...
[.lead]
sshd.auth events are presented when sshd refuses a login attempt due to authentication failure, which is typically fixed by following the documented corrective steps.
