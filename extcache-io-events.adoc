...
[.lead]
extcache.io events are presented when the external cache detects a block checksum verification error while performing a read operation which typically does not require corrective action.
