...
[.lead]
pac.peer events are presented when the protocol access control fails to get the peer name which is typically fixed by verifying system state and connectivity.
