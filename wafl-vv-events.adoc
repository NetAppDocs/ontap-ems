...
[.lead]
wafl.vv events are presented when data ONTAP(R) cannot map a volume to serve a client request because of invalid data Set Identifiers which may require contacting NetApp support.
