...
[.lead]
monitor.fru events are presented when the inventory information about a field-replaceable unit (FRU) that was previously unreadable becomes readable which typically does not require corrective action.
