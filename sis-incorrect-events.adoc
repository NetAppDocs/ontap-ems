...
[.lead]
sis.incorrect events are presented when a Single Instance Storage (SIS) volume repeatedly can not finish SIS operation within user-given 'duration' settings which is typically fixed by following the documented corrective steps.
