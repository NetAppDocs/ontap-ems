...
[.lead]
raid.spares events are presented when this event is issued when a media_scrub i/o detects a medium error on a spare disk which typically does not require corrective action.
