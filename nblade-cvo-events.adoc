...
[.lead]
nblade.cvo events are presented when a remote volume has been accessed in the Cloud Volumes ONTAP(R) environment which typically does not require corrective action.
