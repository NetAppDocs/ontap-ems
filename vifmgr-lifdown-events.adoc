...
[.lead]
vifmgr.lifdown EMS events occur when a logical interface (LIF) IP address cannot serve data because there are no eligible ports on which to host the LIF.
