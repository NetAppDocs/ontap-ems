...
[.lead]
raid.fm events are presented when this event contains summary information for the disaster takeover which typically does not require corrective action.
