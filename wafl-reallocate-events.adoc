...
[.lead]
wafl.reallocate events are presented when an aggregate reallocation scan is interrupted which is typically fixed by following the documented corrective steps.
