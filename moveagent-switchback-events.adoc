...
[.lead]
moveagent.switchback EMS events occur when the volume move operation vetoes a MetroCluster(tm) switchback because the operations are mutually exclusive.
