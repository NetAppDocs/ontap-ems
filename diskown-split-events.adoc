...
[.lead]
diskown.split events are presented when any type of split-shelf automatic drive assignment is disabled which typically does not require corrective action.
