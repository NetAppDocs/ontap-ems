...
[.lead]
repl.core events are presented when a replication transfer that completed ten or more minutes ago is found and subsequently cleaned up which typically does not require corrective action.
