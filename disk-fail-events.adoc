...
[.lead]
disk.fail events are presented when a disk is marked failed, is being sanitized, or has entered Maintenance Center which typically does not require corrective action.
