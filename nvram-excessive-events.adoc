...
[.lead]
nvram.excessive EMS events occur when ONTAP encounters issues associated with correctable error-correcting code (ECC) memory errors in the NVRAM complex.
