...
[.lead]
disk.cksum events are presented when the system detects a block number mismatch during disk checksum verification which typically does not require corrective action.
