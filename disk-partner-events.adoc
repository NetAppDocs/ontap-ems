...
[.lead]
disk.partner events are presented when a node receives notice that its partner has completed a 'disk encrypt revert_original' operation which typically does not require corrective action.
