...
[.lead]
mlm.vmdisk events are presented when the system discovers a new virtual disk in a virtual machine (VM) which typically does not require corrective action.
