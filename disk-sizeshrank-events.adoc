...
[.lead]
disk.sizeshrank events are presented when the controller detects a decrease in the capacity of a virtual disk which typically does not require corrective action.
