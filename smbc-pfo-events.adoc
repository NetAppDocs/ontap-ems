...
[.lead]
smbc.pfo events are presented when the SnapMirror(R) active sync planned failover operation completes which typically does not require corrective action.
