...
[.lead]
dump.transit events are presented when the failover is still in transit while waiting for the dump to be initialized, which typically does not require corrective action.
