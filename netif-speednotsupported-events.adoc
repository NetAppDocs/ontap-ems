...
[.lead]
netif.speednotsupported events are presented when a network interface autonegotiates to an unsupported speed which is typically fixed by following the documented corrective steps.
