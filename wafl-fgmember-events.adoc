...
[.lead]
wafl.fgmember events are presented when a member of a FlexGroup experiences an unexpected rollback in its state due to a loss of the NVRAM log for the member which is typically fixed by following the documented corrective steps.
