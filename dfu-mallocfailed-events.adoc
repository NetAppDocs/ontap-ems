...
[.lead]
dfu.mallocfailed events are presented when data ONTAP(R) cannot allocate memory to read the disk firmware file and aborts the disk firmware update which may require a reboot.
