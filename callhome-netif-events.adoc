...
[.lead]
callhome.netif events are presented when network Interface Card encountered a fatal error which is typically fixed by verifying system state and connectivity.
