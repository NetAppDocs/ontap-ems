...
[.lead]
callhome.sm events are presented when a break operation on a SnapMirror(R) relationship that is a part of VserverDR fails which may require contacting NetApp support.
