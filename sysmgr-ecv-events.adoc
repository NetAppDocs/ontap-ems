...
[.lead]
sysmgr.ecv events are presented when acquiring the desired Effective Cluster Version (ECV) of System Manager was not accomplished within the time limit which is typically fixed by verifying system state and connectivity.
