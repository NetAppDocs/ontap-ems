...
[.lead]
config.badslot events are presented when a disk is found to be attached to an invalid Host Adapter (HA) controller slot which may require contacting NetApp support.
