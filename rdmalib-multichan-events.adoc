...
[.lead]
rdmalib.multichan events occur when this node's high-availability (HA) partner reports an update on the number of interconnect channels (multichan count) in use.
