...
[.lead]
rdmalib.multichan events are presented when this node's high-availability (HA) partner reports an update on the number of interconnect channels (multichan count) in use which typically does not require corrective action.
