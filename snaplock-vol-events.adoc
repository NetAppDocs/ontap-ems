...
[.lead]
snaplock.vol EMS events occur when the SnapLock(R) volume compliance clock time is skewed from the SnapLock system compliance clock by more than one day.
