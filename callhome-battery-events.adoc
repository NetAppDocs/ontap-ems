...
[.lead]
callhome.battery EMS events occur when ONTAP encounters issues associated with NVRAM battery capacity, charging, temperature, or environmental conditions.
