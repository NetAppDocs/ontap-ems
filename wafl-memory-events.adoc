...
[.lead]
wafl.memory events are presented when periodically to inform the administrator about the amount of WAFL memory that is currently available which typically does not require corrective action.
