...
[.lead]
root.vol events are presented when system creates a root volume automatically, after a cluster reboot occurred before root volume creation which is typically fixed by following the documented corrective steps.
