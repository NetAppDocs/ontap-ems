...
[.lead]
rlm.orftp events are presented when a communication error occured while sending or receiving information from the Remote Lan Module (RLM) which may require a reboot.
