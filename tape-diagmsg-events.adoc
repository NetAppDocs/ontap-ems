...
[.lead]
tape.diagmsg events are presented when there is a new state of the tape diagnostic message flag which is typically fixed by verifying system state and connectivity.
