...
[.lead]
sysconfig.sysconfigtab events are presented when this event is issued when the sysconfigtab file cannot be opened which typically does not require corrective action.
