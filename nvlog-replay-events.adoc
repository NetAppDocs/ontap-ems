...
[.lead]
nvlog.replay events are presented when on Cloud Volumes ONTAP platforms to identify the source of the nonvolatile log (nvlog) replay that follows which typically does not require corrective action.
