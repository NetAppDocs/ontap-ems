...
[.lead]
sis.policy events are presented when during system software upgrade to Data ONTAP(R) 8.1 or later, while creating predefined policies which is typically fixed by following the documented corrective steps.
