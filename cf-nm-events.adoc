...
[.lead]
cf.nm events are presented when the controller performs a soft reset of the HA interconnect card as part of automatic recovery from a timeout or link error which typically does not require corrective action.
