...
[.lead]
netif.linkinfo events are presented when a network interface is reset by the software or is configured down by the administrator which typically does not require corrective action.
