...
[.lead]
rdma.rlib events are presented when the system fails to start the advertisement service for the high-availability (HA) interconnect which may require contacting NetApp support.
