...
[.lead]
diskown.statusreadownership events are presented when an event is logged to track that an error was encountered while reading all data ownership blocks at once which typically does not require corrective action.
