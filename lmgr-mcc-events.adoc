...
[.lead]
lmgr.mcc events are presented when the system vetoes MetroCluster(TM) switchback or negotiated switchover because CIFS oplock recall fails which may require contacting NetApp support.
