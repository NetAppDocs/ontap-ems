...
[.lead]
clam.stop events are presented when the Kernel Cluster Services (KCS) Connectivity, Liveliness, Availability Monitor (CLAM) has stopped polling the CLAM mailboxes which typically does not require corrective action.
