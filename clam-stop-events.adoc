...
[.lead]
clam.stop EMS events occur when the Kernel Cluster Services (KCS) Connectivity, Liveliness, Availability Monitor (CLAM) has stopped polling the CLAM mailboxes.
