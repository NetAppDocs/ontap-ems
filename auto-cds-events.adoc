...
[.lead]
auto.cds EMS events occur when ONTAP encounters issues associated with volume efficiency inactive data compression scan disablement during upgrade to Data ONTAP 9.11.1 or later.
