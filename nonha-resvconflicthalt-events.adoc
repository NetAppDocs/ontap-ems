...
[.lead]
nonha.resvconflicthalt events are presented when the controller halts itself after it finds disk with reservation conflicts which may require contacting NetApp support.
