...
[.lead]
repl.s2c events are presented when the checksum of an object's contents does not match with the expected checksum which may require contacting NetApp support.
