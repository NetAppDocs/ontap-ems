...
[.lead]
usb.port events are presented when the Data ONTAP(R) universal serial bus (USB) adapter driver detects an unrecoverable error on the associated port which may require contacting NetApp support.
