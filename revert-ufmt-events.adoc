...
[.lead]
revert.ufmt events are presented when the revert operation to convert the unified object format is paused because the FabricPool aggregate has reached the maximum supported size of the capacity tier which may require contacting NetApp support.
