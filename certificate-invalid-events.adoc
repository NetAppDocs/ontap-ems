...
[.lead]
certificate.invalid events are presented when an installed certificate record contains multiple X.509 certificates which may require reseating or replacing affected hardware.
