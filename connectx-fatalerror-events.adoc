...
[.lead]
connectx.fatalerror events are presented when a fatal error is polled from the ConnectX(tm) InfiniBand(R) adapter which may require contacting NetApp support.
