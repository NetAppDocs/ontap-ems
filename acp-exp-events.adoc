...
[.lead]
acp.exp events occur when ONTAP encounters issues associated with the Alternate Control Path (ACP) Processor receiving commands to power-cycle or reset the SAS expander.
