...
[.lead]
acp.exp events are presented when the Alternate Control Path (ACP) Processor receives a command to power-cycle the SAS expander which typically does not require corrective action.
