...
[.lead]
disk.eos events are presented when a disk is detected that is not supported in this version of Data ONTAP(R) or later which may require reseating or replacing affected hardware.
