...
[.lead]
adt.dest EMS events occur when ONTAP encounters issues associated with the audit consolidation job failing to access or write audit logs to the destination directory.
