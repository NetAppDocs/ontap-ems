...
[.lead]
san.lifrepfieldsmissing events occur when the system cannot replicate a SAN logical interface (LIF) in a MetroCluster(tm) configuration, because one or more attributes of the source LIF cannot be determined.
