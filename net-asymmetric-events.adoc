...
[.lead]
net.asymmetric events are presented when oNTAP(R) detects asymmetric routing on the e0M port which is typically fixed by verifying system state and connectivity.
