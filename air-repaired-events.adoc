...
[.lead]
air.repaired events are presented when oNTAP(R) discovers an inconsistency in a metadata bucket header record which typically does not require corrective action.
