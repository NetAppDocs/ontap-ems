...
[.lead]
air.repaired EMS events occur when ONTAP encounters issues associated with metadata inconsistencies that are automatically repaired immediately upon detection.
