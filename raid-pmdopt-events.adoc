...
[.lead]
raid.pmdopt events occur when the option raid.panic.missing.disks was set to panic and halt the appliance when a hardware error prevents access to multiple file system disks.
