...
[.lead]
useradmin.name events are presented when an administrative name in the cluster is longer than the maximum allowed 255 characters which is typically fixed by following the documented corrective steps.
