...
[.lead]
ha.tkoverabortednomediatormbx events are presented when a planned failover is aborted because the mediator mailbox disks were not detected which is typically fixed by verifying system state and connectivity.
