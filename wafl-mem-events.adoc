...
[.lead]
wafl.mem events are presented when this event indicates whether memory stomper code is running or not which typically does not require corrective action.
