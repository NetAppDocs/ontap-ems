...
[.lead]
sfo.reassignfailed events occur during the Storage Failover takeover process, when the disks from the failed node cannot be reassigned due to the failure listed.
