...
[.lead]
nblade.cifsencshraccessdenied EMS events occur when a client not capable of SMB encryption tries to connect to a CIFS share that requires SMB encryption.
