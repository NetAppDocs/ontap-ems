...
[.lead]
netinet6.icmp events occur when the system receives an Internet Control Message Protocol(ICMP) message, and while processing the ICMP message it finds a checksum error.
