...
[.lead]
nvmeof.portioma events are presented when there are no longer two ports cabled incorrectly from a node to top module (A) on a shelf which typically does not require corrective action.
