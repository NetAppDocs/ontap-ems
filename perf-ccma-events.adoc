...
[.lead]
perf.ccma events occur when the performance archiver is not enabled, which makes it difficult for technical support to troubleshoot performance issues on the system.
