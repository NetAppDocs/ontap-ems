...
[.lead]
callhome.management events are presented when the MANAGEMENT_LOG AutoSupport or 'call home' event is sent which typically does not require corrective action.
