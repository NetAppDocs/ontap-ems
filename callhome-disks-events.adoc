...
[.lead]
callhome.disks events are presented when the system detected simultaneously that multiple disk drives were missing from the system which may require contacting NetApp support.
