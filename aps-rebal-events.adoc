...
[.lead]
aps.rebal events occur when ONTAP encounters issues associated with the performance rebalancing service detecting node utilization thresholds being exceeded.
