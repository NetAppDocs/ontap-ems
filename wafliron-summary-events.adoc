...
[.lead]
wafliron.summary events are presented when wafliron is running and its state is "starting" or "scanning" periodically, which typically does not require corrective action.
