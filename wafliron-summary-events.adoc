...
[.lead]
wafliron.summary events are presented when periodically when wafliron is running and its state is "starting" or "scanning" which typically does not require corrective action.
