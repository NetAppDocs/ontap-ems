...
[.lead]
smbc.aufo events are presented when the SnapMirror(R) active sync automatic unplanned failover operation completes which typically does not require corrective action.
