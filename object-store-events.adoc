...
[.lead]
object.store events are presented when the node can connect to the object store again after an "object.store.unavailable" error which typically does not require corrective action.
