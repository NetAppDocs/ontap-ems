...
[.lead]
backup.abort EMS events occur when ONTAP encounters issues associated with backup operations being aborted during ROOLR or VERITAS NBU STSP Protocol operations.
