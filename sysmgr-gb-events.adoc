...
[.lead]
sysmgr.gb events are presented when acquiring the desired Effective Cluster Version (ECV) of System Manager was not accomplished within the time limit during the first storage giveback phase which is typically fixed by verifying system state and connectivity.
