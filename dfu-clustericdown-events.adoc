...
[.lead]
dfu.clustericdown events are presented when the high-availability (HA) interconnect is not available which is typically fixed by verifying system state and connectivity.
