...
[.lead]
nv.rename events are presented when there is an error while renaming the files specified in /etc/nvfail_rename which typically does not require corrective action.
