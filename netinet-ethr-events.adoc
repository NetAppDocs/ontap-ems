...
[.lead]
netinet.ethr events are presented when a high arrival rate of address resolution protocol (ARP) frames has been detected (possible ARP storm) which is typically fixed by verifying system state and connectivity.
